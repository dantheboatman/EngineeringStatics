...
},
{
  ...
  "number": "4.1.2",
  "title": "",
  "body": "  The boom pendant of the mobile crane is used to raise long boom .  Use the definition of the moment to find the tension in the boom pendant that will produce a moment about point for the position shown.           Draw and label a right triangle with the perpendicular distance as one leg, and a known distance as the hypotenuse.   Find an angle in the triangle.     Use trigonometry to find the perpendicular distance.  Apply the definition of the moment , and solve for .    This force produces a counterclockwise rotation of the boom, so this is a positive scalar moment in two dimensions, which points in the direction in three.   "
},
{
...
{
  "id": "Chapter_04-direction-of-a-moment-3",
  "level": "2",
  "url": "moment-of-force.html#Chapter_04-direction-of-a-moment-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": " 3D Moment about a Line       A per side square box is attached to fixed pipe by two frictionless hinges and . There are two forces applied to the box, and .  For this two part example, first find the rotational moment from about line and then find the moment of and about line .      Find the magnitude of the moment caused by force about pipe (or line) .     The key observation to find the moment of about line is that the line of action of goes directly through line , thus there is no moment arm to develop a moment from force . Force still pulls on the box and line , but causes no rotation about line . While you could set up a two-step or mixed triple to compute this moment, the simplest moment arm from line to force would be which would result in a .    Find the magnitude of the moment caused by force about pipe (or line) .       The top vector in the scalar triple product is the unit vector for the line of interest .   Next, the middle row of the scalar triple product is one of the moment arms from to the force . There are four options which will all result in the same answer after you compute the scalar triple product.   Line drawing of moment arms going from line BG to line of action of P_2, HD.    Finally, the bottom row of the scalar triple product are the force vector components.  Now, set up the vector determinant of the scalar triple product to find the moment of about . Recall that a scalar triple product includes:  Top line: Unit vector for the line of interest   Middle line: Moment arm from line of interest to force vector. We'll use as it has the most zeros, which will simplify the algebra when computing the determinant.  Bottom line: Components of force vector      Hence, the magnitude of the moment caused by force about pipe (or line) is . As we found a positive answer, this confirms that the rotation caused by is in the same direction as the vector , this is reinforced by the right-hand rule thumb direction in the diagram.   Solution line drawing showing the moment around r_GH, the force P_2, and the resulting moment M_BG.     "
},
{
