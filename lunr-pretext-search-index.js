...
},
{
  ...
  "body": " Acknowledgements  This book is the vision of a handful of instructors who wanted to create a free and open Engineering Statics textbook filled with dynamic, interactive diagrams to encourage visualization and engineering intuition.  Dr. Baker brought together a team of volunteers from large public universities, small private colleges, and community colleges across the United States to write the text and create the interactive elements. Some content was adapted with permission from Jacob Moore's Mechanics Map - Open Textbook Project . . After two years of development the book was released to the public in 2020.  The book continues to evolve thanks to the contributions, suggestions, and corrections made by users of the text, both professors and students. The original authors are listed below, and others who have contributed are acknowledged in the source code on GitHub.    Daniel W. Baker Colorado State University  Devin Berg University of Wisconsin - Stout  Andy Guyader Cal Poly, San Luis Obispo  William Haynes Massachusetts Maritime Academy  Erin Henslee Wake Forest University  Anna Howard North Carolina State University  James Lord Virginia Tech  Randy Mondragon Colorado State University  Jacob Moore Penn State University Mont Alto  Scott Bevill Colorado Mesa University  Eric Davishahl Whatcom Community College  Joel Lanning University of California, Irvine  Richard Pugsley Tidewater Community College   The book was supported by funding from the Colorado Department of Higher Education, the Colorado State University Digital Learning Initiative, and the Colorado State University Libraries.  "
},
{
  "id": "newtons-laws",
  "level": "1",
...
},
{
  ...
  "number": "1.1.1",
  "title": "",
  "body": " This rock, likely a glacial erratic dropped here in the last ice age, is at rest with zero velocity and will remain at rest until an unbalanced force (like a crane or another ice age) causes it to move.   A large rock in a field. This rock is at rest with zero velocity and will remain at rest until a unbalanced force causes it to move.    "
},
{
  ...
  "number": "1.1.2",
  "title": "",
  "body": " In deep space, where friction and gravitational forces are negligible, an object moves with constant velocity; near a celestial body gravitational attraction continuously changes its velocity.   An artist rendering of a spacecraft near the lunar surface. In the absence of forces in space, this space capsule will maintain its current velocity.    "
},
{
...
},
{
  ...
  "number": "1.1.3",
  "title": "",
  "body": " A spinning top demonstrates rotary motion.   In image of a spinning top demonstrates rotary motion.    "
},
{
...
},
{
  ...
  "number": "1.1.4",
  "title": "",
  "body": " The earth exerts a gravitational force on the moon, and the moon exerts an equal and opposite force on the earth.   An image of the earth and the moon. Red arrows are drawn from the center of each sphere towards the center of the other sphere. The earth exerts a gravitational force on the moon, and the moon exerts an equal and opposite force on the earth.    "
},
{
...
{
  "id": "Chapter_02-vectors-14",
  "level": "2",
  "url": "Chapter_02-vectors.html#Chapter_02-vectors-14",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "Chapter_02-spherical-coordinates-5",
  "level": "2",
  "url": "coordinates-3d.html#Chapter_02-spherical-coordinates-5",
  "type": "Question",
  "number": "2.4.7",
  "title": "",
...
},
{
  "id": "unit-vectors-3",
  "level": "2",
  "url": "Chapter_02-unit-vectors.html#unit-vectors-3",
  "type": "Figure",
  "number": "2.5.1",
  "title": "",
...
},
{
  ...
  "number": "2.8.5",
  "title": "",
  "body": " Unit vector cross product circle.   An alternate way to remember this is to use the cross-product circle in this image. i is shown at the top of the circle, j is shown at the bottom left of the circle (120 degrees from i), and k is shown at the bottom right of the circle (120 degrees from j). Curved blue arrows are drawn from i to j to k (counter-clockwise) and indicated as the positive (+) direction). An outer circle is formed by red curved arrows that are drawn from k to j to i (clockwise) and indicated with the negative direction. For example when you cross i with j you are going in the positive (counter-clockwise) direction around the blue inner circle and thus the answer is +k. But when you cross j into i you go in the negative (clockwise) direction around the circle and thus get a −k. Remember that the order of cross products matters. If you put the vectors in the wrong order, you will introduce a sign error.    "
},
{
...
},
{
  ...
  "number": "2.8.6",
  "title": "",
  "body": " Augmented determinant   The image illustrates what is stated in the equation (2.8.6) which defines the cross product.    "
},
{
...
{
  "id": "Chapter_03-a-simple-case-5",
  "level": "2",
  "url": "CH03-1d-particles.html#Chapter_03-a-simple-case-5",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Free-body diagrams "
...
{
  "id": "Chapter_03-a-simple-case-6",
  "level": "2",
  "url": "CH03-1d-particles.html#Chapter_03-a-simple-case-6",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "simplified free-body diagram "
},
{
...
{
  "id": "Chapter_03-a-simple-case-15",
  "level": "2",
  "url": "CH03-1d-particles.html#Chapter_03-a-simple-case-15",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "scalar components "
...
},
{
  ...
  "body": " 2D Scalar Addition   If = and = , find the magnitude and direction of their resultant .       In this example the scalar components have different subscripts indicating that they act along different lines of action, and this must be accounted for when they are added together.  Make a sketch of the two vectors and add them using the parallelogram rule. In this case, the parallelogram is a rectangle, so right-triangle trig is appropriate.       is measured from the negative axis. The direction of from the positive axis is , so    "
},
{
...
},
{
  ...
  "number": "3.4.4",
  "title": "Cargo Boom.",
  "body": " Cargo Boom     A crate is being lowered into the cargo hold of a ship. Boom is long and acts at a 40 angle from kingpost . The boom is held in this position by topping lift which has a 1:4 slope.  Determine the forces in the boom and in the topping lift.    The boom AB is 20 m long and acts at a 40° angle from the vertical support (kingpost). The boom is connected to the bottom of the vertical support by a pin connection at point A. The boom is held in this position by topping lift BC (cable attached at point C on the kingpost and at point B on the boom) which has a -1\/4 slope.               Draw diagrams  Start by identifying the particle and drawing a free-body diagram. The particle in this case is point at the end of the boom because it is the point where all three forces intersect. Let be the tension of the topping lift, be the force in the boom, and be the weight of the load. Let and be the angles that forces and make with the horizontal.  Rearrange the forces acting on point to form a force triangle as was done in the previous example.            Find angles  Angle can be found from the slope of the topping lift.  .  Angle is the complement of the 40 angle the boom makes with the vertical kingpost.   Use these values to find the three angles in the force triangle.       Solve force triangle  With the angles and one side of the force triangle known, apply the to find the two unknown sides.          "
},
{
  "id": "utilitypole",
  "level": "2",
...
},
{
  ...
  "number": "3.4.7",
  "title": "Roller.",
  "body": " Roller     A lawn roller which weighs is being pulled up a slope at a constant velocity.  Determine the required pulling force .    A lawn roller weighs 160 lb. is being pulled up a 10° slope at a constant velocity. The force P that is pulling it up the slope is directed 40 degrees above the horizontal.             Strategy     Select a coordinate system, in this case, horizontal and vertical.  Draw a free-body diagram  Solve the equations of equilibrium using the scalar approach.          Procedure     Solving simultaneously for             Strategy     Rotate the standard coordinate system clockwise to align the new axis with force .  Draw a free-body diagram and calculate the angles between the forces and the rotated coordinate system.  Solve for force directly.          Procedure         "
},
{
  "id": "multi-particle-4",
  "level": "2",
  "url": "CH03-2d-particles.html#multi-particle-4",
  "type": "Figure",
  "number": "3.4.8",
  "title": "",
...
},
{
  ...
  "number": "4.1.6",
  "title": "",
  "body": " Point-and-curl right-hand rule for moments.   Image of a right hand demonstrating the use of the right-hand rule.    "
},
{
...
},
{
  ...
  "body": " 2D Moments - Four Ways   This problem demonstrates four different ways you can find the moment of a force about a point. The first two methods use vector algebra; the second two take a scalar approach that uses geometry and right-triangle trigonometry. All four methods are mathematically identical.   A 500-pound-force vector pulls from point D located at (0,2) feet, and we want to find the moment of this force around point A at (-4,-3) feet. A position vector r connects point A with point D   Force has a magnitude of and acts on point in the direction shown. Find the moment caused by force around point using different methods and verify that they give the same result.     Find the moment of about point using Varignon's Theorem, .       Varignon's Theorem states that the moment of a force is the sum of the moments of its components. In this example, we will determine the vertical and horizontal components of and , then add the cross products of the two perpendicular pairs.   Diagram redrawn showing rectangular components of F and corresponding perpendicular distances.   The 3:2 slope of can be expressed as an angle.  Find the components of and .   Finally, following Varignon's Theorem, add the cross products of the perpendicular component pairs.   Notes:   When finding the moment of two-dimensional vectors in component form, this is often the preferred method, as it is quick and most find the process intuitive.    The first cross product, , has a positive value because , not because you are simply multiplying two positive components.    The second cross product, , results in a negative value because .    All moments have units of force times distance, in this case [ft lbf].    The overall sign of determines the final direction. A positive value corresponds to a counterclockwise moment right thumb out of the page and a negative value indicates a clockwise moment. See for the hand diagram.         Find the moment of about point using a vector cross product, .       We can also solve for the moment using the vector determinant method of . We can use the values of , , and computed in part (a) above.   A diagram with both position vector r and force vector F broken into x and y components.   Using the the vector determinant, we find:     Notes:   Determinants are a robust way to compute two-dimensional cross products, but take a bit more effort than Varignon's Theorem. The math is exactly the same either way, which means that Varignon's Theorem is just a shortcut to working through a two-dimensional vector determinant.    The signs on the cross-product terms and still come from the right-hand rule, and conveniently the process of multiplying diagonals in the determinant takes care of the signs.    Recognize that the reason we multiply diagonals in a determinant is that we only want to multiply the perpendicular components.         Find the moment of about point by finding the perpendicular distance , .       This solution requires you to find the perpendicular distance between the point and line-of-action of . One way to find this distance is shown below.   A diagram where the line-of-action of F is extended down past A, and a perpendicular distance is drawn between point A and this line-of-action.      Draw a moderately large and accurate diagram. Too much confusion has been created by small, inaccurately-drawn diagrams. Include a right triangle whose hypotenuse connects the moment center with a convenient point on the line of action of . We have chosen point , although point would work as well.  Can you prove that is on the line of action?    Since the angle between the line of action of the force and any horizontal line is the same everywhere, appears three more times on this diagram, and gives us an angle in the right triangle.    Use right triangle trigonometry to find .     Finally, compute the moment about . The direction of comes from the observation of the right-hand rule, as scalar moment computations are not directional.         Find the moment of about point by finding the perpendicular component of , .       This solution requires you to find the rectangular component of force perpendicular to segment connecting the moment center with a point on the line of action of .  One approach to finding is shown below.   A diagram where the portion of force F perpendicular to the segment connecting A to point B, where the force is applied, is shown.      Draw a large and accurate diagram to assist in finding the distances and angles in this problem.  Draw a line through point and the point where acts, or to any other convenient point on its line of action. Then draw a rectangle aligned with this line, indicating the parallel and perpendicular components of . This rectangle consists of two congruent right triangles, having the force as their common hypotenuse. You will need to find an angle inside the triangle to find the components.    Use triangle to compute angle and the length of the hypotenuse .    Recalling that we have previously found , find .    Find using the force triangle.       Finally, compute the magnitude and the vector . The counterclockwise direction comes from the right-hand rule, since scalar moment computations are not directional.       "
},
{
  "id": "moments-4-ways",
  "level": "2",
...
},
{
  ...
  "body": " 3D Moment about a Point   A thin plate sits in the plane. Cable pulls with a tension of through a frictionless ring at point . Find the moment caused by the tension force around point .   In an axis system with x to the right, y up on the page, and z coming A thin plate OABC sits in the xy plane. Cable BD pulls with a tension of 2 kN down to anchor point D. Find the moment of the tension force around point O.        Start the problem by using the position information and tension magnitude to find the force vector . This will be done in three steps:      Find the position vector : Find position vectors by either subtracting the start-point coordinates from the end-point coordinates or focusing on the changes in the position components from to .      Find the unit vector of : Compute a unit vector by dividing by the total length of . Note that is unitless and is the pure direction of .     Multiply the unit vector by force magnitude: Now multiply by the force magnitude to find the force components.      Next, find the moment arm from point to the line of action of the force. There are two obvious options for moment arms, either or . To demonstrate how both moment arms give the same answer, solutions for both moment arms will be shown.  Option 1: Moment using   A thin plate OABC sits in the xy plane. Cable BD pulls with a tension of 2 kN down to anchor point D. A position vector r_OB goes from the origin to the tail of the 2 kN force vector.      Moment arm starts at the point we are taking the moment around, , and ends at the point .     Cross with to find the moment of about point .      Option 2: Moment using   A thin plate OABC sits in the xy plane. Cable BD pulls with a tension of 2 kN down to anchor point D. A position vector r_OB goes from the origin to the tail of the 2 kN force vector.      Moment arm starts at the point we are taking the moment around, , and ends at the point .     Cross with to find the moment of about point .      It is worth your effort to compute moments both ways for this example, or another problem, to prove to yourself that the answers work out exactly the same with different moment arms. You can actually select a moment arm from to any point on line and get the same result, but and are points on that line that we already know.   Solution drawing to moment form force F_BD on the upper left corner of thin plate OABC.   Drawing , demonstrates that a moment vector direction is both 1) the axis of rotation caused by around point , with the moment aligning to your thumb and the moment rotating around your fingers from the right-hand rule and 2) that is perpendicular to the plane formed by and . Recall that all cross products result in vectors perpendicular to the two crossed vectors.   "
},
{
  "id": "Chapter_04-moment-about-a-line-4",
  "level": "2",
  "url": "Chapter_04-moments-in-three-dimensions.html#Chapter_04-moment-about-a-line-4",
  "type": "Figure",
  "number": "4.4.4",
  "title": "",
...
{
  "id": "Chapter_04-moment-about-a-line-6",
  "level": "2",
  "url": "Chapter_04-moments-in-three-dimensions.html#Chapter_04-moment-about-a-line-6",
  "type": "Figure",
  "number": "4.4.5",
  "title": "",
...
},
{
  ...
  "body": " 3D Moment about a Line   A thin plate sits in the plane. Cable pulls with a tension of through a frictionless ring at point . Find the moment caused by the tension force around point .   alt text   A per side square box is attached to fixed pipe by two frictionless hinges and . There are two forces applied to the box, and .  For this two part example, first find the rotational moment from about line and then find the moment of and about line .     Find the magnitude of the moment caused by force about line .       The key observation to find the moment of about line is that the line of action of goes directly through line , thus force produces no moment about line . Force still pulls on the box and line , but causes no rotation about line . While you could set up a two-step or mixed triple to compute this moment, the simplest moment arm from line to force would be which results in a .      Find the magnitude of the moment caused by force about line .       Keep in mind that to compute the magnitude of a moment about a line, we need to compute a vector moment about a point on the line and then dot this vector moment onto the line's unit vector. There are two options for this computation:  Option 1: The Two-Step Method separates the cross and dot products into two distinct steps.  Compute the vector moment of about any point on line , including or , then  Dot onto the unit vector    Option 2: The Scalar Triple Product combines the cross and dot product into a single matrix determinant, including the following vectors:  Top row: Unit vector for the line of interest  Middle row: Moment arm from line of interest to force vector. We'll use as it has the most zeros, which will simplify the algebra when computing the determinant.  Bottom row: Components of force vector    Let's set up the vectors for the scalar triple product, starting with the unit vector .  The unit vector is found by dividing the position vector by its own magnitude.   Next, the middle row of the scalar triple product is one of the moment arms from to the force . There are four options that will all result in the same answer after you compute the scalar triple product.   Line drawing of moment arms going from line BG to line of action of P_2, HD.   We'll use going forward as it is a one-dimensional vector and the zeros will simplify the determinant.  Finally, the bottom row of the scalar triple product are the force vector components.   Now, combining the three vectors, here is the triple scalar product matrix:     Hence, the magnitude of the moment caused by force about line is . As we found a positive answer, this confirms that the rotation caused by is in the same direction as the vector , which is reinforced by the right-hand rule thumb direction in the diagram.   Solution line drawing showing the moment around r_GH, the force P_2, and the resulting moment M_BG.   Validating the answer with the 2-step approach, we could first sum the moment of about point G.   Given that the moment and line lie in a 2-D plane, you could even use a right triangle instead of a dot product to find the component of which lies along line .   Not all problems have simple geometry where you can form a right triangle to perform a dot product, but this process demonstrates the two-step combination of a cross and a dot product to find a moment about a line.    "
},
{
...
},
{
  ...
  "number": "4.6.3",
  "title": "",
  "body": " Sliding a vector along its line of action   A force vector is shown acting along a line of action. It is equivalent to a diagram where the same force vector has been shifted along the same line of action.    "
},
{
...
},
{
  ...
  "number": "4.7.2",
  "title": "",
  "body": " Moving a force is not an equivalent transformation     Force at end of beam.   Rigid beam fixed at O point B at length l and point A at length 2l. Force P acts downward at point A.      Force moved to center of beam.   Rigid beam fixed at O point B at length l and point A at length 2l. Force P acts downward at point B.        FBD and reactions for (a).   FBD of a rigid beam which was fixed at O point with B at length l and point A at length 2l. Force P acts downward at point A. At O, a force P acts upward. A Moment of M = 2P*l is developed in the counterclockwise direction.      FBD and reactions for (b).   FBD of a rigid beam which was fixed at O point with B at length l and point A at length 2l. Force P acts downward at point B. At O, a force P acts upward. A Moment of M = P*l is developed in the counterclockwise direction.       "
},
{
  ...
  "number": "4.7.3",
  "title": "",
  "body": " Equivalent Force-couple system     Original situation.   Rigid beam fixed on the left side, midpoint at length l and end of beam at length 2l. Force P acts downward at point A.      Add two equal and opposite forces at midpoint.   Rigid beam fixed on the left side, midpoint at length l and end of beam at length 2l. Force P acts downward at point A. Force of magnitude P acts up at the midpoint, and another force of magnitude P acts down at the midpoint.        Recognize couple.   In the previous part, the force P acting up at the midpoint and the force P acting down at the end of the beam separated by distance l are a force couple of magnitude M = P*l acting in the clockwise direction.      Replace couple to produce equivalent force-couple system, with the same reactions as .   In the previous part, the force couple can be replaced by a Moment of magnitude M = P*l acting in the clockwise direction. The reactions at the left end of the rigid beam are P acting up and M = 2*P*l acting counterclockwise.       "
},
{
...
},
{
  ...
  "number": "5.1.1",
  "title": "",
  "body": " Two-dimensional rigid bodies have three degrees of freedom.   A rectangle shown on a two dimensional plane can translate in the x- and y-directions and can rotate to any angle theta from the positive x-axis.    "
},
{
  "id": "FBD_ex1FBD2",
  "level": "2",
  ...
  "number": "5.1.2",
  "title": "",
  "body": " Three-dimensional rigid body have six degrees of freedom - three translations and three rotations.   A box shown on a three dimensional coordinate system can translate in the x-, y-, and z-directions, and can rotate to any angle thetaX around the x axis, thetaY around the y axis, and thetaZ around the z axis.    "
},
{
...
},
{
  ...
  "number": "5.2.1",
  "title": "",
  "body": " Table of common two-dimensional supports and their representation on free-body diagrams.   The table shows different supports and the corresponding number of unknown reactions. Normal supports (one unknown): force perpendicular to the surface. These supports include smooth surface, roller, rocker, pinned collar on a smooth rod, smooth pin in roller or slot. Two-force member supports (one unknown): tension or compression force in line with the two force member. These supports include a cable, a weightless link, or a spring with force F = k*delta (linear spring constant multiplied by the change in length from unstretched). Pin support (two unknowns): Two rectangular force components or one force at an unknown angle).This support is generally is a frictionless pin or hinge. Rough surface support (two unknowns): friction and normal forces or magnitude and direction of resultant force. This support type is a body contacting a rough surface. Fixed collar support (two unknowns): normal force and couple moment. This collar slides but cannot rotate. Fixed support (three unknowns): two rectangular force components and couple. This support is generally welded, bolted, or otherwise anchored.    "
},
{
...
},
{
  ...
  "number": "5.2.4",
  "title": "",
  "body": " One hand holding an object versus two hands holding the same object.   Image of one hand holding an object versus two hands holding the same object, with corresponding free-body diagrams.    "
},
{
...
},
{
  ...
  "number": "6.1.1",
  "title": "",
  "body": " Scissors and bridges are examples of engineering structures. Scissors are machines with three interconnected parts. The bridge is a truss.    Scissors     A truss bridge     "
},
{
...
},
{
  ...
  "number": "6.1.2",
  "title": "",
  "body": " Two-force members in tension and compression.   A horizontal two-force member with forces pointing away from each other (tension) and a second with forces pointing towards each other (compression).    "
},
{
...
},
{
  ...
  "number": "6.2.4",
  "title": "",
  "body": " Load paths   Load on a floor shown pointing down at the center. The load is directed through the floor and down into the columns and footings supporting the load.    "
},
{
...
},
{
  ...
  "number": "6.3.1",
  "title": "",
  "body": " Truss with riveted gusset plates.   Truss bridge with riveted gusset plates.    "
},
{
  ...
  "body": " The Danger of Simple Trusses  Simple trusses have no structural redundancy, which makes them easy to solve using the techniques of this chapter, however, this simplicity also has a dark side.     These trusses are sometimes called fracture-critical trusses because the failure of a single component can lead to catastrophic failure of the entire structure. With no redundancy, there is no alternative load path for the forces that normally would be supported by that member. You can visualize the fracture-critical nature of simple trusses by thinking about a triangle with pinned corners. If one side of a triangle fails, the other two sides lose their support and will collapse. In a full truss made of only triangles, the collapse of one triangle starts a chain reaction which causes others to collapse as well.  While fracture-critical bridges are being replaced by more robust designs, there are still thousands in service across the United States. To read more about two specific fracture critical collapses search the internet for the Silver Bridge collapse, or the I-5 Skagit River Bridge collapse.  "
},
{
  "id": "joint-labels",
  "level": "2",
  ...
  "number": "6.3.3",
  "title": "",
  "body": " Truss Labels.   A five-member truss with pin and roller connection. Pins labeled as single letters and members labeled with both pin letters.    "
},
{
  "id": "truss_reactions",
  "level": "2",
  ...
  "number": "6.3.4",
  "title": "",
  "body": " Free body diagram.   The same five-member truss free-body diagram. Truss is shown detached from its external connections with forces representing those reactions. Additional external force is shown on the top pin.    "
},
{
...
},
{
  ...
  "body": " Zero-Force Member Example    Given the truss shown, eliminate all the zero-force members, and draw the remaining truss.         There are seven zero-force members: , , , , , and .    Rule 1:  Due to two members meeting at unloaded joint , both members and are zero-force members  Due to two members meeting at unloaded joint , both members and are zero-force members    Rule 2:  Due to three forces meeting at joining , with two being collinear (internal forces in and ) then is a zero-force member.  Due to three forces meeting at joint , with two being collinear (internal forces in and ), then is a zero-force member. Note that member does not need to be perpendicular to the collinear members to be a zero force.  After removing zero-force members and , three forces remain at , with two being collinear (internal force in and external load ), making a zero-force member.     The remaining truss is shown. Note that once and are eliminated, you can effectively eliminate the joints and as the member forces in the collinear members will be equal. Also notice that the truss is still formed of triangles which fully support all of the applied forces.        "
},
{
  "id": "ggb_bf6c5jmx",
  "level": "2",
...
},
{
  ...
  "number": "6.6.1",
  "title": "",
  "body": " Frames are rigid objects containing multi-force members.   A kitchen stool is an example of a frame.    "
},
{
  "id": "vice-grips-photo",
  "level": "2",
  ...
  "number": "6.6.2",
  "title": "",
  "body": " Machines contain multi-force members that can move relative to one another.   A set of locking pliers is an example of a machine.    "
},
{
  ...
  "number": "6.6.3",
  "title": "",
  "body": " Free-body diagram of a rigid frame with pin at , roller at , and load at .   A frame of three members shaped like the capital letter A. Pin A is bottom left, and continuing clockwise are pins B, C, D and E.    "
},
{
  ...
  "number": "6.6.4",
  "title": "",
  "body": " Free body diagrams of the individual components. External forces are in red, and exposed action-reaction pairs are in blue.   Members of the frame are shown separately. Separated pin connections are shown with equal and opposite forces acting on the previously connected members.    "
},
{
  "id": "toggle-clamp-01",
  "level": "2",
  ...
  "number": "6.6.5",
  "title": "",
  "body": " Original diagram   Illustrated image of a toggle clamp.    "
},
{
  "id": "toggle-clamp-02",
  "level": "2",
  ...
  "number": "6.6.6",
  "title": "",
  "body": " Component parts.   Component parts are shown as separated from each other.    "
},
{
  "id": "toggle-clamp-03",
  "level": "2",
  ...
  "number": "6.6.7",
  "title": "",
  "body": " Free-body Diagram 1    The toggle clamp is shown separated from the floor, with the external force applied to the handle, and the reaction force of the floor on the base of the assembly.        Included  Excluded     Lever , Short Link , Wooden Block, Roller , Wall, Bearing    Floor      "
},
{
  ...
  "number": "6.6.8",
  "title": "",
  "body": " Free-body diagram 2    Toggle clamp assembly is now separated from the wall, with external forces from the wall shown acting on the assembly.        Included  Excluded     Lever , Short Link , Wooden Block, Roller , Bearing    Floor, Wall      "
},
{
  ...
  "number": "6.6.9",
  "title": "",
  "body": " Free-body diagram 3    The bearing is removed since it has equal and opposite forces on the top member.        Included  Excluded     Lever , Short Link , Wooden Block, Roller ,    Floor, Wall, Bearing      "
},
{
  ...
  "number": "6.6.10",
  "title": "",
  "body": " Free-body diagram 4 (block)    FBD of the block at the base of the clamp.     A free-body diagram of the block shows the clamping force Q, which we are seeking.  Note that . These forces are given different names since they may have different magnitudes. If the weight of the block is small (less than about 0.1%) in comparison to the other forces acting on the object it may be neglected, in which case and they could be given the same name.    "
},
{
  "id": "toggle-clamp-06",
  "level": "2",
  ...
  "number": "6.6.11",
  "title": "",
  "body": " Free-body diagram 5 (lever and link)    FBD of the toggle clamp with wooden block removed.        Included  Excluded     Lever , Short Link , Roller    Floor, Wall, Bearing , Wooden Block      "
},
{
  ...
  "number": "6.6.12",
  "title": "",
  "body": " Free-body diagram 6 (short link)    The short link of toggle clamp (a two-force member).    When drawing free-body diagrams, forces with known directions should be drawn pointing in that direction rather than breaking them into components, otherwise, you may lose track of the fact that the and components are not independent but are actually related by the direction of the force.   "
},
{
  ...
  "number": "6.6.13",
  "title": "",
  "body": " Free-body diagram 7 (roller)    FBD of the roller.    Note that the force acting on the roller is shown pointing down and to the left. This is equal and opposite to the force acting on the link at , which points up and to the right. These two must act in opposite directions because they are an action-reaction pair.   "
},
{
  ...
  "number": "6.6.14",
  "title": "",
  "body": " Free-body diagram 8    FBD of toggle clamp without the roller.        Included  Excluded     Lever , Short Link    Floor, Wall, Bearing , Wooden Block, Roller      "
},
{
  ...
  "number": "6.6.15",
  "title": "",
  "body": " Free-body diagram 9 (lever)    FBD of the single remaining member of the toggle clamp assembly.        Included  Excluded     Lever    Floor, Wall, Bearing , Wooden Block, Roller , Short Link      "
},
{
  ...
  "number": "6.6.16",
  "title": "",
  "body": " Free-body diagram 10 (Subtly incorrect)    A FBD that is incorrect because it does not include the correct reaction at the bottom pin.    This diagram doesn't accurately represent what is happening at pin .   "
},
{
...
},
{
  ...
  "number": "7.4.5",
  "title": "",
  "body": " Plate with variable thickness , divided into many volume elements .   Plate with variable thickness t.    "
},
{
  "id": "composite-parts",
  "level": "1",
...
},
{
  ...
  "number": "7.8.1",
  "title": "",
  "body": " A shelf of books with various weights.   Shelf of books.   "
},
{
  ...
  "number": "7.8.2",
  "title": "",
  "body": " Each book represented as an individual weight   Shelf with books represented by different individual weights.   "
},
{
  "id": "distributed-loads-3-5",
  "level": "2",
  "url": "distributed-loads.html#distributed-loads-3-5",
  "type": "Figure",
  "number": "7.8.3",
  "title": "",
  "body": " All the books represented as a distributed load.   All books represented as distributed load   "
},
{
  "id": "distributed-loads-3-6",
  "level": "2",
  "url": "distributed-loads.html#distributed-loads-3-6",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "resultant "
...
},
{
  ...
  "number": "8.1.2",
  "title": "",
  "body": " A horizontal force alone does not create equilibrium.   L-shaped beam turned 45 degrees with force applied horizontally to each end. If the beam is split on one leg, a horizontal force alone does not result in equilibrium; a moment is necessary.    "
},
{
  "id": "dogleg-internal",
  "level": "2",
  ...
  "number": "8.1.3",
  "title": "",
  "body": " The internal forces are represented as an equal and opposite force and a bending moment   The L-shaped beam from previous figure shown with resultant force and moment achieve equilibrium.    "
},
{
  ...
  "number": "8.1.4",
  "title": "",
  "body": " The internal forces are represented as a normal force , a shear force , and bending moment   The L-shaped beam from previous figure shown with resultant force broken into normal and shear components, as well as the bending moment.    "
},
{
...
},
{
  ...
  "number": "8.4.1",
  "title": "",
  "body": " Beam Supports    Simply Supported   Simply supported beam.      Cantilevered   Cantilevered beam.      Overhanging   Overhanging beam.      "
},
{
  "id": "VM_relations",
  "level": "1",
...
},
{
  ...
  "number": "8.5.1",
  "title": "",
  "body": " A simply supported beam with a distributed load that is a function of beam position .   A simply supported beam with a distributed load that is a function of beam position. A segment is indicated with imaginary cuts at x and at x+delta x.    "
},
{
  ...
  "number": "8.5.2",
  "title": "",
  "body": " A free-body diagram of a small section of the beam with a width of .   FBD of the small segment delta x, with shear and bending moments indicated on the \"cut\" surfaces.    "
},
{
  "id": "VM_relations-25",
  "level": "2",
  "url": "VM_relations.html#VM_relations-25",
  "type": "Remark",
  "number": "8.5.3",
  "title": "Sign Conventions.",
...
{
  "id": "Chapter_09-dry-friction-3-1",
  "level": "2",
  "url": "Chapter_09-dry-friction.html#Chapter_09-dry-friction-3-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": " Statically Equivalent Loadings  The force distribution on the bottom of an object being pushed across a surface is complex, and looks approximately like (a).  To simplify things, we first decompose the actual force into a distributed normal force perpendicular to the surface, and a distributed friction force parallel to the surface, as shown in the (b). These two distributions are further simplified into two concentrated forces representing the normal and friction components of a single resultant force, as show in (c). The net resultant force acts at the point required for equilibrium.   Equivalent representation of friction and normal forces.                        "
},
{
...
},
{
  ...
  "number": "9.3.1",
  "title": "",
  "body": " Wedges in use.    A low friction wedge is used to split logs.   Image of a hydraulic ram splitting a piece of wood.      High friction wedges are used to secure shoring timbers.   Sailors pounding wedges into damage control shoring.      "
},
{
  "id": "wedge-example",
  "level": "2",
...
},
{
  ...
  "number": "9.4.1",
  "title": "",
  "body": " Power Screws    A scissors jack uses fixed screw and a moving a nut.   Photo of a C-clamp.      A C-clamp screw rotates and translates through a fixed nut.   Photo of a C-clamp.      "
},
{
  "id": "screw_rhr",
  "level": "2",
  ...
  "number": "9.4.2",
  "title": "",
  "body": " Right Hand Threads    Loosening   Twisting a screw clockwise tightens the screw, which agrees with the right hand rule, i.e. curling fingers of right hand in the direction of the tightening places points the thumb down in the direction the screw moves as tightened.      Tightening       "
},
{
  ...
  "number": "9.4.3",
  "title": "",
  "body": " Screw Thread Handedness    Right Hand Threads   Image of two screw threads. Right hand threads are higher on the right side, and left hand threads are higher on the left side.      Left Hand Threads     "
},
{
...
},
{
  ...
  "number": "9.4.4",
  "title": "",
  "body": " Thread properties    = pitch, = mean radius     = lead angle       "
},
{
  ...
  "number": "9.4.5",
  "title": "",
  "body": " A screw jack supports a load which opposes impending motion.    Screw Jack       FBD       "
},
{
...
},
{
  ...
  "number": "9.4.7",
  "title": "",
  "body": " Three possible situations when the load acts in the direction of impending motion.    Self-locking       Impending Motion       Unwinds with load       "
},
{
...
},
{
  ...
  "number": "9.5.1",
  "title": "",
  "body": " Applications of belts.    Sailors handling a mooring line.   US Navy sailors handling a mooring line.      Power transmission pulleys.   Belt driven pulley      "
},
{
  "id": "equal-tension",
  "level": "2",
  ...
  "number": "9.5.2",
  "title": "",
  "body": " Free-body diagrams, equal tension.    FBD Belt and pulley       FBD of belt       FBD of cylinder       "
},
{
  ...
  "number": "9.5.3",
  "title": "",
  "body": " Unequal Tensions    FBD of Belt and Pulley       FBD of Belt       FBD of pulley       "
},
{
...
},
{
  ...
  "number": "9.5.6",
  "title": "",
  "body": " FBD of a differential element of a flexible belt.     "
},
{
  "id": "Chapter_09-finding-the-change-in-belt-tension-due-to-friction-10",
  "level": "2",
  "url": "Chapter_09-flexible-belt-friction.html#Chapter_09-finding-the-change-in-belt-tension-due-to-friction-10",
  "type": "Example",
  "number": "9.5.7",
  "title": "Rope Friction.",
  "body": " Rope Friction   How much force is necessary to support a weight suspended by a rope wrapped four and half times around a horizontal bar? Assume the coefficient of friction .   A rope tied to a 100 lb dumbell is wrapped around a post five times, and a person is holding the other end with finger and thumb.     Apply with and .  "
},
{
  "id": "drive-system",
  "level": "2",
  ...
  "number": "9.5.8",
  "title": "",
  "body": " Unequal Tensions    Belt Drive System   A belt-driven set of fixed axis pulleys. The pulleys are separated into separate FBDs with the tension in the belts shown to be equal and opposite.      Driving Pulley       Load Pulley       "
},
{
  ...
  "number": "9.5.9",
  "title": "",
  "body": " V-belt and pulley cross section.     "
},
{
...
},
{
  ...
  "number": "9.6.2",
  "title": "",
  "body": " Shaft Free-body Diagrams    No Moment   FBD of the shaft of the journal bearing showing the F_applied, Normal force, and the friction force opposing direction of impending motion.      Clockwise Moment       Counterclockwise Moment       "
},
{
  "id": "ring-bearing",
  "level": "2",
  ...
  "number": "9.6.3",
  "title": "",
  "body": "    Ring Bearing   Journal bearing cross section shows outside cylinder with fixed internal shaft.      Free-body Diagram       "
},
{
...
},
{
  ...
  "number": "9.7.1",
  "title": "",
  "body": " This orbital sander rotates a circular sanding disc against a stationary surface. The disc friction between the sanding disc and the surface exert a moment on both the surface and the sander.   Photo of orbital sander.    "
},
{
...
},
{
  ...
  "number": "9.7.2",
  "title": "",
  "body": " Collar bearing    Side view   A collar bearing (side view).      Contact Area   Annular contact area of collar (top view).      "
},
{
  ...
  "number": "9.7.3",
  "title": "",
  "body": " Forces and moments on differential areas   Differential Elements.    "
},
{
  ...
  "number": "9.7.4",
  "title": "",
  "body": " A circular thrust bearing.    Side view.   A thrust bearing with a circular bearing surface.      Top view.   Top view.      "
},
{
  "id": "disc-segment",
  "level": "2",
  ...
  "number": "9.7.5",
  "title": "",
  "body": " The contact area in disc brakes is often approximated as a circular arc with a contact angle .   Contact area in disc brakes approximated as a circular arc.    "
},
{
  "id": "Chapter_09-10",
  "level": "1",
...
},
{
  ...
  "number": "10.1.2",
  "title": "",
  "body": "  These three triangles are all the same size. Rank them from smallest to largest moment of inertia with respect to the axis.   Right triangle with right angle on bottom right corner. The y-axis is shown in three locations: 1) on the right, 2) at the centroid, 3) on the left.     From smallest to largest: .    Although the areas of all three triangles are the same, triangle has area on both sides of the axis and relatively close to it, and so has the smallest moment of inertia, while triangle has the most of its area far from the axis which makes its moment of inertia largest.  For parallel axes, the minimum moment of inertia will be about an axis passing through the centroid, and when axis is centroidal .   "
},
{
...
},
{
  ...
  "number": "10.3.1",
  "title": "",
  "body": " Definitions for the parallel axis theorem.   Image illustrating parallel-axis-theorem.    "
},
{
...
},
{
  ...
  "number": "10.4.8",
  "title": "",
  "body": " Beam Nomenclature   Top and bottom of beam are flanges. Vertical center column is the web. Depth is top to bottom measurement. Neutral axis and neutral plane intersect the centroid.    "
},
{
