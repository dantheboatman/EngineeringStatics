var ptx_lunr_docs = [
{
  ...
  "body": "The book was supported by the team’s tireless efforts and funding from the Colorado Department of Higher Education, the Colorado State University Digital Learning Initiative, and the Colorado State University Libraries. \n       \n         Daniel W. Baker \n         Colorado State University \n         Project lead, chapter author, and interactive developer \n       \n       \n         Devin Berg \n         University of Wisconsin - Stout \n         Chapter author \n       \n       \n         Andy Guyader \n         Cal Poly, San Luis Obispo \n         Chapter author \n       \n       \n         William Haynes \n         Massachusetts Maritime Academy \n         Chapter author, interactive developer, and PreTeXt lead \n       \n       \n         Erin Henslee \n         Wake Forest University \n         Chapter author \n       \n       \n         Anna Howard \n         North Carolina State University \n         Chapter author \n       \n       \n         James Lord \n         Virginia Tech \n         Chapter author \n       \n       \n         Randy Mondragon \n         Colorado State University \n         Interactive developer \n       \n       \n         Jacob Moore \n         Penn State University    Mont Alto \n         Chapter author \n       \n       \n         Scott Bevill \n         Colorado Mesa University \n         Chapter reviewer \n       \n       \n         Eric Davishahl \n         Whatcom Community College \n         Chapter reviewer \n       \n       \n         Joel Lanning \n         University of California, Irvine \n         Chapter reviewer \n       \n       \n         Richard Pugsley \n         Tidewater Community College \n         Chapter reviewer \n       \n     "
},
{
  "id": "preface",
  "level": "1",
...
},
{
  ...
  "body": "Newton’s Laws of Motion What are the two types of motion? What three relationships do Newton’s laws of motion define? What are physical examples for each of Newton’s three laws of motion? Translation Rotation Some moving bodies are purely translating, others are purely rotating, and many are doing both. Conveniently, we can usually separate translation and rotation and analyze them individually with independent equations. Newton's three laws and their implications with respect to translation and rotation are described below. Newton’s 1st Law Newton’s first law states that  an object will remain at rest or in uniform motion in a straight line unless acted upon by an external force . This law, also sometimes called the  law of inertia,  tells us that bodies maintain their current velocity unless a net force is applied to change it. In other words, if an object is at rest it will remain at rest until an unbalanced force changes its velocity, and if an object is moving at a constant velocity, it will hold that velocity unless a force makes it change.  Remember that velocity is a vector quantity which includes both speed and direction, so an unbalanced force may cause an object to speed up, slow down, or change direction. \nThis rock is at rest with zero velocity and will remain at rest until a unbalanced force causes it to move.  \n \n               CC-BY-SA 2.0. \n               Liz Gray \n               \n             A large rock in a field. This rock is at rest with zero velocity and will remain at rest until a unbalanced force causes it to move. \nIn the absence of friction in space, this space capsule will maintain its current velocity.\n \n               CC-0 \n               NASA \n             An artist rendering of a spacecraft near the lunar surface. In the absence of friction in space, this space capsule will maintain its current velocity. torque moment A spinning top demonstrates rotory motion. \n                Carrotmadman6 from Mauritius (DSCN8281) \n               CC-BY-2.0 \n               Wikimedia Commons \n             In image of a spinning top demonstrates rotory motion. In the absence of friction this top would spin forever, but the small frictional moment exerted at the point of contact with the table will eventually bring it to a stop. Newton’s 2nd Law \tNewton’s second law is usually succinctly stated with the familiar equation  \n         \n       where   is net force,   is mass, and   is acceleration. You will notice that the force and the acceleration are in bold face. This means these are vector quantities, having both a magnitude and a direction. Mass on the other hand is a scalar quantity, which has only a magnitude.  This equation indicates that a force will cause an object to accelerate in the direction of the net force, and the magnitude of the acceleration will be proportional to the net force but inversely proportional to the mass of the object.    In this course, Statics, we are only concerned with bodies which are  not  accelerating which simplifies things considerably. When an object is not accelerating  , which implies that it is either at rest or moving with a constant velocity.  With this restriction  Newton's Second Law  for translation simplifies to  \n         \n       where   is used to indicate the  net  force acting on the object. \tNewton’s second law for rotational motions is similar . mass moment of inertia. Again, we see that the net moment and angular acceleration are vectors, quantities with magnitude and direction. The mass moment of inertia, on the other hand, is a scalar quantity and has only a magnitude. Also, since Statics deals only with objects which are  not  accelerating   , they will always be at rest or rotating with constant angular velocity.  With this restriction Newton's second law implies that the net moment on all static objects is zero. \n         \n       Newton’s 3rd Law \tNewton’s Third Law states  \n           For every action, there is an equal and opposite reaction. \n         forces \nThe earth exerts a gravitational force on the moon, and the moon exerts an equal and opposite force on the earth.\n \n             BY-SA-3.0 \n             \n           An image of the earth and the moon. Red arrows are drawn from the center of each sphere towards the center of the other sphere. The earth exerts a gravitational force on the moon, and the moon exerts an equal and opposite force on the earth. free-body diagram Consider the situation in figure  .  Diagram (a) shows a book resting on a table supported by the floor. The weights of the book and table are placed at their centers of gravity. To solve for the forces on the legs of the table, we use the free-body diagram in (b) which treats the book and the table as a single system and replaces the floor with the forces of the floor  on  the table. In diagram (c) the book and table are treated as independent objects.  By separating them, the equal-and-opposite interaction forces of the book  on  the table and the table  on  the book are exposed. \nFree-body diagrams are used to isolate objects and identify relevant forces and moments.\n    \n                 Dan Baker \n                 \n               A Statics book rests on a table. \n                 Dan Baker \n                 \n               The floor is \"removed\" so the system is the Statics book on the table. The weight of the Statics book is shown as W_statics going down, the weight of table is shown as W_table going down, the reaction force of the floor on the table is shown as F_floor going up on each table leg. \n                 Dan Baker \n                 \n               The book is \"separated\" or \"isolated\" from the table. Now we see the force of tthe table on the book is F_table going up, and the force of the book on the table is F_book going down.  This will be discussed further in    and  . "
},
{
  "id": "objectives-1",
  "level": "2",
...
},
{
  ...
  "number": "1.1.2",
  "title": "",
  "body": "\nIn the absence of friction in space, this space capsule will maintain its current velocity.\n \n               CC-0 \n               NASA \n             An artist rendering of a spacecraft near the lunar surface. In the absence of friction in space, this space capsule will maintain its current velocity. "
},
{
  "id": "p-30",
  "level": "2",
  "url": "newtons-laws.html#p-30",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "torque moment "
},
{
  ...
  "number": "1.1.3",
  "title": "",
  "body": "A spinning top demonstrates rotory motion. \n                Carrotmadman6 from Mauritius (DSCN8281) \n               CC-BY-2.0 \n               Wikimedia Commons \n             In image of a spinning top demonstrates rotory motion. "
},
{
  "id": "p-42",
  "level": "2",
  "url": "newtons-laws.html#p-42",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "1.1.4",
  "title": "",
  "body": "\nThe earth exerts a gravitational force on the moon, and the moon exerts an equal and opposite force on the earth.\n \n             BY-SA-3.0 \n             \n           An image of the earth and the moon. Red arrows are drawn from the center of each sphere towards the center of the other sphere. The earth exerts a gravitational force on the moon, and the moon exerts an equal and opposite force on the earth. "
},
{
  "id": "p-48",
  "level": "2",
...
},
{
  ...
  "number": "1.1.5",
  "title": "",
  "body": "\nFree-body diagrams are used to isolate objects and identify relevant forces and moments.\n    \n                 Dan Baker \n                 \n               A Statics book rests on a table. \n                 Dan Baker \n                 \n               The floor is \"removed\" so the system is the Statics book on the table. The weight of the Statics book is shown as W_statics going down, the weight of table is shown as W_table going down, the reaction force of the floor on the table is shown as F_floor going up on each table leg. \n                 Dan Baker \n                 \n               The book is \"separated\" or \"isolated\" from the table. Now we see the force of tthe table on the book is F_table going up, and the force of the book on the table is F_book going down.  "
},
{
  "id": "Chapter_01-units",
  "level": "1",
  ...
  "number": "1.2",
  "title": "Units",
  "body": "Units What are the similarities and differences between the SI and US Customary Unity Systems? How do you convert a value into different units? When a Statics problem lists the pounds [lb] of a body, is this referring to pounds-force [lbf] or pounds-mass [lbm]? Most quantities used in engineering consist of a numeric value and an associated unit. The value by itself is meaningless, unless, except when the quantity is unitless.   In the United States there are two primary unit systems in use. The International System of Units, SI, abbreviated from the French  Système international (d'unités)  is the modern form of the metric system and is the most widely used system of measurement. It comprises a coherent system of units of measurement built on seven base units: the second, meter, kilogram, ampere, kelvin, mole, candela.  In statics, the only the first three base units are used.   All other units required are derived from combinations of the base units.  Prefixes to unit names are used to specify the base-10 multiple of the original unit.   The other unit system in use is the United States customary system.  This system was developed from the measurement system in use in the British Empire before the US became an independent country. However, the United Kingdom’s system of measures was overhauled in 1824 to create the Imperial system, changing the definitions of some units. Therefore, while many US units are similar to their Imperial counterparts, there are significant differences between the systems. The base units in the customary system for time, distance, and mass are the second, foot, and slug.  The magnitude of a force is measured in units of mass   times length   divided by time   squared  . In metric units, the unit of force is the newton, abbreviated N, where one newton is a kilogram multiplied by a meter per second squared. This means that a one newton force would cause a one kilogram object to accelerate at a rate of one meter per second squared.  In English units, the most common unit is the pound-force   or pound for short, where one pound is the force which can accelerate a mass of one slug at one foot per second squared.  Some textbooks prefer to use pounds mass   instead of slugs, where  .  The unit of force for the two unit systems in terms of the base units are   in SI units, and  in US customary units. \n     When you find the weight of an object from its mass you are applying Newton’s Second Law. Fundamental Units Unit System   Force   Mass   Length   Time   (Earth) SI   newton  kilogram  meter  second \n             \n           US Customary   pound  slug  foot  second \n             \n           US  \n            pound-force  pound-mass  foot  second \n             \n            shows the name and abbreviation of the standard units for weight, mass, length, time, and gravitational acceleration in SI and US unit systems. When in doubt always convert to these units.  Take care to consider the difference between mass and weight.  . Gravitational acceleration   varies up to about 0.5% across the earth’s surface due to factors including latitude and elevation, but for the purpose of this course the values in   are sufficiently accurate. Awareness of units will help you prevent errors in your engineering calculations. You should always:  Pay attention to the units of every quantity in the problem.  Forces should have force units, distances should have distance units  \n         Use the unit system given in the problem statement. Avoid unit conversions when possible.  If you must, convert given values to a consistent set of units and stick with them.  Check your work for unit consistency.  You can only add or subtract quantities which have the same units. When multiplying or dividing quantities with units, multiply or divide the units as well. The units on both sides of the equals sign must be the equivalent. Develop a sense of the magnitudes of the units and consider your answers for reasonableness.  A kilogram is about 2.2 times as massive as a pound-mass and a newton weighs about a quarter pound. Be sure to include units with every answer. \n     \tHow much does a   bag of flour weigh? \tA value in kg is a mass.  Weight is a force. \n           \n         \n           \n         \tHow much does a   bag of sugar weigh? \tWhen someone says  pounds  they probably mean  pounds-force. .   Even if they mean pounds-mass,   on earth. \n           \n         \n           \n         "
},
{
  "id": "objectives-2",
  "level": "2",
  ...
  "number": "1.2",
  "title": "",
  "body": "What are the similarities and differences between the SI and US Customary Unity Systems? How do you convert a value into different units? When a Statics problem lists the pounds [lb] of a body, is this referring to pounds-force [lbf] or pounds-mass [lbm]? "
},
{
  "id": "units_table",
  "level": "2",
  ...
  "body": "Fundamental Units Unit System   Force   Mass   Length   Time   (Earth) SI   newton  kilogram  meter  second \n             \n           US Customary   pound  slug  foot  second \n             \n           US  \n            pound-force  pound-mass  foot  second \n             \n           "
},
{
  "id": "example-1",
  "level": "2",
...
},
{
  "id": "p-75",
  "level": "2",
  "url": "Chapter_01-forces.html#p-75",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-76",
  "level": "2",
  "url": "Chapter_01-forces.html#p-76",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Body forces "
},
{
  "id": "p-78",
  "level": "2",
  "url": "Chapter_01-forces.html#p-78",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "loads "
},
{
  "id": "p-79",
  "level": "2",
  "url": "Chapter_01-forces.html#p-79",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "eaction forces reactions "
},
{
  "id": "p-80",
  "level": "2",
  "url": "Chapter_01-forces.html#p-80",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "2.1",
  "title": "Vectors",
  "body": "Vectors What differentiates a vector from a scalar? How do you identify the tip, tail, line of action, direction, and magnitude of any drawn vector? What are the standard notations for vectors and scalars in this textbook? What is the difference between the sense and orientation of a vector? Interactive Diagram Adjust the magnitude and direction of the vector with the dot at the tip, and adjust the point of application by dragging the line of action and sliding the tail along it. arrow tip tail line of action Vector Definitions The standard notation for a vector uses either an arrow above the vector name or the vector name in bold font. This book will use a bold font for vectors. You and your instructor will use a bar or an arrow above the vector name for handwritten work.  \n       point of application free vectors magnitude By itself, a vector’s magnitude is a scalar quantity, but it makes no sense to speak of a vector with a negative magnitude so vector magnitudes are always positive or zero. Multiplying a vector by -1 produces a vector with the same magnitude but pointing in the opposite direction. coordinate system origin reference direction orientation sense unit vector scalar component   The scalar component is a signed number Vectors can either be either constant or vary as a function of time, position, or something else. For example, if a force varied with time according to the function   [N] where   is the time in seconds, then the force would be   at  , and increase by   each second thereafter.  "
},
{
  "id": "objectives-5",
  "level": "2",
...
},
{
  "id": "p-97",
  "level": "2",
  "url": "Chapter_02-vectors.html#p-97",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-100",
  "level": "2",
  "url": "Chapter_02-vectors.html#p-100",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-101",
  "level": "2",
  "url": "Chapter_02-vectors.html#p-101",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "magnitude "
...
},
{
  "id": "p-104",
  "level": "2",
  "url": "Chapter_02-vectors.html#p-104",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-105",
  "level": "2",
  "url": "Chapter_02-vectors.html#p-105",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": "One-Dimensional Vectors Given two one-dimensional vectors, how do you compute and then draw the resultant? What happens when you multiply a vector by a scalar? The simplest vector calculations involve one-dimensional vectors.  You can learn some important terminology here without much mathematical difficulty. In one-dimensional situations, all vectors share the same line of action, but may point towards either end.   If the line of action has a positive end like a coordinate axis does, then a vector pointing towards that end will have a positive scalar component. Vector Addition  resultant To find the resultant vector   of two one-dimensional vectors     and    you can use the tip-to-tail technique in   below. In the tip-to-tail technique, you slide vector   until its tail is at the tip of  , and the vector from the tail of   to the tip of   is the resultant  . Note that the resultant   is the same when you add   onto  , so the order of vector addition does not matter and is considered commutative. Interactive Diagram The interactive shows  \n                 You can adjust the magnitude and direction of vectors with the tips and their position along the line of action with the tails.  When they arranged tip-to-tail, the resultant vector will appear.  The vectors are represented as scalar components multiplied by unit vector  . This is just a graphic representation of tip-to-tail addition;   regardless of where   and   are located on the line of action. One Dimensional Vector Addition Vector Subtraction The easiest way to handle vector subtraction is to add the negative of the vector you are subtracting to the other vector. In this way, you can still use the tip-to-tail technique after flipping the vector you are subtracting.  \n          Vector subtraction Find   where   and  . . You can simulate this in  .\n Set   to a value of   and   to a value of  , the negative of its actual value. Move the vectors until they are tip-to-tail. The order does not matter because vector addition is commutative.  \n                . Vector Multiplication by a Scalar Multiplying or dividing a vector by a scalar changes the vector’s magnitude but maintains its original line of action.   One common transformations is to find the negative of a vector. To find the negative of vector  , we multiply it by -1; in equation form  \n          Spatially, the effect of negating a vector this way is to rotate it by 180°. The magnitude, line of action, and orientation stay the same, but the sense reverses so now the arrowhead points in the opposite direction.  "
},
{
  "id": "objectives-6",
  "level": "2",
...
},
{
  "id": "p-108",
  "level": "2",
  "url": "Chapter_02-one-dimensional-vectors.html#p-108",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "resultant "
...
},
{
  ...
  "body": "Vector subtraction Find   where   and  . . You can simulate this in  .\n Set   to a value of   and   to a value of  , the negative of its actual value. Move the vectors until they are tip-to-tail. The order does not matter because vector addition is commutative.  \n                . "
},
{
  ...
  "body": "Two Dimensional Coordinate Systems Why are orthogonal coordinate systems useful? How do you transform between polar and Cartesian coordinates? orthogonal origin coordinates position vector scalar components rectangular polar , Rectangular Coordinates Cartesian Interactive Diagram  Move the dot to change the rectangular (  and  ) coordinates of  . \n           In most cases the   axis is horizontal and points to the right, and the   axis points vertically upward, however we are free to rotate or translate this entire coordinate system if we like.  It is usually mathematically advantageous to establish the origin at a convenient point to make measurements from, and to align one of the coordinate axes with a major feature of the problem. \n           Points are specified as an ordered pair of coordinate values separated by a  comma  and enclosed in parentheses,  . \n          Cartesian Coordinate System  Similarly, forces and other vectors will be specified with an ordered pair of scalar components enclosed by angle brackets,  . Polar Coordinates Interactive Diagram Move the dot to change the polar coordinates, (  and  ) of  . \n           polar \n           In this text, points in polar coordinates will be specified as an ordered pair of values separated by a  semicolon  and enclosed in parentheses  .   \n          Polar Coordinate System  Angles can be measured in either radians or degrees, so be sure to include a degree sign on angle   if that is what you intend. Coordinate Transformation Interactive Diagram  is defined by its rectangular components   and\/or its polar coordinates  .   Move the dot to change them simultaneously.  They are related by right triangle trigonometry.  You should be able to translate points from one coordinate system to the other whenever necessary.  The relation between  ) coordinates and   coordinates are illustrated in the diagram and right triangle trigonometry is all that is needed to convert from one representation to the other.  Coordinate Transformation  Rectangular To Polar for points (Given:   and,  ) \n           \n         Take care when using the inverse tangent function on your calculator.  Calculator angles are always in the first or fourth quadrant, and you may need to add or subtract 180° to the calculator angle to locate the point in the correct quadrant. Polar to Rectangular for points (Given:   and,  ) \n           \n         Rectangular To Polar for forces (Given: rectangular components) If you are working with forces rather than distances, the process is exactly the same but triangle is labeled differently.  The hypotenuse of the triangle is the magnitude of the vector, and sides of the right triangle are the scalar components of the force, so for vector  \n                \n             Polar to Rectangular for forces (Given: magnitude and direction) \n           \n         Rectangular to Polar Representation Express point   in polar coordinates. \n                 William Haynes \n                 CC-BY-SA \n               A graph that shows the point P = (-8.66, 5) on an x-y plane. \n             \n             Given:   ,  \n                \n             \n           You must be careful here and use some common sense.  The   angle your calculator gives you in this problem is incorrect because point   is in the second quadrant, but your calculator doesn't know this.    It can't tell whether the argument of    is negative because the    was negative or because the   was negative, so it must make an assumption and in this case it is wrong.   The arctan function on calculators will always return values in the first and fourth quadrant.  If, by inspection of the   and the   coordinates, you see that the point is in the second or third quadrant, you must add or subtract   to the calculator’s answer. So in this problem,   is really  .  After making this adjustment, the the location of   in polar coordinates is: \n             \n           Most scientific calculators include handy polar-to-rectangular and rectangular-to-polar functions which can save you time and help you avoid errors.  Perhaps you should   google your calculator model   to find out if yours does and learn how to use it? Polar to Rectangular Representation Express   force   as a pair of scalar components. \n                 William Haynes \n                 CC-BY-SA \n               The Force vector F has a magnitude of 200 N. It is shown on a circle that is evenly divided into 12 segments (slices) radially (i.e., each segment is 30 degrees, where the positive x axis is the beginning of the first segment and +30 degrees is the end of the first segment). The Force falls at the end of the 7th segment (i.e. in quadrant III). \n             \n            Given: The magnitude of force  , and from the diagram we see that the direction of   is   counterclockwise from the negative   axis. Letting   we can find the components of   with right triangle trigonometry. \n             \n           Since the force points down and to the left into the third quadrant, these values are actually negative, and the signs must be applied manually.    After making this adjustment, the the location of   expressed in rectangular coordinates is:  \n                If you would prefer not to apply the negative signs by hand, you can convert the   to an angle measured from the positive   axis and let your calculator take care of the signs.  You may use either  . For  \n                \n             \n           Although this approach is mathematically correct, experience has shown that it can lead to errors and we recommend that when you work with right triangles, use angles between zero and  , and apply signs manually as required by the physical situation. "
},
{
  "id": "objectives-7",
  "level": "2",
...
},
{
  "id": "p-124",
  "level": "2",
  "url": "cartesian-coords-2d.html#p-124",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-125",
  "level": "2",
  "url": "cartesian-coords-2d.html#p-125",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-126",
  "level": "2",
  "url": "cartesian-coords-2d.html#p-126",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-127",
  "level": "2",
  "url": "cartesian-coords-2d.html#p-127",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Cartesian "
...
},
{
  "id": "p-134",
  "level": "2",
  "url": "cartesian-coords-2d.html#p-134",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "polar "
...
},
{
  ...
  "body": "Rectangular to Polar Representation Express point   in polar coordinates. \n                 William Haynes \n                 CC-BY-SA \n               A graph that shows the point P = (-8.66, 5) on an x-y plane. \n             \n             Given:   ,  \n                \n             \n           You must be careful here and use some common sense.  The   angle your calculator gives you in this problem is incorrect because point   is in the second quadrant, but your calculator doesn't know this.    It can't tell whether the argument of    is negative because the    was negative or because the   was negative, so it must make an assumption and in this case it is wrong.   The arctan function on calculators will always return values in the first and fourth quadrant.  If, by inspection of the   and the   coordinates, you see that the point is in the second or third quadrant, you must add or subtract   to the calculator’s answer. So in this problem,   is really  .  After making this adjustment, the the location of   in polar coordinates is: \n             \n           Most scientific calculators include handy polar-to-rectangular and rectangular-to-polar functions which can save you time and help you avoid errors.  Perhaps you should   google your calculator model   to find out if yours does and learn how to use it? "
},
{
  ...
  "body": "Polar to Rectangular Representation Express   force   as a pair of scalar components. \n                 William Haynes \n                 CC-BY-SA \n               The Force vector F has a magnitude of 200 N. It is shown on a circle that is evenly divided into 12 segments (slices) radially (i.e., each segment is 30 degrees, where the positive x axis is the beginning of the first segment and +30 degrees is the end of the first segment). The Force falls at the end of the 7th segment (i.e. in quadrant III). \n             \n            Given: The magnitude of force  , and from the diagram we see that the direction of   is   counterclockwise from the negative   axis. Letting   we can find the components of   with right triangle trigonometry. \n             \n           Since the force points down and to the left into the third quadrant, these values are actually negative, and the signs must be applied manually.    After making this adjustment, the the location of   expressed in rectangular coordinates is:  \n                If you would prefer not to apply the negative signs by hand, you can convert the   to an angle measured from the positive   axis and let your calculator take care of the signs.  You may use either  . For  \n                \n             \n           Although this approach is mathematically correct, experience has shown that it can lead to errors and we recommend that when you work with right triangles, use angles between zero and  , and apply signs manually as required by the physical situation. "
},
{
  "id": "coordinates-3d",
  "level": "1",
  ...
  "body": "Three Dimensional Coordinate Systems What is a right-hand Cartesian coordinate system? What are direction cosine angles and why are they always less than 180°? How are spherical coordinates different than cylindrical coordinates? In this section we will discuss four methods to specify points and vectors in three-dimensional space. rectangular coordinates direction cosines spherical You will often need to convert from one representation to another. Good visualization skills are helpful here. Rectangular Coordinates We can extend the two-dimensional Cartesian coordinate system into three dimensions easily by adding a   axis perpendicular to the two-dimensional cartesian plane.  The notation is similar the notation used for two-dimensional vectors. Points and forces are expressed as ordered triples of rectangular coordinates following the same notation used previously. \n         \n       For nearly all three-dimensional problems, you will need the rectangular  ,  , and   locations of points in space and components of vectors before proceeding with the computations. If you are given the components upfront, then you are set to move forward, but otherwise you will need to transform one coordinate system into rectangular coordinates. Interactive Diagram Move the red point to move the vector in space.  Click the red point to switch between  -  mode and   mode. The vector can be visualized as the diagonal of a rectangular box with the  ,  , and   components as the side lengths. Three-Dimensional Rectangular Coordinates Right Handed Coordinate Systems Does it matter which way the axes are oriented?  Is it ok to make the   axis point left or the   axis point down?   \n             right-handed coordinate system right hand rule \n             To apply the right hand rule, orient your thumb and first two fingers at right angles to each other and align them with three coordinate axes. Starting with your thumb, name your the axes in alphabetical order  - - . \n           Right-handed coordinate system. \n                 \n                 \n                 CC-BY-SA-3.0 \n               The image depicts three triangles that are right angled. The vector is the hypotenuse and the adjacent sides are the, x, y, and z rectangular components. The rectangular components have corresponding coordinate direction angles (theta_x, theta_y, and theta_z).     These are the labels for the three axes and your fingers point in their positive directions.  If it is more convenient, you may name your thumb   or  , as long as you name the other two fingers in the same sequence  - -  or   - - . Direction Cosine Angles The direction of a vector in two-dimensional systems could be expressed clearly with a single angle measured from a reference axis, but adding an additional dimension means that one angle is no longer enough.  direction cosine angles coordinate direction angles Interactive Diagram  Move the red point to move the vector in space.  Click the red point to switch between  -  mode and   mode.  Rotate the diagram to see it from different angles. Note that the red, blue and green triangles are right angled although it is not always easy to see this.  The vector is the hypotenuse and the adjacent sides are the  ,  , and   rectangular components.  The rectangular components and the direction angles are shown. Direction Cosine Angles We can relate the components of a vector to its direction cosine angles using the following equations.  \n          Note the component in the numerator of each direction cosine equation is positive or negative as defined by the coordinate system, and the vector magnitude in the denominator is always positive.  From these equations, we can conclude that:\n Direction cosines are signed value between -1 and 1. Direction cosine angles must always be between   and   or  \n                Any direction cosine angle greater than   indicates a negative component along that respective axis. Spatially this is because all direction cosine angles are measured from the positive side of each axis. Mathematically this is because the cosine of any angle between 90 and 180 degrees is numerically negative. \n          Spherical Coordinates In spherical coordinates, points are specified with these three coordinates\n ,  the distance from the origin to the tip of the vector, , the angle, measured counterclockwise from the  positive   axis to the projection of the vector onto the   plane,  and , the polar angle from the   axis to the vector. \n          Interactive Diagram Use the red point to move the tip of the vector anywhere on the spherical surface. The rectangular and spherical coordinates are shown. Spherical Coordinate System What the differences between polar coordinates and terrestrial latitude\/longitude locations? In terrestrial measurements\n Coordinate   is not needed since all points are on the surface of the globe. Longitude is measured   to   East or West of the prime meridian, rather than   to   counterclockwise from the   axis. Latitude is measured    to   North or South of the equator, where as polar angle   is   to   measured from the  North Pole . \n                When vectors are specified using cylindrical coordinates the magnitude of the vector is used instead of distance   from the origin to the point. When the two given spherical angles are defined the manner shown here, the rectangular components of the vector   are found thus:\n \n            Reflect on the equations above. Can you think through the process of how they were derived? The generalized steps are as follows. First, draw an accurate sketch of the given information and define the right triangles related to both   and  . Then use trig identities on the right triangle involving the vector, the   axis and angle   to find  , and  , the projection of   onto the   plane.  Finally, se trig identities on the right triangle involving vector   and   to find the remaining components of  . Cylindrical Coordinates Cylindrical coordinate system are seldom used in statics, however they are useful in certain geometries.  Cylindrical coordinates extend two-dimensional polar coordinates by adding a   coordinate indicating the distance above or below the   plane. Points are specified with these three cylindrical coordinates. \n , the distance from the origin to the projection of the tip of the vector onto the   plane, , the angle, measured counterclockwise from the  positive   axis to the projection of the vector onto the   plane , the vertical height of the vector tip. \n          Interactive Diagram Use the red point to move the tip of the vector along the cylindrical surface. The rectangular and cylindrical coordinates are shown. Cylindrical Coordinate System Unfortunately, not all problems give the angles   and   as defined here here; so you will need to find them from the given angles in other situations.  You can use the interactive diagram in this section to practice visualizing and finding the components of a vector from a given magnitude and polar angles   and  . You should be able to find the  ,  , and   coordinates given direction angles or spherical coordinates, and vise-versa.  "
},
{
  "id": "objectives-8",
  "level": "2",
...
},
{
  "id": "insight-1",
  "level": "2",
  "url": "coordinates-3d.html#insight-1",
  "type": "Thinking Deeper",
  "number": "2.4.2",
  "title": "Right Handed Coordinate Systems.",
  "body": "Right Handed Coordinate Systems Does it matter which way the axes are oriented?  Is it ok to make the   axis point left or the   axis point down?   \n             right-handed coordinate system right hand rule \n             To apply the right hand rule, orient your thumb and first two fingers at right angles to each other and align them with three coordinate axes. Starting with your thumb, name your the axes in alphabetical order  - - . \n           Right-handed coordinate system. \n                 \n                 \n                 CC-BY-SA-3.0 \n               The image depicts three triangles that are right angled. The vector is the hypotenuse and the adjacent sides are the, x, y, and z rectangular components. The rectangular components have corresponding coordinate direction angles (theta_x, theta_y, and theta_z).     These are the labels for the three axes and your fingers point in their positive directions.  If it is more convenient, you may name your thumb   or  , as long as you name the other two fingers in the same sequence  - -  or   - - . "
},
{
  "id": "p-184",
  "level": "2",
  "url": "coordinates-3d.html#p-184",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "2.4.6",
  "title": "",
  "body": "What the differences between polar coordinates and terrestrial latitude\/longitude locations? In terrestrial measurements\n Coordinate   is not needed since all points are on the surface of the globe. Longitude is measured   to   East or West of the prime meridian, rather than   to   counterclockwise from the   axis. Latitude is measured    to   North or South of the equator, where as polar angle   is   to   measured from the  North Pole . \n                "
},
{
  "id": "figure-20",
  "level": "2",
...
},
{
  ...
  "number": "2.5",
  "title": "Unit Vectors",
  "body": "Unit Vectors Why are unit vectors useful? What are the unit vectors along the Cartesian x, y, and z axes? How do you find the force vector components of known force magnitude along a geometric line? How can you find unit vector components from direction cosine angles? A unit vector is a vector with a magnitude of one and no units.  As such, a unit vector represents a pure direction. By convention a unit vector is indicated by a  hat  over a vector symbol. This may sound like a new concept, but it’s a simple one, directly related to the unit circle, the Pythagorean Theorem, and the definitions of sine and cosine. Cartesian Unit Vectors A unit vector can point in any direction, but because they occur so frequently the unit vectors in each of the three Cartesian coordinate directions are given their own symbols, which are:  , for the unit vector pointing in the   direction, , for the unit vector pointing in the   direction, and , for the unit vector pointing in the   direction.. \n          Interactive Diagram \tThis interactive shows the graphical relations between the unit vector   and the unit circle.    and   are the standard unit vectors in the   and   directions. \n           This interactive shows a unit vector   as well as the standard unit vectors   and  .   \n           The   and   components of a point on the unit circle are also the scalar components of  , so \n . \n         Applying the Pythagorean Theorem to the triangle gives the equation for a unit circle \n         \n       No matter what angle a unit vector makes with the   axis,   and   are its scalar components. This relations assumes that the angle   is measured from the   axis, if it is measured from the   axis the sine and cosine functions reverse, with   defining the horizontal component and the   defining the vertical component.  Relation between Vectors and Unit Vectors When a unit vector is multiplied by a scalar value it is  scaled  by that amount, so for instance when a unit vector pointing to the right is multiplied by    the result is a   vector pointing to the right; when a unit vector pointing up is multiplied by    the result is a   vector pointing down.   In general,  , where   is the magnitude of  , and   is the unit vector pointing in the direction of  . Solving equation   for   gives the approach to find the unit vector of known vector  . The process is straightforward  divide the vector by its magnitude.  For arbitrary vector  \n             . To emphasize that unit vectors are pure direction, track what happens when a vector is divided by its magnitude \n . \n         \n       This interactive shows vector  , its associated unit vector  , and expressions for   in terms of its unit vector  . Interactive Diagram \n\tThis interactive shows the graphical expression and component values of force   and its unit vector  .\n Unit Vectors Find unit vector of a force Find the unit vector corresponding to a   force at 60° from the  -axis. \n             \n           In polar coordinates, the unit vector is a vector of magnitude 1, pointing in the same direction as the force, so, by inspection \n \n                In rectangular coordinates, first express   in terms of its   and   components.\n \n                Solve equation   for  \n                   \n                Force Vectors from Position Vectors Unit vectors are generally the best approach when working with forces and distances in three dimensions. For example, when the location of two points on the line of action of a force are known, the unit vector of the line of action can be found and used to determine the components of a force acting along that line.  This can be accomplished as follows, where   and   are points on the line of action.\n    Use the problem geometry to find  , the displacement vector from point   to point  ,  then either subtract the coordinates of the starting point   from the coordinates of the destination point   to find the vector  \n                      \nor, write the displacements directly by noting the distance traveled in each coordinate direction when moving from   to  .  This is really the same as the previous method.\n \n                   Find the direct distance between point   and point   using the Pythagorean Theorem. This distance is also the magnitude of   or  \n                   . Find  , the unit vector from   to  ,  by dividing vector   by its magnitude.  This is a unitless vector with a magnitude of 1 which points from   to  . Multiply the magnitude of the force by the unit vector   to get force  \n                   \n          The interactive below can be used to visualize the displacement vector and its unit vector, and practice this procedure. Interactive Diagram This interactive shows  , the displacement vector from   to   and the corresponding unit displacement vector  . You may change   and   by moving the red and blue dots.  Click the dot to switch between  -  mode and   mode.  Coordinates of   and   can also be entered into the table directly. Unit Vectors in Space Component in a Specified Direction Determine the components of a   force   acting at point  , in the direction of a line from   to  . Given:   and  \n                We will take the solution one step at a time. Draw a good diagram. The interactive in   may be useful for this problem. Find the displacement vector from   to  . \n               \n             \n               \n             Find the magnitude of the displacement vector. \n               \n             \n               \n             Find the unit vector pointing from   to  . \n               \n             \n               \n             Find the force vector. \n               \n             \n               \n             Given the properties of unit vectors, there are some conceptual checks you can make after computing unit vector components which can prevent subsequent errors.\n The signs of unit vector components need to match the signs of the original position vector. A unit vector has the same line of action and sense as the position vector but is scaled down to one unit in magnitude. Components of a unit vector must be between -1 and 1. If the magnitude of a unit vector is one, then it is impossible for it to have rectangular components larger than one. \n          Unit Vectors and Direction Cosines If you look closely at the right side of equation  , you will see that each equation consists of a component divided by the total vector magnitude. These are the same equations just used to find unit vectors. Thus, the cosine of each direction cosine angle collectively also computes the components of the unit vector; hence we can write an equation for  ,  , the unit vector along  .  \n          Combining the Pythagorean Theorem with our knowledge of unit vectors and direction cosine angles gives this result: if you know two of the three direction cosine angles you can manipulate the following equation to find the third.  \n          "
},
{
  "id": "objectives-9",
  "level": "2",
...
},
{
  ...
  "body": "Find unit vector of a force Find the unit vector corresponding to a   force at 60° from the  -axis. \n             \n           In polar coordinates, the unit vector is a vector of magnitude 1, pointing in the same direction as the force, so, by inspection \n \n                In rectangular coordinates, first express   in terms of its   and   components.\n \n                Solve equation   for  \n                   \n                "
},
{
  "id": "unit_vectors_3d",
  "level": "2",
...
},
{
  ...
  "body": "Component in a Specified Direction Determine the components of a   force   acting at point  , in the direction of a line from   to  . Given:   and  \n                We will take the solution one step at a time. Draw a good diagram. The interactive in   may be useful for this problem. Find the displacement vector from   to  . \n               \n             \n               \n             Find the magnitude of the displacement vector. \n               \n             \n               \n             Find the unit vector pointing from   to  . \n               \n             \n               \n             Find the force vector. \n               \n             \n               \n             "
},
{
...
},
{
  "id": "p-262",
  "level": "2",
  "url": "vector_algebra_2D.html#p-262",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-264",
  "level": "2",
  "url": "vector_algebra_2D.html#p-264",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-273",
  "level": "2",
  "url": "vector_algebra_2D.html#p-273",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-274",
  "level": "2",
  "url": "vector_algebra_2D.html#p-274",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "figure-24",
  "level": "2",
  "url": "vector_algebra_2D.html#figure-24",
  "type": "Figure",
  "number": "2.6.2",
  "title": "",
...
},
{
  ...
  "number": "2.6.4",
  "title": "Vector Addition.",
  "body": "Vector Addition  Vector   counterclockwise from the   axis,  and vector  \n                    counterclockwise from the   axis.   Find the resultant   by addition of scalar components. \n             \n           Use the given information to draw a sketch of the situation.  By imagining or sketching the parallelogram rule, it should be apparent that the resultant vector points up and to the left. \n             \n           This answer indicates that the resultant points down and to the left.  This is because the calculator answers for the inverse trig function will always be in the first or fourth quadrant.  To get the actual direction of the resultant, add   to the calculator result.\n \n                The final answer for the magnitude and direction of the resultant is  measured counterclockwise from the x axis. "
},
{
...
},
{
  ...
  "number": "2.7",
  "title": "Dot Products",
  "body": "Dot Products Why are dot products used for? What does it mean when the dot product of two vectors is zero? How do you use a dot product to find the angle between two vectors? What does it mean when the scalar component of the projection   is negative? dot product scalar product cross product vector product For two vectors   and   the dot product multiplication is computed by summing the products of the components.\n . An alternate, equivalent method to compute the dot product is \n  \nwhere   in the equation is the angle between between the two vectors and   and   are the magnitudes of   and  . We can conclude from this equation that the dot product of two perpendicular vectors is zero, because  , and that the dot product of two parallel vectors is the product of their magnitudes. When dotting unit vectors which have a magnitude of one, the dot products of a unit vector with itself is one and the dot product two perpendicular unit vectors is zero, so for  ,  , and   we have\n \n          Commutative. Associative. Distributive. Dot products are a particularly useful tool which can be used to compute the magnitude of a vector, determine the angle between two vectors, and find the rectangular component or projection of a vector in a specified direction.   These applications will be discussed in the following sections. Magnitude of a Vector Dot products can be used to find vector magnitudes. When a vector is dotted with itself using  , the result is the square of the magnitude of the vector.  By the Pythagorean theorem  . The proof is trivial. Consider vector  .  \n .  The results are similar for three-dimensional vectors. Find Vector Magnitude using the Dot Product \tFind the magnitude of vector   with components   ,   and  \n                \n             \n           \n             \n           Angle between Two Vectors A second application of the dot product is to find the angle between two vectors.  Equation   provides the procedure.\n \n          Angle between Orthogonal Unit Vectors Find the angle between   and  . \n             \n            This shows that   and   are perpendicular to each other. Angle between Two Vectors Find the angle between  and  . \n             \n           \n             \n           Vector Projection projectio This is illustrated in  , where   is the projection of   onto  , or alternately   is the rectangular component of   in the direction of  .  In this text we will use the symbols \n  to mean the projection of   on  , a vector quantity,  to mean the magnitude of the projection, a positive or zero valued scalar, and  to mean the scalar component of the projection (the scalar projection), a signed scalar. \n          As we have mentioned before,  the magnitude of a vector is its length and is always positive or zero, while a scalar component is a signed value which can be positive or negative.  When a scalar component is multiplied by a unit vector the result is a vector in that direction when the scalar component is positive, or   opposite when the scalar component is negative. Interactive Diagram This interactive demonstrates the relationship between vectors   and   and the projection of   onto  .    The checkbox switches between showing   and  . Vector projection in two dimensions. The interactive shows that the projection is the adjacent side of a right triangle with   as the hypotenuse.  From the definition of the dot product   we find that  , where   is the scalar component of the projection.  So, the dot product of   and   gives us the projection of   onto   times the magnitude of  . This value will be positive when  , negative when  , and zero when the vectors are perpendicular because of the properties of the cosine function.  So, to find the scalar value of the projection of   onto   we divide by the magnitude of  \n          \n         \n       The final simplified form is written in terms of the unit vector in the direction vector  . If you want the  vector  projection of   onto  , as opposed to the  scalar  projection  we just found, multiply the scalar projection by the unit vector  \n             . Similarly, the vector projection of   onto   is  . The spatial interpretation of the results the scalar projection   is  Positive value  means that   and   are generally in the same direction. Negative value means that   and   are generally in opposite directions. Zero means that    and    are perpendicular. Magnitude smaller than  \n                    This is the most common answer. The vectors are neither parallel nor perpendicular. Magnitude equal to  \n                    and   point in the same direction, thus 100% of   acts in the direction of  . Magnitude larger than  \n                     This answer is impossible. Check your algebra; you might have forgotten to divide by the magnitude of  . \n          Interactive Diagram This interactive shows the vector projection of   on   or of   on  . You may change   and   by moving the red dots or entering values into the table cells.  \n            Click dot to switch between  -  mode and   mode.  \n            The components of   and   can also be entered into the table.\n           Vector projections in three dimensions.  Perpendicular Components The final application of dot products is to find the component of one vector perpendicular to another. To find the component of    perpendicular to  , first find the vector projection of   on  , then subtract that from  .  What remains is the perpendicular component.\n \n             Perpendicular and parallel components of  . To find the component of vector B perpendicular to vector A, first find the vector projection of B on A, then subtract that from B. What remains is the perpendicular component.  "
},
{
  "id": "objectives-11",
  "level": "2",
...
},
{
  "id": "p-316",
  "level": "2",
  "url": "dot_products_2D.html#p-316",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": "Angle between Orthogonal Unit Vectors Find the angle between   and  . \n             \n            This shows that   and   are perpendicular to each other. "
},
{
...
},
{
  "id": "p-337",
  "level": "2",
  "url": "dot_products_2D.html#p-337",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "projectio "
...
},
{
  "id": "figure-29",
  "level": "2",
  "url": "dot_products_2D.html#figure-29",
  "type": "Figure",
  "number": "2.7.6",
  "title": "",
...
},
{
  "id": "p-365",
  "level": "2",
  "url": "cross-product-math.html#p-365",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "2.8.1",
  "title": "",
  "body": " Augmented determinant  \n             William Haynes \n             CC-BY-SA \n           The image illustrates what is stated in the equation (2.8.6) which defines the cross product. "
},
{
...
},
{
  ...
  "body": "3-D Cross Product Find the cross product of   and   . The components of   are in meters and   are in Newtons. \n             \n             To solve, set up the augmented determinant and evaluate it by adding the left-to-right diagonals and subtracting the right-to-left diagonals.   . \n             \n           Calculating three-dimensional cross products by hand is tedious and error prone.  Whenever you can, you should use technology to do the grunt work for you and focus on the meaning of the results.  In this solution we will use an embedded Sage calculator to calculate the cross product.  This same calculator can be used to do other problems. Given: \n             \n            and   are defined in the first two lines, and    A.cross_product(B)  is the expression to be evaluated. Click   Evaluate  to see the result.  You'll have to work out the correct units for yourself. Try changing the third line to   B.cross_product(A) .  What changes? "
},
{
...
},
{
  "id": "p-420",
  "level": "2",
  "url": "ch3-1d-particles.html#p-420",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "concentrated "
...
},
{
  ...
  "body": "1-D Vector Addition  Find the relationship between the tension in the rope and the suspended weight for the system of  . \n             \n           We learn that the tension equals the weight. The free-body diagram shows two forces acting on the particle, and since the particle is in equilibrium they must add to zero. \n \n                   We conclude that force   is equal and opposite to  , that is, since the weight is acting down, the rope acts with the same magnitude but up. Tension To find how the tension is related to  , take the absolute value of both sides \n             \n           "
},
{
  ...
  "body": "1-D Vector Addition using unit vectors Find the relation between the tension   and weight   for the system of   using unit vectors. \n             \n           Express the forces in terms of their magnitudes and the unit vector   then proceed as before,\n \n                   "
},
{
  "id": "p-443",
  "level": "2",
  "url": "CH03-1d-particles.html#p-443",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "scalar components "
},
{
  ...
  "body": "1-D Vector Addition using scalar components Find the relation between the tension   and weight   for the system of   using scalar components. \n             \n           Unsurprisingly, we get the same result. \n               The forces in this problem are   and  , so the corresponding scalar components are  . \n               Adding scalar components gives,\n \n                      \n             Unsurprisingly, we get the same result. "
},
{
  "id": "p-451",
  "level": "2",
...
},
{
  ...
  "body": "1-D Scalar Addition If   and   =  , find the magnitude and direction of their resultant  . \n             \n           Start by sketching the two forces. The subscripts indicate the line of action of the force, and the sign indicates the direction along the line of action.  A negative   points towards the negative end of the   axis. \n               \n                 \n               \n             \n                 William Haynes \n                 CC-BY-SA \n                is the scalar component of the resultant  . The negative sign on the result indicates that the resultant force acts to the left. "
},
{
  ...
  "body": "2-D Scalar Addition If   =   and   =  , find the magnitude and direction of their resultant  . \n             \n           In this example the scalar components have different subscripts indicating that they act along different lines of action, and this must be accounted for when they are added together.  \n               Make a sketch of the two vectors and add them using the parallelogram rule to get \n               \n                 \n               \n               These are the magnitude and direction of vector  . \n             \n                 William Haynes \n                 CC-BY-SA \n               "
},
{
  "id": "p-466",
  "level": "2",
  "url": "CH03-1d-particles.html#p-466",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "two-force body "
},
{
  "id": "p-468",
  "level": "2",
  "url": "CH03-1d-particles.html#p-468",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "figure-33",
  "level": "2",
  "url": "CH03-1d-particles.html#figure-33",
  "type": "Figure",
  "number": "3.3.7",
  "title": "",
...
},
{
  ...
  "number": "3.3.8",
  "title": "Tug of War.",
  "body": "Tug of War Marines and Airmen at Goodfellow Air Force Base are competing in a tug of war and have reached a stalemate.  The Marines are pulling with a force of  . How hard are the Airmen pulling? What is the tension in the rope? \n               US Air Force photo\/Staff Sgt. Laura R. McFarlane \n               \n               CC-0 \n             Marines and Airmen at Goodfellow Air Force Base competing in a tug of war. This is a simple question, but students often get it wrong at first. The tension in the rope is \\ .  Both teams are pulling with the same force. \n             \n                 Assumptions \n                 A free-body diagram of the rope is shown.   \n                 \n                 We'll solve this with scalar components because there’s no need for the additional complexity of the vector approaches in this simple situation. \n                 We'll align the   axis with the rope with positive to the right as usual to establish a coordinate system. \n                 Assume that the pull of each team can be represented by a single force. Let force   be supplied by the Marines and force   by the Airmen; call the tension in the rope  .  \n                 Assume that the weight of the rope is negligible; then the rope can be considered a particle because both forces lie along same line of action. \n               \n                 Givens \n                 . \n               \n                 Procedure \n                 Since they’re stalemated we know that the rope is in equilibrium.   \n                 Applying the equation of equilibrium gives: \n                 \n                   \n                 \n                 We find out that both teams pull with the same force.  This was probably obvious without drawing the free-body diagram or solving the equilibrium equation. \n                 It may seem equally obvious that if both teams are pulling with   in opposite directions that the tension in the rope must be .  This is wrong however. \n                 The tension in the rope   is an example of an internal force and in order to learn its magnitude we need a free-body diagram which includes force  .  To expose the internal force we take an imaginary cut through the rope and draw (or imagine) a free-body diagram of either half of the rope.  \n                 \n                 The correct answer is easily seen to be  . \n               \n           "
},
{
  "id": "wirespool",
  "level": "2",
...
},
{
  ...
  "number": "3.3.12",
  "title": "",
  "body": "How can we apply the principles of mechanics in the two previous examples if the rope and the sling are clearly not  rigid bodies? \n                       They are not rigid, but they are inextensible and in tension. Under these conditions they don't change shape, so we can treat them as rigid. If the force were to change direction and put either into compression, our assumptions and analysis would fail.  That why  tug of war  involves pulling and not pushing. "
},
{
...
},
{
  ...
  "number": "3.4.5",
  "title": "Utility Pole.",
  "body": "Utility Pole Consider the utility pole next to the road shown below. A top view is shown in the right hand diagram. If each of the six cables pulls with a force of  , determine the magnitude of the tension in the guy wire.   Utility pole. Looking at the top view of a utility pole, the parallel, horizontal beams at the top are shown. On each of the beams, three tensile forces act away from the utility pole. The tensions going to the right are 152 degrees from the tensions going to the left. Because of the type of connection of the cables to the beams, the tension in each cable is the same magnitude. A \"guy wire\" G acts 256 degrees from the tensile forces acting to the left, which is 104 degrees from the tensile forces acting to the right. \n             \n           \n             \n                 Assumptions  \n                 A utility pole isn't two-dimensional, but we will consider the top view and forces in the horizontal plane only. \n                 It also isn't a concurrent force problem because the lines of action of the forces don't all intersect at a single point.  However,  we can make it into one by replacing the forces of the three cables in each direction with a single force three times larger.  This is an example of an  equivalent transformation , a trick engineers use frequently to turn complex situations into  simpler ones.  It works here because all the tensions are equal, and the outside wires are equidistant from the center wire.  You must be careful to to justify all equivalent transformations, because they will lead to errors if they are not applied correctly.  Equivalent transformations will be discussed in greater detail in    later.   \n               \n                 Givens \n                 \n                   \n                 \n               \n                 Procedure  \n                 Begin by drawing a neat, labeled, free-body diagram of the pole, establishing a coordinate system and indicating the directions of the forces.  Although it is not necessary, it simplifies this problem considerably to note the symmetry and establish the   axis along the axis of symmetry.  Let   be the tension in one wire, and   be the tension of the guy wire. \n                 \n                 To solve apply the equations of equilibrium.  The symmetry of this problem means that the   equation is sufficient. \n                 \n                   \n                 \n               \n           This problem could have also been solved using the force triangle method. See  . "
},
{
  "id": "Slider",
  "level": "2",
...
},
{
  ...
  "number": "3.5.1",
  "title": "",
  "body": "Point-and-curl right-hand rule technique. \n             Dan Baker \n             CC-0 \n           Using your right hand, put your palm at the origin and point your fingers along the positive x axis. Then curl your fingers towards the positive y axis. Your thumb will point in the direction of the positive z axis. In this case, if the positive x axis is horizontal and to the right and the positive y axis is vertical and upwards, the positive z axis will be coming towards you. Remember that the three axes are mutually perpendicular, i.e. each axis is perpendicular to both of the others. The right hand rule is important in many aspects of engineering, so make sure that you understand how it works. Mistakes will lead to sign errors.  "
},
{
  "id": "figure-38",
  "level": "2",
  "url": "ch3-3d-particles.html#figure-38",
  "type": "Figure",
  "number": "3.5.2",
  "title": "",
  "body": " Direction Cosine Angles  "
...
},
{
  ...
  "number": "3.5.4",
  "title": "Skycam.",
  "body": "Skycam The skycam at Stanford University Stadium has a mass of   and is supported by three cables as shown.  Assuming that it is currently in equilibrium, find the tension in each of the three supporting cables. Interactive Diagram Rotating the interactive diagram may help you visualize the situation. \n                 Jrienstra \n                 \n                 CC-BY-SA \n               Skycam has mass of  20 kg and is in equilibrium. Cable A is in the x-y plane, acting 35 degrees from positive x-axis. Cable B acts -30 degrees from the  negative x-axis in the x-z plane, and 15 degrees above the x-z plane. Cable C acts 20 degrees in the y-z plane, -20 degrees from the positive z-axis. \n             \n           In this situation, the directions of all four forces are specified by the angles in the free body diagram, and the magnitude of the weight is known.  The three unknowns are the magnitudes of forces  ,  , and  .\n \n                We will first find unit vectors in the directions of the four forces by inspection of the free body diagram.  This step requires visualizing the components unit vectors, and determining the angles each makes with the coordinate axis.   \n \n                Particle equilibrium requires that  , so,  .   This is a 3   3 system of three simultaneous equation, one for each coordinate direction, which needs to be solved for  ,  , and  .\n \n                These can be solved by any method you choose.  Here we will use Sage.  Evaluating the coefficients and expressing the equations in matrix form gives\n . This is an equation in the form  .  Entering the coefficient matrixes into Sage.  After evaluating, we learn that\n . "
},
{
  "id": "exercises-2",
  "level": "1",
...
},
{
  ...
  "number": "4.1.1",
  "title": "",
  "body": "Two ways to apply the right hand rule to determine the direction of a moment. \n           \n           \n         Using the right hand, point index finger straiht out, the thumb up (like giving a thumbs-up), and the middle finger pointed perpindicular to the pointer finger and thumb. The thumb represents the position vector, and the index finger represnets the force vector. Taking the cross product r x F results in M which is representeed by the middle finger. Alternatively, r can be the index finger, F the middle finger, and M the thumb. "
},
{
  "id": "rhr4",
  "level": "2",
  ...
  "number": "4.1.2",
  "title": "",
  "body": "Point-and-curl right-hand rule technique for moments. \n           \n           \n         Image of a right hand held out flat, where r is in the direction of the fingers held out flat. If the fingers were curled in, and the thumb pointed up, then the curled fingers are in the direction of F, and the thumb in the direrction of M. "
},
{
  ...
  "body": "Magnitude of a Moment Why is there no moment about any point on the line of action of a force? If you increase the distance between a force and a point of interest, does the moment of the force go up or down?  What practical applications can you think of that could use moments to describe? scalar moment As you probably know, the strength of the moment (or torque) produced by a wrench depends on where and how much force you apply to the wrench. If the nut won't budge, you can apply a larger force or get a longer wrench, and the optimum direction to apply the force is at at right angles to the wrench’s handle.  Definition of a Moment Interactive Diagram This interactive shows  , the perpendicular distance between the center of rotation and the line of action of the force.  The moment is the  force times the perpendicular distance. \n           moment arm perpendicular distance, \n         Definition of the moment,  . Notice that since the magnitude of a moment depends only on the force and the moment arm, different points on the wrench experience different moments. Points on the force’s line of action experience no moment because there the moment arm is zero.  "
},
{
  "id": "objectives-13",
  "level": "2",
...
},
{
  "id": "p-674",
  "level": "2",
  "url": "Chapter_04-magnitude-of-a-moment.html#p-674",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "scalar moment "
},
{
  "id": "p-677",
  "level": "2",
  "url": "Chapter_04-magnitude-of-a-moment.html#p-677",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": "Verignon's theorem A   force is applied to the frame as shown.  Determine the moment this force makes about point  . \n             \n           Force   acts   from the vertical with a   magnitude, so its horizontal and vertical components are\n \n                For component  , the perpendicular distance from point   is   so the moment of this component is  . For component  , the perpendicular distance from point   is   so the moment of this component is  . Assigning a negative sign to   and a positive sign to   to account for their directions and summing, gives the moment of   about  .\n \n                The negative sign indicates that the resultant moment is clockwise, with a magnitude of  . \n             \n           "
},
{
  "id": "ggb_cgjzpe7k",
  "level": "2",
...
},
{
  "id": "figure-49",
  "level": "2",
  "url": "Chapter_04-moments-in-three-dimensions.html#figure-49",
  "type": "Figure",
  "number": "4.4.4",
  "title": "",
...
},
{
  "id": "figure-50",
  "level": "2",
  "url": "Chapter_04-moments-in-three-dimensions.html#figure-50",
  "type": "Figure",
  "number": "4.4.5",
  "title": "",
...
},
{
  "id": "p-735",
  "level": "2",
  "url": "Chapter_04-moments-in-three-dimensions.html#p-735",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-740",
  "level": "2",
  "url": "Chapter_04-couples.html#p-740",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "insight-2",
  "level": "2",
  "url": "Chapter_04-couples.html#insight-2",
  "type": "Thinking Deeper",
  "number": "4.5.2",
...
},
{
  "id": "figure-52",
  "level": "2",
  "url": "equivalent-tranformations.html#figure-52",
  "type": "Figure",
  "number": "4.6.1",
  "title": "",
  "body": "Equivalent transformations of vectors \n             William Haynes \n             CC-BY-SA \n           A fixed ring is shown with two forces F1 and F2. This is equal to a fixed ring with the resultant force shown acting at an angle of theta from the horizontal, which would be pointing towards the coordinates (F1x+F2x, F1y+F2y). This is equal to a fixed ring with a horizontal force of F*cos(theta) and vertical force of F*sin(theta). "
},
{
  "id": "insight-3",
  "level": "2",
  "url": "equivalent-tranformations.html#insight-3",
  "type": "Thinking Deeper",
  "number": "4.6.2",
...
},
{
  "id": "figure-53",
  "level": "2",
  "url": "equivalent-tranformations.html#figure-53",
  "type": "Figure",
  "number": "4.6.3",
  "title": "",
  "body": "Sliding a vector along its line of action \n             William Haynes \n             CC-BY-SA \n           A force vector is shown acting along a line of action. It is equivalent to a diagram where the same force vector has been shifted along the same line of action. "
},
{
  "id": "figure-54",
  "level": "2",
  "url": "equivalent-tranformations.html#figure-54",
  "type": "Figure",
  "number": "4.6.4",
  "title": "",
  "body": "Equivalent transformations of couples \n             William Haynes \n             CC-BY-SA \n           Six equivalent diagrams are shon representing a couple moment. Two equal and opposite forces in parallel of magnitude F separated by perpindicular distance d = two equal\/opposite parallel forces of magnitude (F\/2) separated by perpindicular distance 2d = two equal\/opposite parallel forces at a different angle separated by perpindicular distance d = two equal\/opposite parallel forces of magnitude 2F separated by a perpindicular distance of (d\/2) = a Moment of magnitude M = Fd acting counterclockwise at the middle of the object = a Moment of M = Fd acting counterclockwise at the edge of the object.  "
},
{
...
},
{
  "id": "figure-56",
  "level": "2",
  "url": "statically-equivalent-systems.html#figure-56",
  "type": "Figure",
  "number": "4.7.2",
  "title": "",
  "body": "Moving a force is not an equivalent transformation \n           Force   at end of beam. \n                   William Haynes \n                   CC-BY-SA \n                 Rigid beam fixed at O point B at length l and point A at length 2l. Force P acts downward at point A. Force   moved to center of beam. \n                   William Haynes \n                   CC-BY-SA \n                 Rigid beam fixed at O point B at length l and point A at length 2l. Force P acts downward at point B. \n           FBD and reactions for (a). \n                   William Haynes \n                   CC-BY-SA \n                 FBD of rigid beam which waas fixed at O point with B at length l and point A at length 2l. Force P acts downward at point A. At O, a force P acts upward. A Moment of M = 2P*l is developed in the counter-clockwise direction. FBD and reactions for (b). \n                   William Haynes \n                   CC-BY-SA \n                 FBD of rigid beam which waas fixed at O point with B at length l and point A at length 2l. Force P acts downward at point B. At O, a force P acts upward. A Moment of M = P*l is developed in the counter-clockwise direction. \n         "
},
{
  "id": "figure-61",
  "level": "2",
  "url": "statically-equivalent-systems.html#figure-61",
  "type": "Figure",
  "number": "4.7.3",
  "title": "",
  "body": "Equivalent Force-couple system \n           Original situation. \n                   William Haynes \n                   CC-BY-SA \n                 Rigid beam fixed on the left side, midpoint at length l and end of beam at length 2l. Force P acts downward at point A. Add two equal and opposite forces at midpoint. \n                   William Haynes \n                   CC-BY-SA \n                 Rigid beam fixed on the left side, midpoint at length l and end of beam at length 2l. Force P acts downward at point A. Force of magnitude P acts up at the midpoint, and another force of magnitude P acts down at the midpoint. \n           Recognize couple. \n                   William Haynes \n                   CC-BY-SA \n                 In the previous part, the force P acting up at the midpoint and the force P acting down at the end of the beam separated by distance l are a force couple of magnitude M = P*l acting in the clockwise direction. Replace couple to produce equivalent force-couple system, with the same reactions as  . \n                   William Haynes \n                   CC-BY-SA \n                 In the previous part, the force couple can be replaced by a Moment of magnitude M = P*l acting in the clockwise direction. The reactions at the left end of the rigid beam are P acting up and M = 2*P*l acting counter-clockwise. \n         "
},
{
...
},
{
  ...
  "body": "Equivalent Force-couple System Replace the system of forces in diagram (a) with an equivalent force-couple system at  . Replace the force-couple system at   with a single equivalent force and specify its location.   \n             \n                 CC-0 \n               Horizontal bar has point A at the left end, point B at distance d1 to the right, and point C at distance d2 to the right of point B. F1 acts down at point B, F2 acts down at point C. \n             (a) \n           \n             \n                 CC-0 \n               Horizontal bar has resultant force R acting down at point A, with moment M acting clocwise and shown at point A to produce a statically equivalent system to the original diagram. \n             (b) \n           \n             \n                 CC-0 \n               Horizontal bar has resultant force R acting downward at some distance d from point A to produce a statically equivalent system to the original diagram. \n             (c) \n           ,   and  \n             The original system is shown in (a).  Since the   and   are parallel, the magnitude of the resultant force is just the sum of the two magnitudes and it points down.  \n             The resultant moment about point   is  .  To create the equivalent system (b), the resultant force and resultant moment are placed at point  . The system in (b) can be further simplified to eliminate the moment at  , by performing the process in reverse. In (c) we place the resultant force   a  distance   away from point   such that the resultant moment around point   remains the same.  This distance can be found using  .  \n             The systems in (a), (b), and (c) are all statically equivalent "
},
{
  ...
  "body": "Finding Statically Equivalent Loads Which of the three loading systems shown are statically equivalent? \n               Dan Baker \n               CC-0 \n             A vertical column is 12 ft tall and 3 ft wide. Figure (a) has horizontal force of 10 lb acting to the left on the right side of the bar at a height of 6 ft and a clockwise moment of 80 ft-lb is shown at the bottom. Figure (b) has 10 lb force acting to the right on the left side of the bar at height of 6 ft. Another force of 20 lb acts to the left on the right side of the bar at height of 12 ft. A moment of 120 ft-lb is shown in the clockwise direction at the base. Figure (c) has a force of 10 lb acting to the left at a height of 0 ft. A clockwise moment of 40 ft-lb is shown at the bottom of the bar, and a counter-clockwise moment of 20 ft-lb is shown at the top of the bar.  (a) and (c) are statically equivalent \n           \n               Strategy \n               Evaluate the resultant force and resultant moment for each case and compare.  We choose to evaluate the resultant moment about point A, though any other point would work. \n             \n               For system (a) \n               \n                 \n               \n             \n               For system (b) \n               \n                 \n               \n             \n               For system (c) \n               \n                 \n               \n             \n         Systems (a) and (c) are statically equivalent since   and   are the same in both cases. System (b) is not as its resultant moment is different than the other two.  "
},
{
  "id": "figure-67",
  "level": "2",
  "url": "statically-equivalent-systems.html#figure-67",
  "type": "Figure",
  "number": "4.7.8",
  "title": "",
  "body": "Wrench Resultant \n               William Haynes \n               CC-BY-SA \n             "
},
{
  "id": "exercises-3",
  "level": "1",
...
},
{
  ...
  "number": "5.1.1",
  "title": "",
  "body": "\nTwo-dimensional rigid bodies have three degrees of freedom.\n    \n             Dan Baker \n             CC-BY-SA \n           A 2-D box shown on a two dimensional plane can translate in the x- and y-directions and can rotate to any angle theta from the positive x-axis. "
},
{
  "id": "FBD_ex1FBD2",
  "level": "2",
  ...
  "number": "5.1.2",
  "title": "",
  "body": "\nThree-dimensional rigid body have six degrees of freedom - three translations and three rotations.\n    \n             Dan Baker \n             CC-BY-SA \n           A 3-D box shown on a three dimensional coordianate system can translate in the x-, y-, and z-directions, and can rotate to any angle thetaX around the x axis, thetaY around the y axis, and thetaZ around the z axis. "
},
{
...
},
{
  "id": "p-864",
  "level": "2",
  "url": "Chapter_05-free-body-diagrams.html#p-864",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "5.2.3",
  "title": "",
  "body": "\nAvailable and Engaged reactions.\n    \n             Dan Baker \n             CC-BY-SA \n           A box hangs from the ceiling by a cable. It rests on a flat surface. Therefore, the tension in the cable would be zero, and the T is not engaged. In the second image, the box hangs from a cable from the ceiling. It does not rest on a surface. Thus the tension T in the cable is nonzero, i.e. it is engaged. "
},
{
  "id": "one_vs_two_hands",
  "level": "2",
...
},
{
  ...
  "number": "5.2.5",
  "title": "Fixed support.",
  "body": "Fixed support The cantilevered beam is embedded into a fixed vertical wall at  .  Draw a neat, labeled, correct free-body diagram of the beam and identify the knowns and the unknowns. \n                 Dan Baker \n                 CC-BY-SA \n               The cantilevered beam is fixed at its left end, point A. A force of 15 kip acts down at point B (4 ft from left end). A couple of 30 kip-ft acts counterclockwise shown at point C (10 ft from left end). An 8 kip force acts at the right end of the beam (20 ft from left end). The force acts down at an angle of 30 degrees clocwiwse from the vertical (i.e., at an angle of 210 degrees from the positive x axis). Begin by drawing a neat rectangle to represent the beam disconnected from its supports, then add all the known forces and couple-moments.  Label the magnitudes of the loads and the known dimensions symbolically.   \n                 Dan Baker \n                 CC-BY-SA \n               Choose the standard   coordinate system, since it aligns well with the forces. The wall at   is a fixed support which prevents the beam from translating up, down, left or right, or rotating in the plane of the page. These constraints are represented by two perpendicular forces and a concentrated moment, as shown in  .  Label these unknowns as well. The knowns in this problem are the magnitudes and directions of moment  , forces  , and   and the dimensions of the beam.  The unknowns are the two force components   and   and the scalar moment   caused by the fixed connection.  If you prefer, you may represent force   as a force of unknown magnitude acting at an unknown direction.  Whether you represent it as   and   components or as a magnitude and direction, there are two unknowns associated with force  . The three unknown reactions can be found using the three independent equations of equilibrium we will discuss later in this chapter.    "
},
{
  ...
  "body": "Frictionless pin and roller The beam is supported by a frictionless pin at   and a rocker at  .  Draw a neat, labeled, correct free-body diagram of the beam and identify the knowns and the unknowns. \n                 Dan Baker \n                 CC-BY-SA \n               The beam has a pin connection at its left end, point A. At the right end, point D (10 ft from left end), the beam has a rocker connection which rests on a surface at an angle of 30 degrees from the positive x-axis. A force of 12 kN acts down and to the right on the beam at point B (2 m from let end) at an angle of 45 degrees from the horizontal). A moment of 24 kN-m clockwise is shown at point C (5 m from left end). In this problem, the knowns are the magnitude and direction of force   and moment   and the dimensions of the beam.  The constraints are the frictionless pin at   and the rocker at  .  The pin prevents translation but not rotation, which means two it has two unknowns, represented by either magnitude and direction, or by two orthogonal components.  The rocker provides a force perpendicular to the surface it rests on, which is   from the horizontal.  This means that the line of action of force    is   from the vertical, giving us its direction but not its sense or magnitude   To draw the free body diagram, start with a neat rectangle to representing the beam disconnected from its supports, then draw and label known force   and moment   and the dimensions.  \n                 Dan Baker \n                 CC-BY-SA \n                Add forces   and   representing vector   and force   at  , acting   from the vertical.   When a force has a known line of action as with force  , draw it acting along that line; don’t break it into components.  When it is not obvious which way a reaction force actually points along its lines of action, just make your best guess and place an arrowhead accordingly.  Your calculations will confirm or refute your guess later. As in the previous example, you could alternately represent force   as an unknown magnitude acting in an unknown direction, though there is no particular advantage to doing so in this case. \n                 Dan Baker \n                 CC-BY-SA \n               "
},
{
...
},
{
  ...
  "number": "5.5.1",
  "title": "3D Bent Bar.",
  "body": "3D Bent Bar The bent bar shown is held in a horizontal plane by a fixed connection at   while cable   exerts a   force on point  .   Given  \n                    and  . Find the reaction force   and concentrated moment   with components  ,   and    required to hold the bar in this position under this condition,  \n             \n             \n           \n             \n                 Draw a free-body diagram \n                 \n                 As always, begin by drawing a free-body diagram. \n                 \n               \n                 Determine the force acting at point   in Cartesian form \n                 \n                 \n                 The force of the cable acts from   to  .  This direction is described by the displacement vector from   to  \n                             or the corresponding unit vector  .  \n                 Multiplying the unit vector by the cable tension gives the force acting on   as a three-dimensional Cartesian force vector\n \n                            .\n \n               \n                 Determine the moment about  \n                         \n                 \n                 \n                 The moment about point   is found with the   cross product   where the moment arm is the displacement vector from   to  .  \n                         \n                 \n                   \n                   \n                 \n               \n                 Apply the equations of equilibrium \n                 \n                   \n                 \n                 The resulting vector equations for the reaction force   and reaction moment   are \n .\n \n               \n           "
},
{
  ...
  "body": "Stability and Determinacy What does  stable  mean for a rigid body?  What does  determinate  mean for a rigid body?  Does stability a depend on the external loads or only the reactions? How can I tell if a system is determinate? How can I decide if a problem is both stable and determinate, which makes it solvable statics? Determinate vs. Indeterminate determinate indeterminate In order for a system to be determinate the number of unknown force and moment reaction components must be less than or equal to the number of independent equations of equilibrium available.  Each equilibrium equation derives from a degree of freedom of the system, so there may be no more unknowns than degrees of freedom.  This means that we can determine no more than three unknown reaction components in two-dimensional systems and no more than six in three-dimensional systems.    under-constrained over-constrained indeterminate Stable vs. Unstable stable unstable Rules to Validate a Stable and Determinate System There are three rules to determine if a system is both stable and determinate. While, the rules below can technically be checked in any order, they have been sorted from the quickest to the most time consuming to speed up your analysis. \n           Rule 1:  Are there exactly three reaction components on a two-dimensional body? \n                      If YES, the system is determinate. \n                      If NO, the system is indeterminate or not stable. \n         \n             CC-BY-SA \n           Three scenarios are shown. An L shaped beam has one end against a wall on the left and the other end against the ground. In the first scenario, the top left end is a roller resting against the wall, and bottom right end is a fixed pin connection. This has 3 unknowns and is determinate. The next scenario has both ends with fixed pin connections. This has 4 unknowns and is indeterminate. The final scenario has bot ends with roller conneections. This has 2 unknowns and is indeterminate. \n           Rule 2:  Are all the reaction force components parallel to one another? \n                      If YES, the system is unstable for translation. \n                      If NO, the system is stable for translation. \n         \n             CC-BY-SA \n           Four scenarios are shown. An L shaped beam has one end against a wall on the left and the other end against the ground. In the first scenario, the top left end is a roller resting against the wall, and bottom right end is a fixed pin connection. This is stable for translation. The next scenario rollers on the top of the upper horizontal part of the beam, but no roller support on the vertical wall. This is not stable for translation. In the third scenario, the top left end is a roller resting against the wall, and bottom right end is a fixed pin connection. This is stable for rotation. The fourth scenario has a roller connection at the left end against the wall, and a roller connection on the top of the upper right horizontal part of the beam. This is not stable for rotation. \n           Rule 3:  Do the lines of action of the reaction forces intersect at a single point? \n                      If YES, the system is unstable for rotation about the single intersection point. \n                      If NO, the system is stable for rotation. \n         \n             CC-BY-SA \n           "
},
{
  "id": "objectives-21",
  "level": "2",
  ...
  "number": "5.6",
  "title": "",
  "body": "What does  stable  mean for a rigid body?  What does  determinate  mean for a rigid body?  Does stability a depend on the external loads or only the reactions? How can I tell if a system is determinate? How can I decide if a problem is both stable and determinate, which makes it solvable statics? "
},
{
  "id": "p-956",
  "level": "2",
...
},
{
  "id": "p-959",
  "level": "2",
  "url": "Chapter_05-stability-and-determinacy.html#p-959",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-995",
  "level": "2",
  "url": "Chapter_06-structures.html#p-995",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "frame "
...
},
{
  "id": "p-998",
  "level": "2",
  "url": "Chapter_06-structures.html#p-998",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Solving "
},
{
  "id": "figure-79",
  "level": "2",
  "url": "Chapter_06-structures.html#figure-79",
  "type": "Figure",
  "number": "6.1.2",
  "title": "",
  "body": "Two-force members in tension and compression. \n             CC-BY-SA \n           A horizontal two-force member with forces pointing away from each other (tension) and a second with forces pointing towards each other (compression). "
},
{
...
},
{
  ...
  "number": "6.2.1",
  "title": "",
  "body": "\nExternal load and global reactions in red. Internal action-reaction pairs in blue.\n    Whole Truss A three member truss with loads shown at the pins. Exploded A three member truss separated at the pins with external loads shown acting only on the pins. "
},
{
  "id": "insight-4",
  "level": "2",
  "url": "Chapter_06-interactions-between-members.html#insight-4",
  "type": "Thinking Deeper",
  "number": "6.2.2",
...
},
{
  "id": "p-1010",
  "level": "2",
  "url": "Chapter_06-trusses.html#p-1010",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-1011",
  "level": "2",
  "url": "Chapter_06-trusses.html#p-1011",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "simple trusses "
},
{
  "id": "figure-89",
  "level": "2",
  "url": "Chapter_06-trusses.html#figure-89",
  "type": "Figure",
  "number": "6.3.1",
  "title": "",
  "body": "Truss with riveted gusset plates. \n             William Haynes \n             CC-BY-SA \n             Own work \n             Cape Cod Canal Railroad Bridge \n           Truss bridge with riveted gusset plates. "
},
{
  "id": "insight-5",
  "level": "2",
  "url": "Chapter_06-trusses.html#insight-5",
  "type": "Thinking Deeper",
  "number": "6.3.3",
  "title": "The Danger of Simple Trusses.",
  "body": "The Danger of Simple Trusses Simple trusses have no structural redundancy, which makes them easy to solve using the techniques of this chapter, however this simplicity also has a dark side.   \n             US Department of Transportation NSTB \n             \n             CC-0 \n           These trusses are sometimes called   fracture critical trusses  because the failure of a single component can lead to catastrophic failure of the entire structure.  With no redundancy, there is no alternative load path for the forces that normally would be supported by that member. You can visualize the fracture critical nature of simple trusses by thinking about a triangle with pinned corners. If one side of a triangle fails, the other two sides lose their support and will collapse. In a full truss made of only triangles, the collapse of one triangle starts a chain reaction which causes others to collapse as well.  While fracture critical bridges are being replaced by more robust designs, there are still thousands in service across the United States. To read more about two specific fracture critical collapses search the internet for the  Silver Bridge  collapse, or the  I-5 Skagit River Bridge  collapse.  "
},
{
  "id": "joint-labels",
  "level": "2",
...
},
{
  ...
  "number": "6.3.5",
  "title": "",
  "body": "\nFree body diagram.\n    \n               CC-BY-SA \n             The same five-member truss free body diagram. Truss is shown detached from its external connections with forces representing those reactions. Additional external force shown on top pin. "
},
{
  "id": "insight-6",
  "level": "2",
  ...
  "body": "Why include Zero-Force Members? You may be wondering what is the point of including a member in a truss if it supports no load. In our simplified example problems, they really are unnecessary, but in the real world, zero-force members are important for several reasons:\n We have assumed that all members have negligible weight or if not, applied half the weight to each pin.  The  actual  weight of  real  members invalidates the two-force body assumption and leads to errors.  Consider a vertical member -- the internal forces must at least support the member’s weight. Truss members are not actually rigid, and long slender members under compression will  buckle  and collapse. The so-called zero-force member will be engaged to prevent this buckling. In the previous example, members CD and DE are under compression and form an unstable equilibrium and would definitely buckle at pin   if they were not replaced with a single member   with sufficient rigidity. Trusses are often used over a wide array of loading conditions. While a member may be zero-force for one loading condition, it will likely be engaged under a different condition   think about how the load on a bridge shifts as a heavy truck drives across. \n             So finding a zero-force member in a determinate truss does not mean you can discard the member. Zero-force members can be thought of as removed from the analysis, but only for the loading you are currently analyzing. After removing zero-force members, you are left with the simplest truss which connects the reaction and applied forces with triangles. If you misinterpret the rules you may over-eliminate members and be left with missing legs of triangles or ‘floating’ forces that have no load path to the foundation. "
},
{
  ...
  "body": "Zero-Force Member Example  \tGiven the truss shown, eliminate all the zero-force members, and draw the remaining truss. \n                 CC-BY-SA \n               \tThere are six zero-force members:  ,  ,  ,  ,   and  . Rule 1: \n Due to two members meeting at unloaded joint  , both members   and   are zero-force members Due to two members meeting at unloaded joint  , both members   and   are zero-force members \n                Rule 2: \n Due to three forces meeting at joining  , with two being collinear (internal forces in   and  ) then   is a zero-force member. Due to three forces meeting at joint  , with two being collinear (internal forces   and  ), then   is a zero-force member. Note that member   does not need to be perpendicular to the collinear members to be a zero force. \n                \tThe remaining truss is shown. Note that once   and   are eliminated, you can effectively eliminate the joints   and   as the member forces in the collinear members will be equal. Also notice that the truss is still formed of triangles which fully support all of the applied forces. \n                 CC-BY-SA \n               "
},
{
  "id": "ggb_bf6c5jmx",
  "level": "2",
...
},
{
  "id": "p-1053",
  "level": "2",
  "url": "method-of-joints.html#p-1053",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-1070",
  "level": "2",
  "url": "method-of-sections.html#p-1070",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-1086",
  "level": "2",
  "url": "frames-and-machines.html#p-1086",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Frames "
},
{
  "id": "p-1087",
  "level": "2",
  "url": "frames-and-machines.html#p-1087",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Machines "
...
},
{
  ...
  "number": "6.6.2",
  "title": "",
  "body": "\nMachines contain multi-force members that can move relative to one another.\n    \n               \n               CC-BY-SA \n             A set of locking pliers is example of a machine. "
},
{
...
},
{
  ...
  "number": "6.6.4",
  "title": "",
  "body": "\nFree body diagrams of the individual components. External forces are red, exposed action-reaction pairs in blue.\n    William Haynes CC-BY-SA Members of the frame are shown separated. Separated pin connections are shown with equal and opposite forces acting on the previously connected members. "
},
{
  "id": "toggle-clamp-01",
  "level": "2",
...
},
{
  ...
  "number": "6.6.6",
  "title": "",
  "body": "\nComponent parts.\n    \n                 Dan Baker \n                 CC-BY-SA \n               Component parts are shown separated from each other. "
},
{
  "id": "toggle-clamp-03",
  "level": "2",
  ...
  "number": "6.6.7",
  "title": "",
  "body": " Free-body Diagram 1\n    \n                   Anna Howard \n                   CC-BY-SA \n                 Toggle clamp is shown separated from the floor, with the external force applied to the handle, and the reaction force of the floor on the base of the assembly. \n                Included\n             \n                Excluded\n             \n                     Lever  , Short Link  , Wooden Block, Roller  , Wall, Bearing  \n                               \n                   \n                     Floor \n                   "
},
{
  "id": "figure-102",
  "level": "2",
  "url": "frames-and-machines.html#figure-102",
  "type": "Figure",
  "number": "6.6.8",
  "title": "",
  "body": " Free-body diagram 2 \n                   Anna Howard \n                   CC-BY-SA \n                 Toggle clamp assembly is now separated from the wall, with external forcese from the wall shown acting on the assembly. \n                Included\n             \n                Excluded\n             \n                     Lever  , Short Link  , Wooden Block, Roller  , Bearing  \n                               \n                   \n                     Floor, Wall \n                   "
},
{
  "id": "figure-103",
  "level": "2",
  "url": "frames-and-machines.html#figure-103",
  "type": "Figure",
  "number": "6.6.9",
  "title": "",
  "body": " Free-body diagram 3 \n                   Anna Howard \n                   CC-BY-SA \n                 The bearing is removed since it has equal and opposite forces on the top member. \n                Included\n             \n                Excluded\n             \n                     Lever  , Short Link  , Wooden Block, Roller  ,\n                         \n                   \n                     Floor, Wall, Bearing  \n                               \n                   "
},
{
  "id": "figure-104",
  "level": "2",
  "url": "frames-and-machines.html#figure-104",
  "type": "Figure",
  "number": "6.6.10",
  "title": "",
  "body": " Free-body diagram 4 (block) \n                   Anna Howard \n                   CC-BY-SA \n                 FBD of the block at the base of the clamp. \n                 A free-body diagram of the block shows the clamping force Q, which we are seeking.    \n                 Note that  . These forces are given different names since they may have different magnitudes.  If the weight of the block is small (less than about 0.1%)  in comparison to the other forces acting on the object it may be neglected, in which case   and they could be given the same name.   \n               "
},
{
  "id": "toggle-clamp-06",
  "level": "2",
  ...
  "number": "6.6.11",
  "title": "",
  "body": " Free-body diagram 5 (lever and link) \n                   Anna Howard \n                   CC-BY-SA \n                 FBD of the toggle clamp with wooden block removed. \n                Included\n             \n                Excluded\n             \n                     Lever  , Short Link  , Roller  \n                               \n                   \n                     Floor, Wall, Bearing  , Wooden Block \n                   "
},
{
  "id": "figure-106",
  "level": "2",
  ...
  "number": "6.6.12",
  "title": "",
  "body": "Free-body diagram 6 (short link) \n                   Anna Howard \n                   CC-BY-SA \n                 The short link of toggle clamp (a two-force member). When drawing free-body diagrams, forces with known directions should be drawn pointing in that direction rather than breaking them into components, otherwise you may lose track of the fact that the   and   components are not independent but are actually related by the direction of the force.  "
},
{
  "id": "figure-107",
  "level": "2",
  ...
  "number": "6.6.13",
  "title": "",
  "body": " Free-body diagram 7 (roller) \n                   Anna Howard \n                   CC-BY-SA \n                 FBD of the roller. Note that the force   acting on the roller is shown pointing down and to the left.  This is the opposite to the force acting on the link at  , which acts up and to the right.  These two must act in opposite directions because they are an action-reaction pair. "
},
{
  "id": "figure-108",
  "level": "2",
...
},
{
  ...
  "number": "6.6.15",
  "title": "",
  "body": " Free-body diagram 9 (lever)  \n                   Anna Howard \n                   CC-BY-SA \n                 FBD of the single remaining member of the toggle clamp assembly. \n                Included\n             \n                Excluded\n             \n                     Lever  \n                               \n                   \n                     Floor, Wall, Bearing  , Wooden Block, Roller  , Short Link  \n                               \n                   "
},
{
  "id": "figure-110",
  "level": "2",
  ...
  "number": "6.6.16",
  "title": "",
  "body": "Free-body diagram 10 (Subtly incorrect) \n                 Anna Howard \n                 CC-BY-SA \n               A FBD that is incorrect because it does not include the correct reaction at the bottom pin. This diagram doesn't accurately represent what is happening at pin  . "
},
{
  ...
  "number": "6.6.17",
  "title": "Toggle Clamp.",
  "body": "Toggle Clamp Knowing that angle  , find the vertical clamping force acting on the piece at   and the magnitude of the force exerted on member   at pin   in terms of force   applied to the clamp arm at  . \n               \n             For this problem, we need two free-body diagrams.  The first links the input force   to the link force   and the second links   to the clamping force  . FBD I \n                       Dan Baker \n                       CC-BY-SA \n                     FBD of the multiforce member of the toggle clam;. FBD II \n                       Anna Howard \n                       CC-BY-SA \n                     FBD of the roller from the toggle clamp assembly. We will assume the two-force member   is in compression based on the physical situation. The forces acting on the link, lever and roller are all directed along a line-of-action defined by a 7-24-25 triangle.  Similar triangles gives \n . Applying   at   to the free-body diagram of the lever gives   in terms of  .\n \n                   The positive sign on the answer reveals that our assumption that member   was in compression was correct.      Applying     to the free-body diagram of the roller will give   in terms of  . \n \n                   While you could certainly find  ,   and   using other equilibrium equations they weren't asked for and we don't bother to find them. "
},
{
  "id": "insight-7",
  "level": "2",
  "url": "frames-and-machines.html#insight-7",
  "type": "Thinking Deeper",
  "number": "6.6.19",
...
},
{
  "id": "p-1187",
  "level": "2",
  "url": "weghted-average.html#p-1187",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-1216",
  "level": "2",
  "url": "Chapter_07-center-of-gravity.html#p-1216",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": "Simple Center of Gravity Three   boxes are distributed along the   axis as shown.  \n           \n               Find the total weight and the distance from the origin to the center of gravity of the three boxes. \n             \n               How would the center of gravity  change if the right-most box  weighed   instead of  ? \n             \n         a)  \n             b)  \n             The total weight increases by   and the center of gravity shifts to the right by  . Also, if the weights of box three doubles, the first moment of weight with respect to the origin of the third box would also double. . "
},
{
  ...
  "body": "Center of Mass center of mass Substituting   in   gives the equations for the center of mass.\n . By our assumption that   is constant on the surface of the earth,   can be factored out of the sums and drops out of the equation completely.\n . first moment of mass "
},
{
  "id": "p-1231",
  "level": "2",
  "url": "Chapter_07-center-of-mass.html#p-1231",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "center of mass "
},
{
  "id": "p-1234",
  "level": "2",
  "url": "Chapter_07-center-of-mass.html#p-1234",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "figure-116",
  "level": "2",
  "url": "Chapter_07-centroids.html#figure-116",
  "type": "Figure",
  "number": "7.4.1",
  "title": "",
...
},
{
  ...
  "number": "7.4.2",
  "title": "",
  "body": "What are the coordinates of the centroid of the I beam section shown? Symmetrical I-beam shown with width of the flange 7 cm, height of 7 cm, width of the beam and height of flanges of 1 cm. \n             \n           The cross section is symmetrical about both a vertical and horizontal centerline.  The centroid is at the intersection, in the middle.  The coordinates are measured from the origin, in the bottom left of the diagram.\n \n                "
},
{
  "id": "table-2",
  "level": "2",
  ...
  "body": "Centroids of Common Shapes \n               Shape \n             \n               Area \n             \n               \n                 \n               \n             \n               \n                 \n               \n             \n               \n                 A rectangle with width of b and height of h, centroid at (x-bar,y-bar). \n               \n             \n               \n             \n               \n                 \n               \n             \n               \n                 \n               \n             \n               \n                 A right triangle with right angle at the origin. Width of b and height of h, centroid at (x-bar,y-bar). \n               \n             \n               \n             \n               \n                 \n               \n             \n               \n                 \n               \n             \n               \n                 A trapezoid with bottom width of b, top width of a, and height of h, centroid at (x-bar,y-bar). \n               \n             \n               \n             \n               \n                 \n               \n             \n               \n                 \n               \n             \n               \n                 A circle with radius of r, centroid at (x-bar,y-bar)=(r,r). \n               \n             \n               \n             \n               \n                 \n               \n             \n               \n                 \n               \n             \n               \n                 A semicircle with radius of r, centroid at (x-bar,y-bar)=(r,4r\/(3*pi)). \n               \n             \n               \n                 \n               \n             \n               \n                 \n               \n             \n               \n                 \n                 See   for proof.  \n                         \n               \n             \n               \n                 A quarter circle with radius of r. The center of curvature is at the origin. Centroid at (x-bar,y-bar)=(4r\/(3*pi),4r\/(3*pi)). \n               \n             \n               \n             \n               \n             \n               \n             "
},
{
  "id": "note-3",
  "level": "2",
...
},
{
  ...
  "number": "7.4.5",
  "title": "",
  "body": "Plate with variable thickness  , divided into many volume elements  .\n    \n               William Haynes \n               CC-BY-SA \n             Plate with variable thickness t. "
},
{
  "id": "composite-parts",
  "level": "1",
...
{
  "id": "Chapter_07-example-interactive--centroid-of-trapezoid-and-hole",
  "level": "2",
  "url": "composite-parts.html#Chapter_07-example-interactive--centroid-of-trapezoid-and-hole",
  "type": "Example",
  "number": "7.5.1",
  "title": "Interactive: Centroid of Trapezoid and Hole.",
  "body": "Interactive: Centroid of Trapezoid and Hole \n           \n         Interactive Diagram Click  Show Parts  to see the individual parts and their centroids, as well as the centroid of the whole shape.  Move the read dots to create a different shape. Interactive of the composite body consisting of a rectangle, triangle and a circular hole.  "
},
{
  "id": "Chapter_07-example-interactive--centroid-of-composite-rectangles",
  "level": "2",
  "url": "composite-parts.html#Chapter_07-example-interactive--centroid-of-composite-rectangles",
  "type": "Example",
  "number": "7.5.3",
  "title": "Interactive: Centroid of Composite Rectangles.",
  "body": "Interactive: Centroid of Composite Rectangles This interactive shows a composite shape shape consisting of a large rectangle with a smaller rectangle subtracted. You can change the location and size of the rectangles by moving the red points.  Use this to visualize how the centroids of the whole is related to to the centroid of the parts.  Note that for objects divided into two pieces, the centroid of the whole always falls on the line connecting the centroids of the parts.  Interactive Diagram Use the red and blue dots to adjust the size of the outer and inner rectangles. The centroid of the outer rectangle is red, the inner rectangle is blue and the whole shape is black.   Can you find an example where the black centroid is between the red and blue ones? Interactive Centroids "
},
{
  "id": "question-6",
  "level": "2",
  "url": "composite-parts.html#question-6",
  "type": "Question",
  "number": "7.5.5",
  "title": "",
  "body": "When finding a centroid, what will happen if you don't measure the centroids of the parts consistently from the same origin? Your answer will be wrong! "
},
{
  "id": "objectives-28",
  "level": "2",
...
},
{
  "id": "question-7",
  "level": "2",
  "url": "Chapter_07-average-value-of-a-function.html#question-7",
  "type": "Question",
  "number": "7.6.2",
  "title": "",
  "body": "How far is it from the earth to the sun? 92,958,412 miles Siri says that   The average distance from the earth to the sun is 92,958,412 miles. \n             That’s a pretty exact answer.  What does it mean, exactly?  From what point on the earth to what point on the sun?   If the earth and sun were perfect spheres, we could use the distance between their centroids.  With more information about shape and density, we could find their centers of mass and measure between those points. The bigger problem is that this distance changes continuously as the earth revolves around the sun.  How can we find an average value for something which is continuously changing?  We need to use the methods described here, integrating the distance as a function of time over the course of a year. "
},
{
  ...
  "body": "Centroids using Integration How do you find the the centroid of an area using integration? What is a differential quantity? Why are double integrals required for square   elements and single integrals required for rectangular   elements? In this section we will use the integral form of   to find the centroids of non-homogenous objects or shapes with curved boundaries.  \n \n          With the integral equations we are mathematically breaking up a shape into an infinite number of infinitesimally small pieces and adding them together by integrating.  This powerful method is conceptually identical to the discrete sums we introduced first. Integration Process The procedure for finding centroids with integration can be broken into three steps:  Set up the integrals Usually this is the hardest step.   You should always begin by drawing a sketch of the problem and reviewing the given information.  You will need to understand the boundaries of the shape, which may be lines or functions.  You may need to know some math facts, like the definition of slope, or the equation of a line or parabola.  A bounding function  may be given as a function of  , but you want it as a function of   or vice-versa or it may have a constant which you will need to determine. You will need to choose an element of area  .  There are several choices available, including vertical strips, horizontal strips, or square elements; or in polar coordinates, rings, wedges or squares. There really is no right or wrong choice; they will all work, but one may make the integration easier than another. The best choice depends on the nature of the problem, and it takes some experience to predict which it will be. Differential Elements of Area Square element Square differential element of width dx, height dy, located at (x, y). Vertical strip Vertical differential element of width dx, height y. Horizontal strip Horizontal differential element of width x, height dy. The two most common choices for differential elements are: \n Square elements and double integrals If you choose an infinitesimal square element  , you must integrate twice, over   and over   between the appropriate integration limits.  The position of the element typically designated  . Rectangular elements and single integrals If you choose rectangular strips you eliminate the need to integrate twice.  You may select a vertical element with a different width  , and a height extending from the lower to the upper bound, or a horizontal strip with a differential height   and a width extending from the left to the right boundaries.  Either way, you only integrate once to cover the enclosed area. When finding the area enclosed by a single function  , and the   and   axes   represents a point on the function and    for vertical strips, or   for horizontal strips. \n                   You must find expressions for the area   and centroid of the element   in terms of the bounding functions. This is how we turn an integral over an area into a definite integral which can be integrated. When you have established  all these items, you can substitute them into   and proceed to the integration step. Solve the integrals This step is pure mathematics. Here are some tips if you are doing integration  by hand . Be neat,  work carefully, and check your work as you go along. Use proper mathematics notation: don't lose the differential   or   before the integration step, and don't include it afterwords.  Don't forget to use equals signs between steps.  Simplify as you go and don't substitute numbers or other constants too soon.  Pay attention to units: Area   should have units of   and the first moments of area   and   should have units of  . If your units aren't consistent, then you have made a mistake. Evaluate the centroid After you have evaluated the integrals you will have expressions or values for  ,  , and  .  All that remains is to substitute these into the defining equations for   and   and simplify.  Notice the   goes into the   equation, and vice-versa.\n \n                   Finally, plot the centroid at   on your sketch and decide if your answer makes sense for area. \n          What is  ?  is just an area, but an extremely tiny one!   differential quantity infinitesimal Some other differential quantities we will see in statics are  ,   and  , which are infinitesimal increments of distance;  , which is a differential volume;  , a differential weight;  , a differential mass, and so on.   Any product involving a differential quantity is itself a differential quantity, so if the area of a vertical strip is given by   then, even though height   is a real number, the area is a differential because   is differential.   If you like, you can pronounce the   as  the little bit of  so   reads  The little bit of area is the height   times a little bit x.  and   reads  The total area is the sum of the little bits of area. \n             Area of a General Spandrel spandrel Interactive Diagram Use the sliders to vary the exponent   and the widths of the differential strips. A general spandrel of the form  \n             Begin by identifying the bounding functions.  From the diagram, we see that the boundaries  are the function, the   axis and,  the vertical line  .  The function   has a constant    which has not been specified, but which is not arbitrary. The diagram indicates that the function passes through the origin and point  , and there is only one value of   which will cause this. We can find   by substituting   and   into the function for   and   then solving for it.\n \n          Next, choose a differential area.  For this problem a vertical strip works well.  A vertical strip has a width  , and extends from the bottom boundary to the top boundary.  Any point on the curve is   and a point directly below it on the   axis is  .  This means that the height of the strip is   and the area of the strip is (base   height), so  .   The limits on the integral are from   on the left to   on the right since we are integrating with respect to  . With these details established, the next step is to set up and evaluate the integral  . This is the familiar formula from calculus for the area under a curve.  Proceeding with the integration\n \n          This result is not a number, but a general formula for the area under a curve in terms of  ,  , and  .  Explore with the interactive, and notice for instance that when  , the shape is a rectangle and  ; when   the shape is a triangle and the  ; when   the shape is a parabola and   etc.  This single formula gives the equation for the area under a whole family of curves. Which is better, horizontal or vertical elements? Recall that the first moment of area    is the distance weighted area as measured from a desired axis. The distance term    is the the distance from the desired axis to the centroid of each differential element of area,  . \n           \n         If you’re using a single integral with a  vertical  element  \n                   \n\nand the horizontal distance from the   axis to the centroid of   would simply be\n \n                It is also possible to find    using a horizontal element but the computations are a bit more challenging. First the equation for   changes to  .  Additionally, the distance to the centroid of each element,  , must measure to the middle of the horizontal element. For this triangle,  . We find a similar contrast to finding the vertical centroidal distance   where it is easier to use a   element to find   than it is to use a   element.  The interactive below compares horizontal and vertical strips for a shape bounded by the parabola    and the diagonal line   .  Horizontal strips are a better choice in this case, because the left and right boundaries  are easy to express as functions of  .  If vertical strips are chosen, the parabola must be expressed as two different functions of  , and two integrals are needed to cover the area, the first from   to  , and the second from   to  . Interactive Diagram This interactive shows the difference between horizontal and vertical differential elements  . Note that for vertical elements, the lower bounding function changes at  , whereas for horizontal strips the bounding functions don't change over the range of  .  Use the  slider to switch to the differential element. Function demonstrating good and bad choices of differential elements. Examples This section contains several examples of finding centroids by integration, starting with very simple shapes and getting progressively more difficult.  All the examples include interactive diagrams to help you visualize the integration process, and to see how   is related to   or  . The first two examples are a rectangle and a triangle evaluated three different ways: with vertical strips, horizontal strips, and using double integration.  The different approaches produce identical results, as you would expect.  You should try to decide which method is easiest for a particular situation. Centroid of a rectangle Use integration to show that the centroid of a rectangle with a base   and a height of   is at its center. Interactive Diagram This interactive shows three possible differential elements to use for integration.  Use the red slider to change the element.  \n             \n           This solution demonstrates solving integrals using vertical rectangular strips.   Set the slider on the diagram to   to see a representative element. \n             \n                 Set up the integrals \n                 The bounding functions in this example are vertical lines   and  , and horizontal lines   and  .  \n                 The strip extends from   on the   axis to   on the top of the rectangle, and has a differential width  . \n                 The area of the strip is the base times the height, so  .   \n                 The centroid of the strip is located at its midpoint so, by inspection\n \n                         \n                 With vertical strips the variable of integration is  , and the limits on    run from   at the left to   on the right.  For a rectangle, both 0 and   are constants, but in other situations,   and the left or right limits may be functions of  . \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate.  \n\n \n                         \n                 Unsurprisingly, we learn that the area of a rectangle is base times height.  Since the area formula is well known, it was not really necessary to solve the first integral. Note that   has units of  , and   and   have units of  .  \n               \n                 Find the centroid \n                 Substituting the results into the definitions gives\n . \n               \n           This solution demonstrates solving integrals using horizontal rectangular strips.  Set the slider on the diagram to   to see a representative element. \n             \n                 Set up the integrals \n                 The bounding functions   ,  ,   and  .   \n                 The strip extends from   on the   axis to   on the right, and has a differential height  . \n                 The area of the strip is the base times the height, so  .   \n                 The centroid of the strip is located at its midpoint so, by inspection\n \n                         \n                 With horizontal strips the variable of integration is  , and the limits on   run from   at the bottom to   at the top. \n                 For a rectangle, both 0 and   are constants, but in other situations,   and the upper or lower limits may be functions of  . \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate.  The results are the same as we found using vertical strips. \n \n                         \n               \n                 Find the centroid \n                 Substituting the results into the definitions gives\n . \n               \n           This solution demonstrates solving integrals using square elements and double integrals. Set the slider on the diagram  to   to see a representative element. \n             \n                 Set up the integrals \n                 Set the slider on the diagram  to   to see a representative element. \n                 The bounding functions   ,  ,   and  .   \n                 Instead of strips, the integrals will be evaluated using square elements with width   and height   located at  . \n                 The area of the square element is the base times the height, so  .   \n                 The centroid of the strip is located at its midpoint so, by inspection\n \n                         \n                 We will integrate twice, first with respect to   and then with respect to  .  The limits on the first integral are   to   and   to   on the second.  For a rectangle, both   and   are constants.  In other situations, the upper or lower limits may be functions of   or  . \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate the  inside  integral, then the  outside  integral.  The results are the same as before.\n \n                         \n               \n                 Find the centroid \n                 Substituting the results into the definitions gives\n . \n               \n           Centroid of a triangle Use integration to locate the centroid of a triangle with base   and height of   oriented as shown in the interactive. Interactive Diagram  Use the red slider to see the options for the differential element.  \n             \n           This solution demonstrates finding the centroid of the triangle using vertical strips  .  Set the slider on the diagram to   to see a representative element. \n             \n                 Set up the integrals \n                 The bounding functions in this example are the   axis, the vertical line  , and the straight line through the origin with a slope of  . Using the slope-intercept form of the equation of a line, the upper bounding function is \n  and any point on this line is designated  . \n                 The strip extends from   on the   axis to   on the function, has a height of  , and a differential width  .  The area of this strip is  .   \n                 The centroid of the strip is located at its midpoint so, by inspection\n \n                         \n                 With vertical strips the variable of integration is  , and the limits are   to  . \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate.  In contrast to the rectangle example both   and   are functions of  , and will have to be integrated accordingly.\n \n                         \n                 We learn that the area of a triangle is one half base times height.  Since the area formula is well known, it would have been more efficient to skip the first integral.  Note that   has units of  , and   and   have units of  .  \n               \n                 Find the Centroid \n                 Substituting the results into the definitions gives\n . \n               \n           This solution demonstrates solving integrals using horizontal rectangular strips. Set the slider on the diagram to   to see a representative element. \n             \n                 Set up the integrals \n                 As before, the triangle is bounded by the   axis, the vertical line  , and the line  .  \n                 To integrate using horizontal strips, the function   must be inverted to express   in terms of  . Solving for   for   gives  .  The limits on the integral are from   to  . \n                 The strip extends from   to  , has a height of  , and a length of  , therefore the area of this strip is  .   \n                 The coordinates of the midpoint of the element are \n . \n                 These expressions are recognized as the  average  of the   and   coordinates of strip’s endpoints. \n                 A common student mistake is to use  , and  .  These would be correct if you were looking for the properties of the area to the left of the curve. \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into the definitions of   and   and integrate.  The results are the same as we found using vertical strips.  There in no need to evaluate    since we know that   for a triangle.\n \n                         \n                 It makes solving these integrals easier if you avoid prematurely substituting in the function for   and if you factor out constants whenever possible.  Here it   was not substituted until the fourth line. \n               \n                 Find the centroid \n                 Substituting the results into the definitions gives\n . \n               \n           This solution demonstrates solving integrals using square elements and double integrals. Set the slider on the diagram to   or   to see a representative element. \n             \n                 Set up the integrals \n                 As before, the triangle is bounded by the   axis, the vertical line  , and the line\n . \n                 In this solution the integrals will be evaluated using square differential elements   located at  . \n                 With double integration, you must take care to evaluate the limits correctly, since the limits on the inside integral are functions of the variable of integration of the outside integral.  The inside integral essentially stacks the elements into strips and the outside integral adds all the strips to cover the area. \n                 Choosing to express   as   means that the integral over   will be conducted first.  The limits on the inside integral are from   to  .  Then, the limits on the outside integral are from   to  \n                         \n                 Using   would reverse the order of integration, so the inside integral’s limits would be from   to  , and the limits on the outside integral would be   to  .  Either choice will give the same results  \n                            if you don't make any errors! \n                         \n                 The area of the square element is the base times the height, so  .  The centroid of the square is located at its midpoint so, by inspection\n \n                         \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate the  inside  integral, then the  outside  integral.  The results are the same as before.\n \n                         \n               \n                 Find the centroid \n                 Substituting Q_x and   along with   into the centroid definitions gives\n . \n               \n           The next two examples involve areas with functions for both boundaries,  Centroid of a semi-parabola Find the coordinates of the centroid of a parabolic spandrel bounded by the   axis, a horizontal line passing through the point   and a parabola with a vertex at the origin and passing through the same point.    and   are positive integers. Interactive Diagram  In this diagram you may change the positions of the red points.  \n             \n           We will use   with vertical strips to find the centroid of a spandrel.   \n             \n                 Set up the integrals \n                 Determining the bounding functions and setting up the integrals is usually the most difficult part of problems like this. Begin by drawing and labeling a sketch of the situation.  \n                 \n                   Place a point in the first quadrant and label it  . This point is in the first quadrant and fixed since we are told that   and   are positive integers Place a horizontal line through   to make the upper bound. Sketch in a parabola with a vertex at the origin and passing through   and shade in the enclosed area. Decide which differential element you intend to use. For this example we choose to use vertical strips, which you can see if you tick   show strips  in the interactive above.  Horizontal strips   would give the same result, but you would need to define the equation for the parabola in terms of  .  \n                 \n                 Determining the equation of the parabola and expressing it in terms of of   and any known constants is a critical step.  You should remember from algebra that the general equation of parabola with a vertex at the origin is  , where   is a constant which determines the shape of the parabola.  If  , the parabola opens upward and if  , the parabola opens downward. \n                 To find the value of  , substitute the coordinates of   into the general equation, then solve for  .  \n                         \n                 The resulting function of the parabola is  .   \n                 To perform the integrations, express the area and centroidal coordinates of the element in terms of the points at the top and bottom of the strip.  The area of the strip is its height times its base, so  .  If you incorrectly used  , you would find the centroid of the spandrel below the curve. \n                 For vertical strips, the bottom is at   on the parabola, and the top is directly above at  .  The strip has a differential width  . The centroid of the strip is located at its midpoint and the coordinates are are found by averaging the   and   coordinates of the points at the top and bottom.\n \n                         \n                 For vertical strips, the integrations are with respect to  , and the limits on the integrals are   on the left to   on the right. \n               \n                 Solve the integrals \n                 We have already established that   where  .  To simplify the algebra, it is best not to prematurely substitute y(x) and  , but you must substitute in any functions of   before you do the integration step.  \n                 \n                   \n                 \n                 The area of the spandrel is   of the area of the enclosing rectangle and the moments of area have units of  .  \n               \n                 Find the centroid \n                 Substituting the results into the definitions gives\n . \n                  is   of the width and   is   of the height of the enclosing rectangle. \n               \n           Centroid of an area between two curves Use integration to locate the centroid of the area bounded by  . Interactive Diagram \n                    Use the red slider to see the options for the differential element.  \n                 Find the centroid location    of the shaded area between the two curves below. \n             \n           This solution demonstrates finding the centroid of the area between two functions using vertical strips  .  Set the slider on the diagram to   to see a representative element. \n             \n                 Set up the integrals \n                 The bounding functions in this example are the   axis, the vertical line  , and the straight line through the origin with a slope of  . Using the slope-intercept form of the equation of a line, the upper bounding function is \n  and any point on this line is designated  . \n                 The strip extends from   on the   axis to   on the function, has a height of  , and a differential width  .  The area of this strip is  .   \n                 The centroid of the strip is located at its midpoint so, by inspection\n \n                         \n                 With vertical strips the variable of integration is  , and the limits are   to  . \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate.  In contrast to the rectangle example both   and   are functions of  , and will have to be integrated accordingly.\n \n                            \n                         \n               \n                 Find the Centroid \n                 Substituting the results into the definitions gives\n . \n               \n           This solution demonstrates finding the centroid of the area between two functions using vertical strips  .  Set the slider on the diagram to   to see a representative element. \n             \n                 Set up the integrals \n                 The bounding functions in this example are the   axis, the vertical line  , and the straight line through the origin with a slope of  . Using the slope-intercept form of the equation of a line, the upper bounding function is \n  and any point on this line is designated  . \n                 The strip extends from   on the   axis to   on the function, has a height of  , and a differential width  .  The area of this strip is  .   \n                 The centroid of the strip is located at its midpoint so, by inspection\n \n                         \n                 With vertical strips the variable of integration is  , and the limits are   to  . \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate.  In contrast to the rectangle example both   and   are functions of  , and will have to be integrated accordingly.\n \n                            \n                         \n               \n                 Find the Centroid \n                 Substituting the results into the definitions gives\n . \n               \n           The last example demonstrates using double integration with polar coordinates. Centroid of a semi-circle Find the coordinates of the top half of a circle with radius  , centered at the origin. Interactive Diagram This shows the differential element   used with polar coordinates. The centroid of a semicircle with radius  , centered at the origin is\n \n                We will use   with polar coordinates   to solve this problem because they are a natural fit for the geometry. In polar coordinates, the equation for the bounding semicircle is simply  . Normally this involves evaluating three integrals but as you will see, we can take some shortcuts in this problem. Otherwise we will follow the same procedure as before. \n             \n                 Set up the integrals \n                 Divide the semi-circle into \"rectangular\" differential elements of area  , as shown in the interactive when you select   Show element . This shape is not really a rectangle, but in the limit as   and   approach zero, it doesn't make any difference. \n                 The radial height of the rectangle is   and the tangential width is the arc length  .  The product is the differential area  .  .   \n                 The differential element is located at   in polar coordinates.  Expressing this point in rectangular coordinates gives\n . \n               \n                 Solve the integrals \n                 The area of a semicircle is well known, so there is no need to actually evaluate  ,  . \n                 Since the semi-circle is symmetrical about the   axis,  . This is because each element of area to the right of the   axis is balanced by a corresponding element the same distance the left which cancel each other out in the sum. \n                 All that remains is to evaluate the integral   in the numerator of \n \n                         \n                 The differential area   is the product of two differential quantities, we will need to perform a double integration.\n \n                         \n               \n                 Find the centroid \n                 Substituting the results into the definitions gives\n . \n                 So   and lies on the axis of symmetry, and    above the diameter. \n                 This result can be extended by noting that a semi-circle is mirrored quarter-circles on either side of the   axis.  These must have the same   value as the semi-circle.  Further, quarter-circles are symmetric about a   line, so for the quarter-circle in the first quadrant,  . \n               \n           "
},
{
  "id": "objectives-29",
  "level": "2",
...
},
{
  "id": "p-1354",
  "level": "2",
  "url": "centroids-by-integration.html#p-1354",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": ""
},
{
  "id": "figure-121",
  "level": "2",
  "url": "centroids-by-integration.html#figure-121",
  "type": "Figure",
  "number": "7.7.1",
  "title": "",
...
},
{
  "id": "insight-8",
  "level": "2",
  "url": "centroids-by-integration.html#insight-8",
  "type": "Thinking Deeper",
  "number": "7.7.2",
...
},
{
  "id": "p-1379",
  "level": "2",
  "url": "centroids-by-integration.html#p-1379",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "spandrel "
...
},
{
  ...
  "body": "Which is better, horizontal or vertical elements? Recall that the first moment of area    is the distance weighted area as measured from a desired axis. The distance term    is the the distance from the desired axis to the centroid of each differential element of area,  . \n           \n         If you’re using a single integral with a  vertical  element  \n                   \n\nand the horizontal distance from the   axis to the centroid of   would simply be\n \n                It is also possible to find    using a horizontal element but the computations are a bit more challenging. First the equation for   changes to  .  Additionally, the distance to the centroid of each element,  , must measure to the middle of the horizontal element. For this triangle,  . We find a similar contrast to finding the vertical centroidal distance   where it is easier to use a   element to find   than it is to use a   element.  The interactive below compares horizontal and vertical strips for a shape bounded by the parabola    and the diagonal line   .  Horizontal strips are a better choice in this case, because the left and right boundaries  are easy to express as functions of  .  If vertical strips are chosen, the parabola must be expressed as two different functions of  , and two integrals are needed to cover the area, the first from   to  , and the second from   to  . Interactive Diagram This interactive shows the difference between horizontal and vertical differential elements  . Note that for vertical elements, the lower bounding function changes at  , whereas for horizontal strips the bounding functions don't change over the range of  .  Use the  slider to switch to the differential element. Function demonstrating good and bad choices of differential elements. "
},
{
  ...
  "body": "Centroid of a rectangle Use integration to show that the centroid of a rectangle with a base   and a height of   is at its center. Interactive Diagram This interactive shows three possible differential elements to use for integration.  Use the red slider to change the element.  \n             \n           This solution demonstrates solving integrals using vertical rectangular strips.   Set the slider on the diagram to   to see a representative element. \n             \n                 Set up the integrals \n                 The bounding functions in this example are vertical lines   and  , and horizontal lines   and  .  \n                 The strip extends from   on the   axis to   on the top of the rectangle, and has a differential width  . \n                 The area of the strip is the base times the height, so  .   \n                 The centroid of the strip is located at its midpoint so, by inspection\n \n                         \n                 With vertical strips the variable of integration is  , and the limits on    run from   at the left to   on the right.  For a rectangle, both 0 and   are constants, but in other situations,   and the left or right limits may be functions of  . \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate.  \n\n \n                         \n                 Unsurprisingly, we learn that the area of a rectangle is base times height.  Since the area formula is well known, it was not really necessary to solve the first integral. Note that   has units of  , and   and   have units of  .  \n               \n                 Find the centroid \n                 Substituting the results into the definitions gives\n . \n               \n           This solution demonstrates solving integrals using horizontal rectangular strips.  Set the slider on the diagram to   to see a representative element. \n             \n                 Set up the integrals \n                 The bounding functions   ,  ,   and  .   \n                 The strip extends from   on the   axis to   on the right, and has a differential height  . \n                 The area of the strip is the base times the height, so  .   \n                 The centroid of the strip is located at its midpoint so, by inspection\n \n                         \n                 With horizontal strips the variable of integration is  , and the limits on   run from   at the bottom to   at the top. \n                 For a rectangle, both 0 and   are constants, but in other situations,   and the upper or lower limits may be functions of  . \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate.  The results are the same as we found using vertical strips. \n \n                         \n               \n                 Find the centroid \n                 Substituting the results into the definitions gives\n . \n               \n           This solution demonstrates solving integrals using square elements and double integrals. Set the slider on the diagram  to   to see a representative element. \n             \n                 Set up the integrals \n                 Set the slider on the diagram  to   to see a representative element. \n                 The bounding functions   ,  ,   and  .   \n                 Instead of strips, the integrals will be evaluated using square elements with width   and height   located at  . \n                 The area of the square element is the base times the height, so  .   \n                 The centroid of the strip is located at its midpoint so, by inspection\n \n                         \n                 We will integrate twice, first with respect to   and then with respect to  .  The limits on the first integral are   to   and   to   on the second.  For a rectangle, both   and   are constants.  In other situations, the upper or lower limits may be functions of   or  . \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate the  inside  integral, then the  outside  integral.  The results are the same as before.\n \n                         \n               \n                 Find the centroid \n                 Substituting the results into the definitions gives\n . \n               \n           "
},
{
  ...
  "body": "Centroid of a triangle Use integration to locate the centroid of a triangle with base   and height of   oriented as shown in the interactive. Interactive Diagram  Use the red slider to see the options for the differential element.  \n             \n           This solution demonstrates finding the centroid of the triangle using vertical strips  .  Set the slider on the diagram to   to see a representative element. \n             \n                 Set up the integrals \n                 The bounding functions in this example are the   axis, the vertical line  , and the straight line through the origin with a slope of  . Using the slope-intercept form of the equation of a line, the upper bounding function is \n  and any point on this line is designated  . \n                 The strip extends from   on the   axis to   on the function, has a height of  , and a differential width  .  The area of this strip is  .   \n                 The centroid of the strip is located at its midpoint so, by inspection\n \n                         \n                 With vertical strips the variable of integration is  , and the limits are   to  . \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate.  In contrast to the rectangle example both   and   are functions of  , and will have to be integrated accordingly.\n \n                         \n                 We learn that the area of a triangle is one half base times height.  Since the area formula is well known, it would have been more efficient to skip the first integral.  Note that   has units of  , and   and   have units of  .  \n               \n                 Find the Centroid \n                 Substituting the results into the definitions gives\n . \n               \n           This solution demonstrates solving integrals using horizontal rectangular strips. Set the slider on the diagram to   to see a representative element. \n             \n                 Set up the integrals \n                 As before, the triangle is bounded by the   axis, the vertical line  , and the line  .  \n                 To integrate using horizontal strips, the function   must be inverted to express   in terms of  . Solving for   for   gives  .  The limits on the integral are from   to  . \n                 The strip extends from   to  , has a height of  , and a length of  , therefore the area of this strip is  .   \n                 The coordinates of the midpoint of the element are \n . \n                 These expressions are recognized as the  average  of the   and   coordinates of strip’s endpoints. \n                 A common student mistake is to use  , and  .  These would be correct if you were looking for the properties of the area to the left of the curve. \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into the definitions of   and   and integrate.  The results are the same as we found using vertical strips.  There in no need to evaluate    since we know that   for a triangle.\n \n                         \n                 It makes solving these integrals easier if you avoid prematurely substituting in the function for   and if you factor out constants whenever possible.  Here it   was not substituted until the fourth line. \n               \n                 Find the centroid \n                 Substituting the results into the definitions gives\n . \n               \n           This solution demonstrates solving integrals using square elements and double integrals. Set the slider on the diagram to   or   to see a representative element. \n             \n                 Set up the integrals \n                 As before, the triangle is bounded by the   axis, the vertical line  , and the line\n . \n                 In this solution the integrals will be evaluated using square differential elements   located at  . \n                 With double integration, you must take care to evaluate the limits correctly, since the limits on the inside integral are functions of the variable of integration of the outside integral.  The inside integral essentially stacks the elements into strips and the outside integral adds all the strips to cover the area. \n                 Choosing to express   as   means that the integral over   will be conducted first.  The limits on the inside integral are from   to  .  Then, the limits on the outside integral are from   to  \n                         \n                 Using   would reverse the order of integration, so the inside integral’s limits would be from   to  , and the limits on the outside integral would be   to  .  Either choice will give the same results  \n                            if you don't make any errors! \n                         \n                 The area of the square element is the base times the height, so  .  The centroid of the square is located at its midpoint so, by inspection\n \n                         \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate the  inside  integral, then the  outside  integral.  The results are the same as before.\n \n                         \n               \n                 Find the centroid \n                 Substituting Q_x and   along with   into the centroid definitions gives\n . \n               \n           "
},
{
...
},
{
  ...
  "body": "Centroid of an area between two curves Use integration to locate the centroid of the area bounded by  . Interactive Diagram \n                    Use the red slider to see the options for the differential element.  \n                 Find the centroid location    of the shaded area between the two curves below. \n             \n           This solution demonstrates finding the centroid of the area between two functions using vertical strips  .  Set the slider on the diagram to   to see a representative element. \n             \n                 Set up the integrals \n                 The bounding functions in this example are the   axis, the vertical line  , and the straight line through the origin with a slope of  . Using the slope-intercept form of the equation of a line, the upper bounding function is \n  and any point on this line is designated  . \n                 The strip extends from   on the   axis to   on the function, has a height of  , and a differential width  .  The area of this strip is  .   \n                 The centroid of the strip is located at its midpoint so, by inspection\n \n                         \n                 With vertical strips the variable of integration is  , and the limits are   to  . \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate.  In contrast to the rectangle example both   and   are functions of  , and will have to be integrated accordingly.\n \n                            \n                         \n               \n                 Find the Centroid \n                 Substituting the results into the definitions gives\n . \n               \n           This solution demonstrates finding the centroid of the area between two functions using vertical strips  .  Set the slider on the diagram to   to see a representative element. \n             \n                 Set up the integrals \n                 The bounding functions in this example are the   axis, the vertical line  , and the straight line through the origin with a slope of  . Using the slope-intercept form of the equation of a line, the upper bounding function is \n  and any point on this line is designated  . \n                 The strip extends from   on the   axis to   on the function, has a height of  , and a differential width  .  The area of this strip is  .   \n                 The centroid of the strip is located at its midpoint so, by inspection\n \n                         \n                 With vertical strips the variable of integration is  , and the limits are   to  . \n               \n                 Solve the integrals \n                 Substitute  ,  , and   into   and integrate.  In contrast to the rectangle example both   and   are functions of  , and will have to be integrated accordingly.\n \n                            \n                         \n               \n                 Find the Centroid \n                 Substituting the results into the definitions gives\n . \n               \n           "
},
{
  "id": "four-r-three-pi",
  "level": "2",
  ...
  "body": "Centroid of a semi-circle Find the coordinates of the top half of a circle with radius  , centered at the origin. Interactive Diagram This shows the differential element   used with polar coordinates. The centroid of a semicircle with radius  , centered at the origin is\n \n                We will use   with polar coordinates   to solve this problem because they are a natural fit for the geometry. In polar coordinates, the equation for the bounding semicircle is simply  . Normally this involves evaluating three integrals but as you will see, we can take some shortcuts in this problem. Otherwise we will follow the same procedure as before. \n             \n                 Set up the integrals \n                 Divide the semi-circle into \"rectangular\" differential elements of area  , as shown in the interactive when you select   Show element . This shape is not really a rectangle, but in the limit as   and   approach zero, it doesn't make any difference. \n                 The radial height of the rectangle is   and the tangential width is the arc length  .  The product is the differential area  .  .   \n                 The differential element is located at   in polar coordinates.  Expressing this point in rectangular coordinates gives\n . \n               \n                 Solve the integrals \n                 The area of a semicircle is well known, so there is no need to actually evaluate  ,  . \n                 Since the semi-circle is symmetrical about the   axis,  . This is because each element of area to the right of the   axis is balanced by a corresponding element the same distance the left which cancel each other out in the sum. \n                 All that remains is to evaluate the integral   in the numerator of \n \n                         \n                 The differential area   is the product of two differential quantities, we will need to perform a double integration.\n \n                         \n               \n                 Find the centroid \n                 Substituting the results into the definitions gives\n . \n                 So   and lies on the axis of symmetry, and    above the diameter. \n                 This result can be extended by noting that a semi-circle is mirrored quarter-circles on either side of the   axis.  These must have the same   value as the semi-circle.  Further, quarter-circles are symmetric about a   line, so for the quarter-circle in the first quadrant,  . \n               \n           "
},
{
  ...
  "body": "Distributed Loads What is a distributed load? Given a distributed load, how do we find the magnitude of the equivalent concentrated force? Given a distributed load, how do we find the location of the equivalent concentrated force? Distributed loads uniformly distributed load \n           A shelf of books with various weights. Shelf of books. \n           Each book represented as an individual weight Shelf with books represented by different individual weights. \n           All the books represented as a distributed load. All books represented as distributed load \n         resultant To be equivalent, the point force must have a:\n Magnitude equal to the the area or volume under the distributed load function. Line of action that passes through the centroid of the distributed load distribution. \n          The next two sections will explore how to find the magnitude and location of the equivalent point force for a distributed load. Equivalent Magnitude The magnitude of the distributed load of the books is the total weight of the books divided by the length of the shelf  . It represents the  average  book weight per unit length.  Similarly, the total weight of the books is equal to the value of the distributed load times the length of the shelf or \n \n          This total load is simply the area under the curve  , and has units of force.  If the loading function is not uniform, integration may be necessary to find the area. Bookshelf A common paperback is about   thick and weighs approximately   .    What is the loading function   for a shelf full of paperbacks and what is the total weight  of paperback books on a   shelf? \n             \n           The weight of one paperback over its thickness is the load intensity  , so\n . The total weight is the the area under the load intensity diagram, which in this case is a rectangle. So, a   bookshelf covered with paperbacks would have to support  .   The line of action of this equivalent load passes through the centroid of the rectangular loading, so it acts at  . Equivalent Location To use a distributed load in an equilibrium problem, you must know the equivalent magnitude to sum the forces, and also know the position or line of action to sum the moments.   The line of action of the equivalent force acts through the centroid of area under the load intensity curve.  For a rectangular loading, the centroid is in the center.  We know the vertical and horizontal coordinates of this centroid, but since the equivalent point force’s line of action is vertical and we can slide a force along its line of action, the vertical coordinate of the centroid not important in this context. uniformly varying load Essentially, we’re finding the balance point so that the moment of the force to the left of the centroid is the same as the moment of the force to the right.  The examples below will illustrate how you can combine the computation of both the magnitude and location of the equivalent point force for a series of distributed loads. Uniformly Varying Load Find the equivalent point force and its point of application for the distributed load shown. Horizontal beam with width of 6 ft fixed on the left end. Distributed load starts at 0 and increases to 10 lb\/ft at the right end. The equivalent load is   downward force acting    from the left end. The equivalent load is the  area  under the triangular load intensity curve and it acts straight down at the centroid of the triangle.  This triangular loading has a   base and a  height so   and the centroid is located   of the way from the left end so,  . Distributed loads may be any geometric shape or defined by a mathematical function. If the load is a combination of common shapes, use the properties of the shapes to find the magnitude and location of the equivalent point force using the methods of  . If the distributed load is defined by a mathematical function, integrate to find their area using the methods of  . A few things to note:\n You can include the distributed load or the equivalent point force on your free body diagram,  but not both !  Since you’re calculating an area, you can divide the area up into any shapes you find convenient. So, if you don't recall the area of a trapezoid off the top of your head, break it up into a rectangle and a triangle. \n          Distributed Load Applications Once you convert distributed loads to the resultant point force, you can solve problem in the same manner that you have other problems in previous chapters of this book. Note that while the resultant forces are  externally  equivalent to the distributed loads, they are not  internally  equivalent, as will be shown  . Cantilever Beam Find the reactions at the fixed connection at  .  Cantilever beam fixed on left end and length of 6 m. Uniform distributed load of 4 N\/m begins at 2 m from left end and continues to the right end. \n             \n           Draw a free body diagram with the distributed load replaced with an equivalent concentrated load, then apply the equations of equilibrium. Horizontal beam 44 in long. Distributed load of 12 lb\/in from left end to 10 in. Pin A at 10 in. Downward force of 100 lb at 16 in. Downward force of 150 lb at 22 in. Downward force of 100 lb at 28 in. Roller support at 28 in. Uniform distributed load of 12 lb\/in starting at 34 in and ending at 44 in. \n               \n             Beam Reactions Find the reactions at the supports for the beam shown.  \n             \n           \n             \n           \n             \n                 The two distributed loads are   each. \n               \n                 The total downward force is  \n                         \n               \n                 Since the beam and loading are symmetrical supports   and   share the load equally, so  \n                         \n               \n                 There are no horizontal loads acting on the beam, so  \n                         \n               \n           "
},
{
  "id": "objectives-30",
  "level": "2",
...
},
{
  "id": "p-1532",
  "level": "2",
  "url": "distributed-loads.html#p-1532",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-1533",
  "level": "2",
  "url": "distributed-loads.html#p-1533",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "figure-132",
  "level": "2",
  "url": "distributed-loads.html#figure-132",
  "type": "Figure",
  "number": "7.8.1",
  "title": "",
  "body": "\n           A shelf of books with various weights. Shelf of books. \n           Each book represented as an individual weight Shelf with books represented by different individual weights. \n           All the books represented as a distributed load. All books represented as distributed load \n         "
},
{
  "id": "p-1534",
  "level": "2",
  "url": "distributed-loads.html#p-1534",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "resultant "
},
{
  ...
  "number": "7.8.2",
  "title": "Bookshelf.",
  "body": "Bookshelf A common paperback is about   thick and weighs approximately   .    What is the loading function   for a shelf full of paperbacks and what is the total weight  of paperback books on a   shelf? \n             \n           The weight of one paperback over its thickness is the load intensity  , so\n . The total weight is the the area under the load intensity diagram, which in this case is a rectangle. So, a   bookshelf covered with paperbacks would have to support  .   The line of action of this equivalent load passes through the centroid of the rectangular loading, so it acts at  . "
},
{
  "id": "p-1548",
  "level": "2",
  "url": "distributed-loads.html#p-1548",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": "Uniformly Varying Load Find the equivalent point force and its point of application for the distributed load shown. Horizontal beam with width of 6 ft fixed on the left end. Distributed load starts at 0 and increases to 10 lb\/ft at the right end. The equivalent load is   downward force acting    from the left end. The equivalent load is the  area  under the triangular load intensity curve and it acts straight down at the centroid of the triangle.  This triangular loading has a   base and a  height so   and the centroid is located   of the way from the left end so,  . "
},
{
  ...
  "body": "Cantilever Beam Find the reactions at the fixed connection at  .  Cantilever beam fixed on left end and length of 6 m. Uniform distributed load of 4 N\/m begins at 2 m from left end and continues to the right end. \n             \n           Draw a free body diagram with the distributed load replaced with an equivalent concentrated load, then apply the equations of equilibrium. Horizontal beam 44 in long. Distributed load of 12 lb\/in from left end to 10 in. Pin A at 10 in. Downward force of 100 lb at 16 in. Downward force of 150 lb at 22 in. Downward force of 100 lb at 28 in. Roller support at 28 in. Uniform distributed load of 12 lb\/in starting at 34 in and ending at 44 in. \n               \n             "
},
{
  ...
  "body": "Beam Reactions Find the reactions at the supports for the beam shown.  \n             \n           \n             \n           \n             \n                 The two distributed loads are   each. \n               \n                 The total downward force is  \n                         \n               \n                 Since the beam and loading are symmetrical supports   and   share the load equally, so  \n                         \n               \n                 There are no horizontal loads acting on the beam, so  \n                         \n               \n           "
},
{
  ...
  "number": "7.9",
  "title": "Fluid Statics",
  "body": "Fluid Statics What is the basic relationship between depth and pressure? How are absolute and relative pressure different?  How can use use our knowledge of centroids to compute the equivalent point forces of fluids? Pressure is the term used for a force distributed over an area  . We will consider the effect of fluid pressure on underwater surfaces, including slanted or curved objects. In all cases we will simply ask the question: what is the pressure at each point and how does it change along the surface? Absolute pressure Gage pressure We will use gage pressure for the remainder of the chapter. Commonly used pressure units include:\n 1 pascals (Pa) = 1  \n                1 kilopascal (kPa) = 1000  \n                1 pound per square inch (psi) =  \n                1 kip per square inch (ksi) = 1000  \n                1 pound per square foot (psf) =  1  \n                \n          Principles of Fluid Statics A fluid, like water or air exerts a pressure on its surroundings.  This pressure applies a distributed load on surfaces surrounding the fluid, like the face of a dam, an irrigation control gate, a teakettle, or the drum of a steam boiler.  When you dive underwater, the pressure you feel in your ears increases with depth.  At the surface, the gage pressure is zero no matter which unit system you use.  As you descend, the fluid pressure   increases with depth according to the equation  , where:\n  is the density of a fluid,  is gravitational acceleration, and   is the height of fluid above the point of interest. \n          Since fluid pressure increases linearly with depth, it behaves as a distributed load which increases linearly from 0 at the surface to   at depth  , acting normal to the surface.  The pressure can be replaced with an equivalent force acting through the centroid of the triangular loading, with a magnitude equal to the triangular area.  The pressure on horizontal surfaces is constant, and it is normal to all surfaces. Pressure on submerged surfaces. Distributed pressure. Vertical submerged wall of height h. Pressure is a function of height p(y) = rho*g*y. Equivalent force. Vertical submerged wall of height h. Distributed load of water pressure is shown as (1\/2)*rho*g*h at a depth of (2\/3)*h. Pressure is perpendicular to the surface. Submirged trapezoid shape illustrating pressure is perpindicular to each surface. Some points to remember when solving fluid pressure problems.  The pressure due to the fluid always acts perpendicular the surface. A particle underwater will feel the same pressure from all directions.  Pressure increases linearly with depth.  \n                 assumes a constant density and thus is valid only for incompressible fluids like water or oil, but not for compressible fluids like air. In English units, specific weight   is often used instead of density   to describe fluids.  Specific weight is the  weight  per unit volume of a substance, while density is its  mass  per unit volume.  The two properties are related by   .  The specific weight of freshwater at room temperature is about  . Gage pressure is the pressure above the surrounding atmospheric pressure. Atmospheric pressure is approximately   or  , but since this pressure acts on everything equally and from all directions, the pressure scale can be offset to make the pressure of the surroundings  , gage. \n          Does fluid pressure depend on the surface area of the container?  For instance, is the pressure below the Atlantic Ocean less than the pressure below the Pacific Ocean since the Pacific is larger? No.  Fluid pressure is a function of density and depth only, so the surface area of an ocean or tank is insignificant.  . Assuming that the density of seawater and   are the same everywhere under the ocean, the gage pressure depends on depth only.  Compare the pressure at three feet and thirty feet below the surface of freshwater to the atmospheric pressure. The gage pressure at   is  . This is   , approximately 9% greater than atmospheric pressure. At   below the surface, the pressure is 10 times higher,   which is nearly twice atmospheric pressure. Fluid Statics Applications Force on a submerged window \n               An aquarium tank has a   window AB for viewing the inhabitants.  The tank contains water with density  . \n               Find the force of the water on the window, and the location of the equivalent point load. \n             Vertical submerged wall of height h. pressure is a function of height p(y) = rho*g*y.  acting   above point   or    below the surface of the water. Begin by drawing a diagram of the window showing the load intensity and the equivalent concentrated force.  Schematic of aquarium. Wall of aquarium descends 2 m from top. A glass window goes from 2 m in depth to 5 m in depth. The pressure at the top and the bottom of the window are\n \n                Since the loading is linear, the average pressure acting on the window is\n \n                The total force acting on the window is the average pressure times the area of the window\n \n                This force may also be visualized as the volume of a trapezoidal prism with a   depth into the page.  The line of action of the equivalent force passes through the centroid of the trapezoid, which may be calculated using composite areas, see  .   Dividing the trapezoid into a triangle and a rectangle and measuring down from the surface of the tank, the distance to the equivalent force is\n If you prefer, you may use the formula from the   Centroid table  to locate the centroid of the trapezoid instead. Mud on Concrete Wall \n               Find the depth   of mud for which the   tall concrete retaining wall will be on the verge of tipping over.  \n               Assume the density of mud is   and the density of concrete is  . \n             Retaining wall is 3 m high and 0.8 m wide. The mud is shon to the right of the wall at height of h. \n             \n           Sea Gate \n               A sea gate is hinged at point   and is designed to rotate and release the water when the depth   exceeds a certain value. \n               The gate extends   into the page. The mass density of the water is  .  \n               What depth will cause the gate to open? \n             A vertical sea gate holds back water of depth d on its right. The gate is hinged at 500 mm from the floor of the sea. A stopper is at the bottom of the gate on the right to prevent the gate from rotating counter clockwise. \n             \n           For the gate to tip, the force of the water must act at or above A. That happens when the centroid of the load intensity diagram from the water has its equivalent point force at or above A, so \n . Gate with Horizontal Surface \n               The gate at the end of a  freshwater channel is fabricated from three  ,   rectangular steel plates. The gate is hinged at   and rests against a frictionless support at  . The depth of the water  . \n               Draw the free body diagram and determine the reactions at   and  . \n             \n             \n           \n               A free body diagram of a cross section of the gate is shown.  For simplicity the thickness of the steel plates has been ignored.  You must sufficient distances are provided to locate the loads.  \n               The easiest way to solve this is to apply the principle of transmissibility: slide the lower trapezoid left until it aligns with the upper triangle and makes a triangular loading.  \n             A sea gate holds back water of depth d. Pin A is at the sea floor at the origin. The gate goes up vertically to point (0, 0.6). The gate continues horizontally from (0, 0.6) to (-0.6, 0.6). Then the gate continues vertically up to point D. A roller is on the left end of point D to prevent the gate from rotating counter clockwise. The total horizontal force from the water will be \n  acting to the right   above point   . The total vertical load from the water is\n acting upward    to the left of  . Each plate weighs\n . From here solve the equilibrium equations to find the reactions.   You should complete this for practice.\n \n                "
},
{
  "id": "objectives-31",
  "level": "2",
...
},
{
  "id": "p-1572",
  "level": "2",
  "url": "Chapter_07-fluid-statics.html#p-1572",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "figure-136",
  "level": "2",
  "url": "Chapter_07-fluid-statics.html#figure-136",
  "type": "Figure",
  "number": "7.9.1",
  "title": "",
...
},
{
  "id": "question-9",
  "level": "2",
  "url": "Chapter_07-fluid-statics.html#question-9",
  "type": "Question",
  "number": "7.9.3",
  "title": "",
...
},
{
  ...
  "body": "Gate with Horizontal Surface \n               The gate at the end of a  freshwater channel is fabricated from three  ,   rectangular steel plates. The gate is hinged at   and rests against a frictionless support at  . The depth of the water  . \n               Draw the free body diagram and determine the reactions at   and  . \n             \n             \n           \n               A free body diagram of a cross section of the gate is shown.  For simplicity the thickness of the steel plates has been ignored.  You must sufficient distances are provided to locate the loads.  \n               The easiest way to solve this is to apply the principle of transmissibility: slide the lower trapezoid left until it aligns with the upper triangle and makes a triangular loading.  \n             A sea gate holds back water of depth d. Pin A is at the sea floor at the origin. The gate goes up vertically to point (0, 0.6). The gate continues horizontally from (0, 0.6) to (-0.6, 0.6). Then the gate continues vertically up to point D. A roller is on the left end of point D to prevent the gate from rotating counter clockwise. The total horizontal force from the water will be \n  acting to the right   above point   . The total vertical load from the water is\n acting upward    to the left of  . Each plate weighs\n . From here solve the equilibrium equations to find the reactions.   You should complete this for practice.\n \n                "
},
{
  "id": "exercises-6",
  "level": "1",
...
{
  "id": "Chapter_08-internal-loads",
  "level": "1",
  "url": "Chapter_08-internal-loads.html",
  "type": "Section",
  "number": "8.1",
  "title": "Internal Loads",
  "body": "Internal Loads internal shear internal bending moment Internal loads are present at every point within a rigid body, but they always occur in equal-and-opposite pairs which cancel each other out, so they’re not obvious.  They’re there however, and when an object is cut (in your imagination) into two parts the internal loads become visible and can be determined.  You are familiar with straight, two-force members which only exist in equilibrium if equal and opposite forces act on either end.  Now imagine that we cut the member at some point along its length.  To maintain equilibrium forces must exist at the cut, equal and opposite to the external forces. These forces are internal forces. Interactive Diagram \n\tIn this interactive you may change the external forces on this two-force member from tension to compression, and then cut the beam into sections. You will see that each piece must have an internal force to balance the external force. If you move the cut point, you'll see that the value of the internal force is constant at every location.\n Internal Loading in a straight two-force member. Now let’s examine the two-force member shown in  . This time, the member is  L  shaped, not straight, but the external forces must still share the same line of action to maintain equilibrium. If you cut across the object, you will obtain two rigid bodies which must also be in equilibrium. However, adding an equal and opposite horizontal force at the cut won't produce static equilibrium because the two forces form a couple which causes the piece to rotate. This means that something is missing! A horizontal force alone does not create equilibrium. \n           Dan Baker \n           \n         L-shaped beam turned 45 degrees with force applied horizontally to each end. If the beam is split on one leg, a horizontal force alone does not result in equilibrium; a moment is necessary. Two-dimensional rigid bodies have three degrees-of-freedom and require three equilibrium equations to satisfy static equilibrium in order to prevent translation in the   direction, the   direction, and to prevent rotation about the   axis.\n       Assuming the material is rigid, the connection between the two halves must resist both translation and rotation, so we can model this connection as a fixed support and replace the removed half of the link with a force reaction  and  a couple-moment reaction as shown in the free-body diagrams of  . This internal loading is actually a simplification of a more complex loading distributed across the section plane. The couple   represents the net rotational effect of the force system on the surface of the cut. \nThe internal loading represented as an equal and opposite force   and a bending moment  \n          \n           Dan Baker \n           \n         The L-shaped beam from previous figure shown with resultant force and moment achieve equilibrium. The horizontal force can also be resolved into orthogonal components parallel and perpendicular to the cut. These components have special names in the context of internal loads.  The internal loading represented as a normal force  , a shear force  , and bending moment  \n          \n           Dan Baker \n           \n         The L-shaped beam from previous figure shown with resultant force broken into normal and shear components, as well as the bending moment. normal force axial force shear force bending moment shear, moment Interactive Diagram This interactive demonstrates how the internal loads at a cut may be represented. \nInternal Loading in a L shaped member. Deformation The controlling design parameter for most engineering systems is deformation. Thankfully, due to a property called elasticity, most materials will bend, stretch, and compress, long before they ultimately break. For example, when designing the floor in a new building, the floor is often limited to deflecting less than the length of the span in inches, divided by 360. Any more deformation than this would be considered disconcerting to the building residents and also start damaging surface materials like drywall. For example, for a   span, the deflection would need to be less than  . To meet this deformation limit, we need to consider the magnitude and location of applied loads, the size and shape of the floor beams, and the material the floor beams are made from. As deflection is an internal property of the flooring materials, the first step is to determine the internal loadings that arise from the externally applied loads, using the methods of this chapter. "
},
{
  "id": "p-1620",
  "level": "2",
  "url": "Chapter_08-internal-loads.html#p-1620",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "Chapter_08-internal-loads.html#ggb_tension_compression",
  "type": "Figure",
  "number": "8.1.1",
  "title": "",
  "body": "Internal Loading in a straight two-force member. "
},
{
  "id": "dogleg_cut",
  "level": "2",
  "url": "Chapter_08-internal-loads.html#dogleg_cut",
  "type": "Figure",
  "number": "8.1.2",
  "title": "",
  "body": "A horizontal force alone does not create equilibrium. \n           Dan Baker \n           \n         L-shaped beam turned 45 degrees with force applied horizontally to each end. If the beam is split on one leg, a horizontal force alone does not result in equilibrium; a moment is necessary. "
},
{
  "id": "dogleg-internal",
  "level": "2",
  "url": "Chapter_08-internal-loads.html#dogleg-internal",
  "type": "Figure",
  "number": "8.1.3",
  "title": "",
  "body": "\nThe internal loading represented as an equal and opposite force   and a bending moment  \n          \n           Dan Baker \n           \n         The L-shaped beam from previous figure shown with resultant force and moment achieve equilibrium. "
},
{
  "id": "figure-143",
  "level": "2",
  "url": "Chapter_08-internal-loads.html#figure-143",
  "type": "Figure",
  "number": "8.1.4",
  "title": "",
  "body": "The internal loading represented as a normal force  , a shear force  , and bending moment  \n          \n           Dan Baker \n           \n         The L-shaped beam from previous figure shown with resultant force broken into normal and shear components, as well as the bending moment. "
},
{
  "id": "p-1632",
  "level": "2",
  "url": "Chapter_08-internal-loads.html#p-1632",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-1633",
  "level": "2",
  "url": "Chapter_08-internal-loads.html#p-1633",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "shear force "
},
{
  "id": "p-1634",
  "level": "2",
  "url": "Chapter_08-internal-loads.html#p-1634",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "bending moment "
},
{
  "id": "p-1635",
  "level": "2",
  "url": "Chapter_08-internal-loads.html#p-1635",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "shear, moment "
},
{
  "id": "ggb_bell_crank",
  "level": "2",
  "url": "Chapter_08-internal-loads.html#ggb_bell_crank",
  "type": "Figure",
  "number": "8.1.5",
  "title": "",
  "body": "\nInternal Loading in a L shaped member. "
},
{
  "id": "insight-10",
  "level": "2",
  "url": "Chapter_08-internal-loads.html#insight-10",
  "type": "Thinking Deeper",
  "number": "8.1.6",
  "title": "Deformation.",
...
},
{
  ...
  "body": "Sign Conventions \tWhen talking about internal loads our standard sign convention for forces and moments is not good enough.  We can't, for instance, just call a vertical shear force positive if it points up  and negative if it points down, because internal forces always occur in pairs so at any given point a shear force is  both  up and down.  The direction of the internal force at a point depends on which side of the cut you’re looking at.  \tSo to define the state of internal loads at a point we need a better sign convention.  Although the choice is somewhat arbitrary, agreeing on a  standard  sign convention allows us to have consistency across our calculations and to communicate the internal state clearly to others. The standard sign conventions defined here are used for internal loadings at a point and also for the shear and bending moment diagrams which are discussed in  .  \tBe aware that although this new sign convention applies all internal loads, it doesn't change the sign convention for the  equations of equilibrium  at all, so you will continue to solve them in the same way you alway have. \tThe standard sign convention used for shear force, normal force, and bending moment is shown below.      \n  Positive Shear William Haynes CC-0 Rectangular element illustrating that positive shear force tends to rotate the object clockwise. Positive shear forces tends to rotate the object clockwise,   the shear forces act down when looking towards the cut from the right, and up when looking from the left.  Positive Normal Force William Haynes CC-0 Rectangular element illustrating that positive normal force tends to stretch the object. \n          Positive normal forces tends to stretch the object.  Positive Bending Moment William Haynes CC-0 Rectangular element illustrating that positive bending moment tends to deform an object with upward curvature. \n         Positive bending moments tends to deform the object with an upward curvature. \n       \tWe have defined positive internal loads by looking at the  front  side of the object.  Would the results change if you walked around the object and analyzed it from the other side?   "
},
{
  "id": "question-10",
  "level": "2",
  "url": "VM_sign_convention.html#question-10",
  "type": "Question",
  "number": "8.2.1",
  "title": "",
  "body": "\tWe have defined positive internal loads by looking at the  front  side of the object.  Would the results change if you walked around the object and analyzed it from the other side?   "
},
{
  "id": "internal_load_at_point",
  "level": "1",
  "url": "internal_load_at_point.html",
  "type": "Section",
  "number": "8.3",
  "title": "Internal Loads at a Point",
  "body": "Internal Loads at a Point \tThis section covers the procedure to compute the internal normal force, shear force, and bending moment at a designated point in a multiforce rigid body.  Consider the frame shown in   consisting of two-force members   and  , and multiforce members   and  . Since no information is provided, we can assume that the components have negligible weight.  The internal loading within the two-force members is purely axial, but the multiforce members will be subject to the complete set of internal loadings. \nA frame supporting a load at  .\n \n               Dan Baker \n               \n             Vertical column pinned at its base and anchored by a cable to the ground. The column has a horizontal beam supported by an angled beam. A force F is applied at the end of the horizontal beam. \n           To find the internal loadings at a specified point within one of the members, we make an imaginary cut there.  \n            shows the free-body diagram of member  , with a proposed cut between points   and  . The free-body diagram is shown with reactions for pinned connections at   and   and forces from the two-force members at locations   and  .  \n         \nWavy line indicates the location of the imaginary cut.\n \n               Dan Baker \n               \n             FBD of the vertical column from previous image. The internal load will be determined at an imaginary \"cut\". We then separate the free-body diagram of the member into two independent free-body diagrams, one above the cut and one below. This is analogous to the Method of Sections technique of  . The free-body diagrams for the two sections of the member are shown in  .  The three internal forces are are exposed and labeled  ,  , and  . Either free-body diagram can be used to solve for the internal forces, so it is wise to choose the easier one.   Recognizing which one is easier takes practice, but look for the piece with more known and fewer unknown values. \nInternal forces are exposed by the cut.\n \n               Dan Baker \n               \n             The two sections of the column from the previous figure are shown separated. Each is a FBD with the internal loads shown as reactions at each of the cut surfaces. Note that the internal loadings at the cut are drawn in the positive direction according to the  sign conventions  for internal loads, that they act in opposite direction either side of the cut, and they cancel out if the object is put back together. This technique can be used to find the internal loads at any point within any object. In the examples below we will  finding the internal loadings at a specific point in load carrying beams. Internal loads in a simply supported beam A beam of length   is supported by a pin at   and a roller at   and is subjected to a horizontal force   applied to point   and a uniformly distributed load over its entire length.  The intensity of the distributed load is   with units of [force\/length].  \n                 Dan Baker \n                 \n               A beam of length L is supported by a pin at A on the left side and a roller at B on the right. It is subjected to a horizontal force F applied to point B and a uniformly distributed load over its entire length is w with units [force\/length]. Find the internal loads at the midpoint of the beam. At the midpoint of the beam, \n             \n           \n             \n                 Find the external reactions \n                 \n                   \n                 \n                 Begin by drawing a free-body diagram of the entire beam, simplified by replacing the distributed load   with an equivalent concentrated load at the centroid of the rectangle. The magnitude of the equivalent load   is equal to the  area  under the rectangular loading curve.  \n                            \n                       Dan Baker \n                       \n                     \n                 Then apply and simplify the equations of equilibrium to find the external reactions at   and  .\n \n                         \n               \n                 Cut the beam \n                 Cut the beam at the point of interest and separate the beam into two sections.  Notice that as the beam is cut in two, the distributed load   is cut as well.  Each of these distributed load halves will support equivalent point loads of   acting through the centroid of each cut half. \n                 \n                       Dan Baker \n                       \n                     \n                       Dan Baker \n                       \n                     \n               \n                 Add the internal forces \n                 At each cut, a shear force, a normal force, and a bending moment will be exposed, and these need to be included on the free-body diagram.  \n                 At this point, we don't know the actual directions of the internal loads, but we do know that they act in opposite directions.  We will assume that they act in the positive sense as defined by the   standard sign convention . \n                 Axial forces are positive in tension and act in opposite directions on the two halves of the cut beam.  \n                 Positive shear forces act down when looking at the cut from the right, and up when looking at the cut from the left. An alternate definition of positive shears is that the positive shears cause clockwise rotation. This definition is useful if you are dealing with a vertical column instead of a horizontal beam. \n                 \n                 Bending moments are positive when the moment tends to bend the beam into a smiling U-shape. Negative moments bend the beam into a frowning shape.  \n                 For vertical columns, positive bending moments bend a beam into a C shape and negative into a backward C-shape. \n                 The final free-body diagrams look like this.  \n                 \n                     Dan Baker \n                     \n                   \n                 Horizontal beams should always have assumed internal loadings in these directions at the cut, indicating that you have assumed  positive  shear,  positive  normal force and  positive  bending moments at that point. \n               \n                 Solve for the internal forces \n                 You may uses either  FBD  to find the internal loads using the techniques you have already learned. So, with a standard   coordinate system, forces to the left or up are positive when summing forces and counterclockwise moments are positive when summing moments. \n                 Using the left free-body diagram and substituting in the reactions, we get:\n \n                         \n                 Using the right side free-body diagram we get:\n \n                         \n               \n           Regardless of which side is chosen, we get the same results for the internal loads at the chosen point. When you solve for the internal loadings, the results can be either positive, negative, or sometimes zero. Negative values indicate that the actual direction of the load is opposite to the assumed direction.  Since we assumed all three internal loads were positive as defined by the  standard sign convention , a negative answer means that the load actually acts in the opposite direction to the vector shown on the free-body diagram. Internal loads in a cantilever beam Consider a cantilever beam which is supported by a fixed connection at  , and loaded by a vertical force   and horizontal force   at the free end  .  Determine the internal loads at a point a distance   from the left end. \n                 Dan Baker \n                 \n               A cantilever beam  is supported by a fixed connection at A on the left, and loaded by a vertical force P and horizontal force F at the free end on the right. If you think ahead, you may not need to find the reactions at  . At the midpoint, \n             \n           \n             \n                 Determine the reactions \n                 Draw an  FBD  of the entire, un-cut beam and determine the reactions.  \n                       Dan Baker \n                       \n                     \n                 Notice that only the applied loads and support reactions are included on this un-cut beam  FBD . The internal loads are only exposed and shown on a  FBD  after the beam is cut. \n                 Use this free-body diagram and the equations of equilibrium to determine the external reaction forces.\n \n                         \n               \n                 Section the beam \n                 Take a cut at the point of interest and draw a  FBD  of either or both parts.  Try to choose the simpler free-body diagram.  If one side has no external reactions, then you can skip the previous step if you choose that side. \n                 \n                     Dan Baker \n                     \n                   \n                 The free-body diagrams of both portions have been drawn with the internal loads indicated in the positive direction defined by the  standard sign convention . \n                 The axial force is shown in tension on both parts.  This force has been named   so its name doesn't conflict with the forces at point  .   \n                 The shear force   is positive when the shear is down on the right face of the cut and up on the left face.  \n                 \the  bending moment   is positive if the bending direction would tend to bend the beam into a concave upward curve.  \n                 Always assume that the unknown internal loads act in the positive direction as defined by the standard sign convention.  \n               \n                 Solve for the internal loads \n                 \tSolve for the three unknown internal loads. \n                 \n                   \n                 \n                 \tOnce you have found the reactions and drawn a free-body diagram of the simpler portion with the normal force, shear force, and bending moment assumed positive, you then solve for the unknown values and signs just like any other equilibrium problem. \n               \n           This workflow typically includes:\n Establishing a horizontal   and vertical   coordinate system. Taking a cut at the point of interest. Assuming that the internal force act in the positive direction and drawing a free-body diagram accordingly Using  ,  , and   to solve for the three unknown internal loads. \n          \tThe  shear force  , normal force  , and bending moment   are scalar components and they may be positive, zero, or negative depending on the applied loads.  The signs of the scalar components together with the sign convention for internal loads establish the actual directions of the shear force, normal force and bending moment vectors. Interactive Internal Loading The internal loading inside a beam depends on the load that the beam is supporting and differs from point to point.  This simply supported beam supports a uniformly varying load.  The interactive traces out the value of the shear and bending moment as you move point  .  Can you deduce the relation between the triangular loading and the value of the shear and bending moment? Interactive Diagram This interactive allows you to change the cut location on a beam with a downward distributed load varying from a maximum at point   to 0 at point  . The check box cuts the beam and exposes the internal loadings. Moving point   traces out the shear and moment as functions of  . Internal loading in a beam with a uniformly varying load. "
},
{
  "id": "frame_space_diagram",
  "level": "2",
  "url": "internal_load_at_point.html#frame_space_diagram",
  "type": "Figure",
  "number": "8.3.1",
  "title": "",
  "body": "\nA frame supporting a load at  .\n \n               Dan Baker \n               \n             Vertical column pinned at its base and anchored by a cable to the ground. The column has a horizontal beam supported by an angled beam. A force F is applied at the end of the horizontal beam. "
},
{
  "id": "frame_1",
  "level": "2",
  "url": "internal_load_at_point.html#frame_1",
  "type": "Figure",
  "number": "8.3.2",
  "title": "",
  "body": "\nWavy line indicates the location of the imaginary cut.\n \n               Dan Baker \n               \n             FBD of the vertical column from previous image. The internal load will be determined at an imaginary \"cut\". "
},
{
  "id": "frame_2",
  "level": "2",
  "url": "internal_load_at_point.html#frame_2",
  "type": "Figure",
  "number": "8.3.3",
  "title": "",
  "body": "\nInternal forces are exposed by the cut.\n \n               Dan Baker \n               \n             The two sections of the column from the previous figure are shown separated. Each is a FBD with the internal loads shown as reactions at each of the cut surfaces. "
},
{
  "id": "Chapter_08-example-internal-loads-in-a-simply-supported-beam",
  "level": "2",
  "url": "internal_load_at_point.html#Chapter_08-example-internal-loads-in-a-simply-supported-beam",
  "type": "Example",
  "number": "8.3.4",
  "title": "Internal loads in a simply supported beam.",
  "body": "Internal loads in a simply supported beam A beam of length   is supported by a pin at   and a roller at   and is subjected to a horizontal force   applied to point   and a uniformly distributed load over its entire length.  The intensity of the distributed load is   with units of [force\/length].  \n                 Dan Baker \n                 \n               A beam of length L is supported by a pin at A on the left side and a roller at B on the right. It is subjected to a horizontal force F applied to point B and a uniformly distributed load over its entire length is w with units [force\/length]. Find the internal loads at the midpoint of the beam. At the midpoint of the beam, \n             \n           \n             \n                 Find the external reactions \n                 \n                   \n                 \n                 Begin by drawing a free-body diagram of the entire beam, simplified by replacing the distributed load   with an equivalent concentrated load at the centroid of the rectangle. The magnitude of the equivalent load   is equal to the  area  under the rectangular loading curve.  \n                            \n                       Dan Baker \n                       \n                     \n                 Then apply and simplify the equations of equilibrium to find the external reactions at   and  .\n \n                         \n               \n                 Cut the beam \n                 Cut the beam at the point of interest and separate the beam into two sections.  Notice that as the beam is cut in two, the distributed load   is cut as well.  Each of these distributed load halves will support equivalent point loads of   acting through the centroid of each cut half. \n                 \n                       Dan Baker \n                       \n                     \n                       Dan Baker \n                       \n                     \n               \n                 Add the internal forces \n                 At each cut, a shear force, a normal force, and a bending moment will be exposed, and these need to be included on the free-body diagram.  \n                 At this point, we don't know the actual directions of the internal loads, but we do know that they act in opposite directions.  We will assume that they act in the positive sense as defined by the   standard sign convention . \n                 Axial forces are positive in tension and act in opposite directions on the two halves of the cut beam.  \n                 Positive shear forces act down when looking at the cut from the right, and up when looking at the cut from the left. An alternate definition of positive shears is that the positive shears cause clockwise rotation. This definition is useful if you are dealing with a vertical column instead of a horizontal beam. \n                 \n                 Bending moments are positive when the moment tends to bend the beam into a smiling U-shape. Negative moments bend the beam into a frowning shape.  \n                 For vertical columns, positive bending moments bend a beam into a C shape and negative into a backward C-shape. \n                 The final free-body diagrams look like this.  \n                 \n                     Dan Baker \n                     \n                   \n                 Horizontal beams should always have assumed internal loadings in these directions at the cut, indicating that you have assumed  positive  shear,  positive  normal force and  positive  bending moments at that point. \n               \n                 Solve for the internal forces \n                 You may uses either  FBD  to find the internal loads using the techniques you have already learned. So, with a standard   coordinate system, forces to the left or up are positive when summing forces and counterclockwise moments are positive when summing moments. \n                 Using the left free-body diagram and substituting in the reactions, we get:\n \n                         \n                 Using the right side free-body diagram we get:\n \n                         \n               \n           "
},
{
  "id": "Chapter_08-example-internal-loads-in-a-cantilever-beam",
  "level": "2",
  "url": "internal_load_at_point.html#Chapter_08-example-internal-loads-in-a-cantilever-beam",
  "type": "Example",
  "number": "8.3.5",
  "title": "Internal loads in a cantilever beam.",
  "body": "Internal loads in a cantilever beam Consider a cantilever beam which is supported by a fixed connection at  , and loaded by a vertical force   and horizontal force   at the free end  .  Determine the internal loads at a point a distance   from the left end. \n                 Dan Baker \n                 \n               A cantilever beam  is supported by a fixed connection at A on the left, and loaded by a vertical force P and horizontal force F at the free end on the right. If you think ahead, you may not need to find the reactions at  . At the midpoint, \n             \n           \n             \n                 Determine the reactions \n                 Draw an  FBD  of the entire, un-cut beam and determine the reactions.  \n                       Dan Baker \n                       \n                     \n                 Notice that only the applied loads and support reactions are included on this un-cut beam  FBD . The internal loads are only exposed and shown on a  FBD  after the beam is cut. \n                 Use this free-body diagram and the equations of equilibrium to determine the external reaction forces.\n \n                         \n               \n                 Section the beam \n                 Take a cut at the point of interest and draw a  FBD  of either or both parts.  Try to choose the simpler free-body diagram.  If one side has no external reactions, then you can skip the previous step if you choose that side. \n                 \n                     Dan Baker \n                     \n                   \n                 The free-body diagrams of both portions have been drawn with the internal loads indicated in the positive direction defined by the  standard sign convention . \n                 The axial force is shown in tension on both parts.  This force has been named   so its name doesn't conflict with the forces at point  .   \n                 The shear force   is positive when the shear is down on the right face of the cut and up on the left face.  \n                 \the  bending moment   is positive if the bending direction would tend to bend the beam into a concave upward curve.  \n                 Always assume that the unknown internal loads act in the positive direction as defined by the standard sign convention.  \n               \n                 Solve for the internal loads \n                 \tSolve for the three unknown internal loads. \n                 \n                   \n                 \n                 \tOnce you have found the reactions and drawn a free-body diagram of the simpler portion with the normal force, shear force, and bending moment assumed positive, you then solve for the unknown values and signs just like any other equilibrium problem. \n               \n           "
},
{
  "id": "ggb_internal_loading",
  "level": "2",
  "url": "internal_load_at_point.html#ggb_internal_loading",
  "type": "Figure",
  "number": "8.3.6",
  "title": "",
  "body": "Internal loading in a beam with a uniformly varying load. "
},
{
  "id": "VM_diagrams",
  "level": "1",
...
},
{
  ...
  "number": "8.4.1",
  "title": "",
  "body": "Beam Supports Simply Supported \n                 Dan Baker \n                 \n               Simply supported beam. Cantilevered \n                 Dan Baker \n                 \n               Cantilevered beam. Overhanging \n                 Dan Baker \n                 \n               Overhanging beam. "
},
{
...
},
{
  ...
  "number": "8.5.2",
  "title": "",
  "body": "Shear and Bending Moment Diagrams  vs.  \n                Shear diagram for the previous FBD. V(x)=P from x=0 to x=L.  vs.  \n                Moment diagram for the previous FBD. M(x) starts at (0,-PL) and ends at (L,0). "
},
{
  "id": "figure-160",
  "level": "2",
  "url": "section_cut_method.html#figure-160",
  "type": "Figure",
  "number": "8.5.3",
  "title": "",
...
},
{
  ...
  "body": "Relation Between Loading, Shear and Moment Suppose that we have a simply supported beam upon which there is an applied load   which is distributed on the beam by some function of position,  , as shown in  . \nA simply supported beam with a distributed load that is a function of beam position  .\n \n           Dan Baker \n           \n         A simply supported beam with a distributed load that is a function of beam position. A segment is indicated with imaginary cuts at x and at x+delta x. If we select a small section of this beam from   to   to look at closely, we have the free-body diagram  shown in  .  \nA free-body diagram of a small section of the beam with a width of  \n          \n           Dan Baker \n           \n         FBD of the small segment delta x, with shear and bending moments indicated on the \"cut\" surfaces. Since    is infinitely narrow, we can assume that the distributed load over this small distance is constant and equal to the value at  , and call it  . Applying the force equilibrium in the vertical direction gives the following result:\n \n       Taking the limit of both sides as   approaches 0, we get this important result\n \n       This equation tells us that, at a given location  , the slope of the shear function   there is the value of the loading directly above,  . Furthermore, if we multiply both sides by  , we can integrate to find that  \n       \n     In words, this equation says that over a given distance, the change in the shear   between two points is the area under the loading curve between them. Now looking at the internal bending moments on the  FBD  in  , when we apply moment equilibrium about the centroid of the element, and take the limit similarly, \n       \n     This final equation tells us that, the slope of the moment diagram is the value of the shear. Furthermore, if we multiply both sides by  , we can integrate to find that  \n       \n     In words, this equation says that over a given segment, the change in the moment value is the area under the shear curve. Hence, the functional relationships between the internal shear force  , internal bending moment   at a point  , and the value of the loading at that point   are are simply the derivatives and integrals that you learned in Calculus I.  These relationships are summarized below.   The slope of the shear function at   is the value of the loading function at the same position. An upward load is considered a positive load. \n         \n       The change in the shear value between two points is the area under the loading function between those points. \n         \n       The slope of the moment function at   is the value of the shear at the same position. \n         \n       The change in the moment value between two points is the area under the shear curve between those points. \n         \n       Shear and bending moment diagrams show the effect of the load on the internal forces within the beam and are a graphical representation of equations  .  The diagrams are made up of jumps, slopes and areas as a result of the load.\n Jumps   are vertical changes in shear and moment diagrams. Slopes   are gradual changes in shear and moment diagrams. Positive slopes go up and to the right. Areas     are  areas  under the loading and shear curves.  The area under the loading curve is actually a force, and the area under the shear curve is actually a moment. \n       Effect of load on shear and bending moments. \n                      Diagram \n           \n                      Jumps \n           \n                      Slopes \n           \n                      Areas \n           \n                      Shear \n           \n                      Concentrated forces cause the shear diagram to jump by the same amount.   Upward loads cause upward jumps. \n             Concentrated moments on the beam have no effect on the shear diagram. \n           \n                       The  slope of the shear diagram at a point is equal to the value of the distributed load above that point.  An downward distributed load will give the shear diagram a negative slope. \n           \n                      The change in the shear between two points is equal to the corresponding area under the loading curve. \n           \n                      Moment \n           \n                     Concentrated moments cause jumps on the moment curve.  Counterclockwise moments cause downward jumps and vice-versa. \n           \n                      The slope of the moment diagram at a point is equal to the value of shear at that point.   A positive shear causes a positive slope on the moment diagram and vice-versa. \n           \n                     Change in the moment between two points is equal to the corresponding area under a shear curve. \n           You can use the interactive below to explore how changes to concentrated load   and distributed load   affects the slopes, jumps, and areas of the resulting shear and bending moment diagrams. Interactive Diagram Try moving the red dots to change the load and see the effects on the diagrams.  Building Blocks for Shear and Moment Diagrams "
},
{
...
},
{
  ...
  "body": "Effect of load on shear and bending moments. \n                      Diagram \n           \n                      Jumps \n           \n                      Slopes \n           \n                      Areas \n           \n                      Shear \n           \n                      Concentrated forces cause the shear diagram to jump by the same amount.   Upward loads cause upward jumps. \n             Concentrated moments on the beam have no effect on the shear diagram. \n           \n                       The  slope of the shear diagram at a point is equal to the value of the distributed load above that point.  An downward distributed load will give the shear diagram a negative slope. \n           \n                      The change in the shear between two points is equal to the corresponding area under the loading curve. \n           \n                      Moment \n           \n                     Concentrated moments cause jumps on the moment curve.  Counterclockwise moments cause downward jumps and vice-versa. \n           \n                      The slope of the moment diagram at a point is equal to the value of shear at that point.   A positive shear causes a positive slope on the moment diagram and vice-versa. \n           \n                     Change in the moment between two points is equal to the corresponding area under a shear curve. \n           "
},
{
...
},
{
  ...
  "number": "8.8.2",
  "title": "Example.",
  "body": "Example Use the integration method to find the equations for shear and moment as a function of  , for a simply supported beam carrying a uniformly distributed load   over its entire length  . Simply supported beam carrying a uniformly distributed load w over its entire length L. \n             \n           This beam has only one load section, and on that section the load is constant so,  . There is a pinned connection at   which provides a vertical force and no concentrated moment, so the initial conditions there are  , and  .   Integrating equations   and   we have. \n               \n             \n               \n             "
},
{
  ...
  "body": "Geogebra Interactives You can use the interactives below to practice drawing shear and moment diagrams.  You can change the position of the loads and change their magnitudes and observe how the diagrams change, or you can click  New Problem  to generate a new problem. After exploring the diagrams and seeing how they relate to each other, turn off the solutions and try for yourself.  You will very likely see problems like these on an exam. Concentrated Forces Interactive Diagram  and   are the supports.  ,  , and   are the loads.\n Concentrated Force and Moment Distributed Load Interactive Diagram  and   are the reaction forces.\n Combination Load Interactive Diagram  and   are the reaction forces.\n Arbitrary Load Interactive Diagram \n\tThe load   is a function of  .\n \n\tThis applet uses the sign convention that positive loads act down, so  .\n "
},
{
...
},
{
  ...
  "number": "9.1.1",
  "title": "",
  "body": "\nDry friction appears between the bottom of a training sled and the field when motion is impending or occurring. \n \n               Avenue \n               CC-BY-SA \n             Photo of a football training sled. \n               Dan Baker \n               \n             Schematic of a football training sled. If sled is pushed to the right, friction opposes impending motion and acts to the left. The weight acts down through the centroid, and the normal force acts up at some point on the bottom of the sled, depending on the relative force values. "
},
{
  "id": "cycle_BB",
  "level": "2",
...
},
{
  "id": "insight-11",
  "level": "2",
  "url": "Chapter_09-dry-friction.html#insight-11",
  "type": "Thinking Deeper",
  "number": "9.1.3",
...
},
{
  ...
  "number": "9.1.4",
  "title": "",
  "body": "\nA simple model of a book being pushed horizontally while sitting on a table.  FBDs  are provided for the system, book, and table. Additionally, a Coulomb friction graph is shown and the various phases are numbered.\n \n             based upon an original by Jacob Moore \n             Dan Baker \n             \n           Book resting on table with force being applied horizontally to the right on the book. The graph shows that the friction force equals the push force, increases as the push force on the book increases up until it reaches mu_static*N. Then, the push force reduces to mu_kinetic*N. "
},
{
  "id": "friction_summary",
  "level": "2",
  ...
  "body": " Summary of the three phases of friction with the key to recognizing and examples of each.  \n                Type  \n             \n                Governing equation  \n             \n                Key to recognizing  \n             \n                Static-but-not- impending motion  \n             \n               None,   is independent of  .  \n             \n                Mention of sitting or static, but no extremal language  \n             \n               Examples :  \n               A moment of   is applied to a wheel held static by a brake arm. What is the friction force between the wheel and the brake arm? A box sits on a slope, find the resultant of the friction and normal forces on the box. \n             \n                Impending motion  \n             \n               \n                 \n               \n             \n               The use of extremal language (related to maximum or minimum values) in the problem statements \n             \n               \n                 Examples: \n               \n               What is the maximum force applied to the box before it will start to move? What is the minimum coefficient of static friction that will keep the box static? What is the lightest box which will not slip or tip on this slope? What is the most massive moment that the brake arm will hold static? \n             \n                Kinetic friction  \n             \n               \n                 \n               \n             \n               Mention of the body moving at a constant velocity under the effect of friction. (You will learn to solve non-constant velocity friction problems in Dynamics). \n             \n               Examples : \n               A   box is sliding down a 20° slope, what is the coefficient of friction to keep the velocity constant? A rope slips around a tree with a known friction coefficient and a constant velocity, what is the contact angle of the rope?  \n             "
},
{
  "id": "block_XX",
  "level": "2",
  ...
  "number": "9.1.6",
  "title": "",
  "body": "\nA block of weight   is pushed sideways by force  . The combined effect of the friction and normal forces can either be modeled as separate friction ( ) and normal ( ) forces (left) or a friction resultant force ( ) and friction angle  .\n \n             Dan Baker \n             \n            A block of weight W is pushed to the right by force P. Normal force N acts up and friction force Ff acts to the left. "
},
{
  "id": "resultant_CC",
  "level": "2",
...
},
{
  ...
  "body": "Block and Wedge Friction \tShow on a free-body diagram how a normal force always remains perpendicular to the contact surface, while the friction force lies parallel to the contact surface \tDemonstrate graphically that components of friction and normal forces are related to the right-triangle trigonometry terms sine and cosine. In this section, a block is defined as any rectangular rigid body. A wedge is a tapered object that forces objects apart or holds something in place. Wedges are used in two primary ways: \tLow friction wedges  are a simple machine which allows users to create large normal forces to move objects with comparatively small input forces. \tHigh-friction (self-locking) wedges  control the location of or hold things in place (as in doorstop wedges or carpentry wedges). \nA hydraulic ram is used to push a stationary wedge into the through a piece of firewood. All forces are drawn with respect to forces on the log and there would be mirrored friction and normal forces on the other side of the splitter. The normal force   is pushing the two halves of the log apart while the friction force   is opposing the pushing force  .\n \n           Wikimedia Commons \n         Image of a hydraulic ram splitting a piece of wood. Luckily the free-body diagrams and computations associated with both low- and high-friction wedges are identical. Block and wedge friction problems are quite similar to the multi-force body equilibrium problems from   Rigid Body Equilibrium and   in the Frames and Machines section. The main difference is the inclusion of friction from all non-smooth contact surfaces. The directions of both the normal and friction forces on the free-body diagrams are defined below. Normal forces  act between bodies are reactions forces perpendicular to the contacting surfaces. All normal forces on a  FBD  should be pointing at (and not away from) the body.  Friction forces  are reaction forces between bodies parallel (or tangential) to the contacting surfaces and created by the roughness of both surfaces. All friction forces on an  FBD  should resist the motion at the point of contact. \tThe key added challenge of solving wedge problems is that the angled faces of wedges create additional force components in your equations. One of the critical steps to solve a block or wedge problem is to look at the problem statement and drawing to determine which force is engaging the friction of the system. Start by drawing the friction forces on the body where this force acts (see  ). As you are passing the friction and normal forces to adjacent  FBDs , do not forget to draw both friction and normal forces in the opposite direction. \nThis figure demonstrates the free-body diagrams to find the minimum   to raise the block. We would assume that all the friction forces are pushed to impending motion, thus can use   to relate the friction and normal forces at all contact surfaces. A detail of   and   has also been provided so that you can see how the angle   is incorporated into the   and   components.\n \n           Dan Baker \n           \n         Schematic of a force being applied to an angled wedge to lift a larger block against a frictionless roller. FBDs for the wedge and the block. If the problem in   was changed to  Given a coefficient of static friction of   find the minimum force   to keep the wedge from slipping out under the   block , the  FBDs  would need to change in the following ways:\n all friction force directions would change as the impending motion of both the wedge and   block would change direction and the direction of   may have to change if the wedge has sufficient friction to stay static when  . \n       \tNote that for all values of   between   and   the system would be static, and the friction forces would be static-but-not-impending. "
},
{
  "id": "objectives-33",
  "level": "2",
...
},
{
  ...
  "number": "9.2.2",
  "title": "",
  "body": "\nThis figure demonstrates the free-body diagrams to find the minimum   to raise the block. We would assume that all the friction forces are pushed to impending motion, thus can use   to relate the friction and normal forces at all contact surfaces. A detail of   and   has also been provided so that you can see how the angle   is incorporated into the   and   components.\n \n           Dan Baker \n           \n         Schematic of a force being applied to an angled wedge to lift a larger block against a frictionless roller. FBDs for the wedge and the block. "
},
{
...
},
{
  "id": "insight-12",
  "level": "2",
  "url": "Chapter_09-slipping-vs--tipping.html#insight-12",
  "type": "Thinking Deeper",
  "number": "9.3.1",
...
},
{
  ...
  "number": "9.3.3",
  "title": "",
  "body": "\nA body will slide across a surface if the pushing force exceeds the maximum static friction force that can exist between the two surfaces in contact. As in all dry friction problems, this limit to the friction force is equal to the static coefficient of friction times the normal force between the body ( ). Given the scenario below of a box on a horizontal surface, if the pushing force exceeds the maximum force of friction, then the body will slip.\n\n Dan Baker FBD of block with horizontal force applied. "
},
{
  "id": "tip_GG",
  "level": "2",
  ...
  "number": "9.3.4",
  "title": "",
  "body": "\n\nGiven the box on a rough horizontal surface above, as we push horizontally on the body, the resultant normal force will shift to the right. Because the normal force is the direct result of physical contact, we cannot move the normal force beyond the corner of the box. At tipping, the friction force is static-but-not-impending as it has not reached impending motion for slipping. \n Dan Baker FBD of block with a larger horizontal force applied. "
},
{
...
},
{
  ...
  "number": "9.4.1",
  "title": "",
  "body": "A power screw is essentially a ramp wrapped around a cylinder.  \n             \n             CC-0 \n           Photo of a power screw. "
},
{
  "id": "c_clamp",
  "level": "2",
...
},
{
  ...
  "number": "9.4.3",
  "title": "",
  "body": "\nScissors Jack. \n \n             \n             CC-0 \n           Photo of a scissors jack under the driver side of a car. "
},
{
  "id": "screw_rhr",
  "level": "2",
  ...
  "number": "9.4.4",
  "title": "",
  "body": "\nThis figure demonstrates the movement of a right-hand threaded screw through a fixed nut. First, make a thumbs up with your right hand. To tighten\/lower the screw, rotate the screw in the direction of your fingertips (CW and blue rotational arrows). To loosen\/raise the screw, point your right thumb upwards and rotate the screw in the direction of your fingertips (CCW and direction of blue rotational arrows).\n \n             Dan Baker \n             \n           Twisting a screw clockwise tightens the screw, which agrees with the right hand rule, i.e. curling fingers of right hand in the direction of the tightening places points the thumb down in the direction the screw moves as tightened. The reverse is also true. "
},
{
  "id": "screw_threads_ZZ",
  "level": "2",
  ...
  "number": "9.4.5",
  "title": "",
  "body": "\nNotice that the threads on a right hand threaded screw angle up to the right, while those on a left-hand threaded screw angle up to the left. Note that turning a screw upside-down does not reverse the direction of its threads.\n   \n             Dan Baker \n             \n           Image of two screw threads. Right hand threads are higher on the right side, and left hand threads are higher on the left side. "
},
{
  "id": "screw_pitch",
  "level": "2",
  ...
  "number": "9.4.6",
  "title": "",
  "body": "\nNotice that the threads on a right hand threaded screw angle up to the right, while those on a left-hand threaded screw angle up to the left. Note that turning a screw upside-down does not reverse the direction of its threads.\n   \n             Dan Baker \n             \n           Screw thread shown up close. The angle alpha is the angle between the thread and the horizontal. The circumference of the screw thread is pi*D*(threads\/inch) or 2*pi*mean radius. The lead or pitch is the inverse tangent of alpha x mean radius. "
},
{
  "id": "screw_weight",
  "level": "2",
  ...
  "number": "9.4.7",
  "title": "",
  "body": "\nFree body diagram showing the moment   required to raise a load   given the friction   and normal force   on a single thread of a screw interacting with a nut.  \n             Dan Baker \n             \n           Sketch of weight opposing screw motion. "
},
{
  ...
  "number": "9.4.8",
  "title": "",
  "body": "FBD  of single thread element.   is the fraction of the total weight on this element, and the total moment M is represented by the fraction of the rotational force   acting at the mean radius £ from the center of the screw  .\n   \n             Dan Baker \n             \n           FBD of single thread element. "
},
{
  "id": "screw_supports",
  "level": "2",
  ...
  "number": "9.4.9",
  "title": "",
  "body": "\nFree body diagrams for the three cases where the impending motion of the screw is in the direction of the force on the screw.  Cases include (a) a self-locking screw  , (b) a screw that will unwind-with-load  , and (c) a screw at impending motion  . Note that in all three cases, the thread angle   also determines the angle of the normal force   from the centerline of the screw, and the friction angle   is the angle between the friction resultant force   and the normal force  .\n   \n             Dan Baker \n             \n           Image of a) self-locking screw, b) unwind-with-load, and c) impending motion. "
},
{
  "id": "insight-13",
  "level": "2",
  "url": "Chapter_09-screw-friction.html#insight-13",
  "type": "Thinking Deeper",
  "number": "9.4.10",
  "title": "Absolute vs. Relative Motion of Screw and Nut.",
  "body": "Absolute vs. Relative Motion of Screw and Nut Thinking Deeper - Absolute vs. Relative Motion of Screw and Nut [box] As we have seen, screws typically rotate but can be designed to for the screw or nut to translate depending on the intended use. To better understand the use of screws and nuts, it is valuable to learn about the differences between absolute and relative motion. Absolute motion is the motion you observe from a stationary reference point. The speed of a car or the velocity of the wind are all typically measured from an absolute (or non-moving) reference frame. When we choose to measure the same terms from a moving reference frame, they are considered relative motion terms. For example, the velocity of a car relative to a moving train is a relative velocity term. We typically label absolute velocity with a single variable subscript, like the velocity of car   could be written  . Relative velocities we write with a slash between the two moving objects, like a fraction in the subscript. So, the velocity of the car   relative to the moving train   is written  . The relationship between the absolute and relative velocities of two particles can be written as:  \n           \n         The relative motion of a fixed object can also be measured from the reference frame of a moving object. Thus, we find that the stop sign’s relative velocity with respect to a moving car is equal and opposite to the car’s absolute velocity.  but since the velocity of the stop sign is zero,  . The same concept can be applied to screws and nuts. In a system where a screw both translates and rotates, but the nut is stationary, you would find that the relative translation direction of the nut is equal and opposite to the absolute translation of the screw. We will use relative motion for this and other friction topics in Statics also heavily in Dynamics.  "
},
{
...
},
{
  "id": "rope_branch",
  "level": "2",
  "url": "Chapter_09-flexible-belt-friction.html#rope_branch",
  "type": "Figure",
  "number": "9.5.1",
  "title": "",
  "body": "\nIf we were to pass a rope over a tree branch to help lift a heavy object, there would be a tension differential between sides of the rope due to friction resisting the rope’s motion relative to the tree branch.   \n               Dan Baker \n               \n             Photo of rope over a tree branch to lift a heavy object. "
},
{
  ...
  "number": "9.5.2",
  "title": "",
  "body": "\nIn many belt-driven systems, friction keeps the belt from slipping on the pulley, which allows the belt to transfer forces from one pulley to another.   \n               Kiilahihnakone \n               CC-BY-SA \n             Photo of large belt and pulley. "
},
{
  "id": "belt_MM",
  "level": "2",
  ...
  "number": "9.5.3",
  "title": "",
  "body": "\nWith equal tensions on each side of the belt, the only interaction force between the belt and pulley is a non-uniform distributed force.\n   \n             Dan Baker \n             \n           Image of frictionless pulley with equal tension on each side of the belt. There is a non-uniform distributed load between the belt and the pulley. "
},
{
  "id": "belt_NN",
  "level": "2",
...
},
{
  ...
  "number": "9.5.5",
  "title": "",
  "body": "\n A flat belt pulley (left) only interacts with the bottom surface of the belt or cable. A v-belt pulley (right) has a groove, and the belt interacts with the sidewalls of the groove.\n   \n             Dan Baker \n             \n           Flat belt pulley and V-belt pulley. "
},
{
  "id": "ggb_fzgfuyex",
  "level": "2",
...
},
{
  ...
  "number": "9.5.7",
  "title": "",
  "body": "\nThe mechanical system of a fixed axis pulley hooked to a motor providing a rotational moment of M and a fixed belt designed to hold the pulley static. Note that the wheel and belt are considered massless (thus do not have a weight) in this example.\n   \n               Dan Baker \n               \n             Fixed axis pulley hooked to a motor providing a rotational moment of M and a fixed belt designed to hold the pulley static. "
},
{
  "id": "belt_QQ",
  "level": "2",
...
},
{
  ...
  "number": "9.5.10",
  "title": "",
  "body": "\nDifferential element of a flexible belt with applied normal force  , friction force  , and internal tensions   and  .\n   \n               Dan Baker \n               \n             Differential element of a flexible belt. "
},
{
  "id": "belt_TT",
  "level": "2",
...
},
{
  ...
  "number": "9.5.12",
  "title": "",
  "body": "\nA belt-driven set of fixed axis pulleys. Note that the direction of the input moment is opposite that of the resisting output moment, but the impending motion is the same for both pulleys.\n   \n               Dan Baker \n               \n             A belt-driven set of fixed axis pulleys. The pulleys are separated into separate FBDs with the tension in the belts shown to be equal and opposite. "
},
{
...
},
{
  ...
  "number": "9.6",
  "title": "",
  "body": "Draw a problem sketch and  FBD  of a journal bearing system including the appropriate shift in contact point due to impending rotation Solve for unknown values associated with journal bearing "
},
{
  "id": "journal_XX",
  "level": "2",
  ...
  "number": "9.6.1",
  "title": "",
  "body": "\n(left) In a journal bearing like the one shown here with a vertical force applied to the shaft, the contact point is located along the line of action of the applied force. (middle) If a CW couple-moment   attempts to rotate the shaft, then the contact point will move to the right as the friction force between the shaft and bearing causes the surfaces to stick, and the shaft climbs up the bearing until impending motion is reached. (right) If a CCW couple-moment   is applied, then the contact point will shift to the left as the friction force between the shaft and bearing causes the surfaces to stick, and the shaft climbs up the bearing until impending motion is reached. \n   \n             Dan Baker \n             \n           Journal bearing cross section shows outside cylinder with internal shaft in three configurations a) Contact point at 270 degrees, b) contact point at ~300 degrees, c) contact point at ~240 degrees. "
},
{
  "id": "journal_YY",
  "level": "2",
  ...
  "number": "9.6.2",
  "title": "",
  "body": "\nThe shafts in the three journal bearings above can be turned into  FBDs  s by replacing the bearing and contact point with the forces which act through the contact point. Note in all three cases the normal force   perpendicular to the tangential line of contact, which makes its line of action a radial line through the center of each shaft. Additionally, (left) there is no friction engaged, (middle) the friction resists the CW moment, and (left) the friction resists the CCW moment. The friction circle (radius  ) is explained in the steps below\n   \n             Dan Baker \n             \n           FBD of the shaft of the journal bearing showing the F_applied, Normal force, and the friction force opposing direction of impending motion. "
},
{
  "id": "journal_ZZ",
  "level": "2",
  ...
  "number": "9.6.3",
  "title": "",
  "body": "\nProblem sketches (top) and  FBDs   (bottom) for journal bearings with a fixed shaft and rotating bearing. The left set of drawings has no moment applied. The middle set has a CW moment applied to the bearing, and the right set have a CCW moment applied to the bearing.\n   \n             Dan Baker \n             \n           Journal bearing cross section shows outside cylinder with fixed internal shaft in three configurations a) Contact point at 90 degrees, b) contact point at ~60 degrees, c) contact point at ~120 degrees. Corresponding FBDs of the bearing in the three configurations are shown. "
},
{
  "id": "insight-14",
  "level": "2",
...
},
{
  ...
  "number": "9.7",
  "title": "Disc Friction",
  "body": "Disc Friction \tSelect the appropriate disc friction equation among those for hollow circular areas, solid areas, and disc brakes with a circular arc and \tCompute the possible moment the friction forces from disc friction can resist. Disc Friction Disc friction is the friction that exists between a rotating body and a stationary surface. Disc friction exerts a moment on the bodies involved which resists the relative rotation of each bodies. Disc friction is applicable to a wide variety of designs including end bearings, collar bearings, disc brakes, and clutches. \nThis orbital sander rotates a circular sanding disc against a stationary surface. The disc friction between the sanding disc and the surface will exert a moment on both the surface and the sander.   \n             Hedwig Storch \n             CC-BY-SA \n           Photo of orbital sander. Collar bearing with a hollow circular contact area To start our analysis of disc friction we will use the example of a collar bearing, which has a hollow circular contact area between the rotating collar and the stationary surface ( ). In this type of bearing, we will have a rotating shaft traveling through a hole in a surface. The shaft is supporting some load force as shown and a collar is used to support the shaft itself. \nA collar bearing has a donut shaped contact area between the rotating collar and the stationary surface. The shaft transfers the applied load \n   \n             Dan Baker \n             \n           A collar bearing (side view), and contact area of collar (top view). The friction force at any point in the contact area will be equal to the normal force at that point times the kinetic coefficient of friction at that point. If we assume a uniform pressure between the collar and the surface and a uniform coefficient of friction, then we will have the same friction force exerted at all points. This does not translate however into an equal moment exerted by each point. Points further from the center of rotation will exert a larger moment than points closer to the center of rotation because they will have a larger moment arm. \nThe friction forces on any differential element are assumed to be the same (due to a uniformly distributed normal force), yet elements along the outside edge of the contact area will cause a larger moment than those in the inside edge due to a greater radius.    \n             Dan Baker \n             \n           Top view of contact area of collar. To determine the total moment exerted by the friction forces, we will need to integrate the friction from all elements of the contact area. The moment of each element ( ) will be equal to the product of the kinetic coefficient of friction ( ), the normal force pressure ( ), the distance from that point to the center of rotation ( ), and the area of each element ( ).  \n          The total friction moment can be found by integrating the moment of each element over the contact area:   \n          To simplify the equation we can move the constant coefficient of friction and the constant normal force pressure term outside of the integral. We can also replace the pressure term with the applied force on the bearing over the contact area. Finally, so that we can integrate over the range of   values, we can recognize that the rate of change in the area ( ) for the hollow circular areas is simply the rate of change of the   term time the circumference of the circle at  . These changes lead to the equation below.  \n          Finally, we can evaluate the integral from the inner radius to the outer radius. If we evaluate the integral and simplify we will end up with the final equation below.  \n          End bearing with a solid circular contact area In cases where we have a solid circular contact area such as with a solid circular shaft in an end bearing or with the orbital sander shown at the top of the page we simply set the inner radius to zero and we can simplify the formula. If we do so, the original formula is reduced to the equation below.  \n          \nAn end bearing has a solid circular contact area between the rotating shaft and the stationary bearing.   \n             Dan Baker \n             \n           End bearing (side view) and contact area of end bearing (top view). Disc brakes with a circular arc Disc brakes have a contact area that looks like a section of the hollow circular contact area we covered earlier.  \nThe contact area in disc brakes is often approximated as a circular arc (inner radius   and outer radius  ) with a given contact angle ( )\n   \n             Dan Baker \n             \n           Contact area in disc brakes approximated as a circular arc. However, disc brakes, due to their smaller contact area, have both smaller area over which to exert friction force and also higher pressure for the same applied force. In the end, these factors cancel each other out and we end up with the same formula we had for the hollow circular contact area (independent of  ).   \tBrake pad on one side: \n         \n       Most disc brakes, however, have a pair of pads (one on each side of the rotating disc), so we will need to double the moment in our equation for the usual pair of pads. Brake pads on each side: \n         \n       "
},
{
  "id": "objectives-38",
  "level": "2",
...
},
{
  ...
  "number": "9.7.2",
  "title": "",
  "body": "\nA collar bearing has a donut shaped contact area between the rotating collar and the stationary surface. The shaft transfers the applied load \n   \n             Dan Baker \n             \n           A collar bearing (side view), and contact area of collar (top view). "
},
{
  "id": "disk_RR",
  "level": "2",
  ...
  "number": "9.7.3",
  "title": "",
  "body": "\nThe friction forces on any differential element are assumed to be the same (due to a uniformly distributed normal force), yet elements along the outside edge of the contact area will cause a larger moment than those in the inside edge due to a greater radius.    \n             Dan Baker \n             \n           Top view of contact area of collar. "
},
{
  "id": "disk_SS",
  "level": "2",
  ...
  "number": "9.7.4",
  "title": "",
  "body": "\nAn end bearing has a solid circular contact area between the rotating shaft and the stationary bearing.   \n             Dan Baker \n             \n           End bearing (side view) and contact area of end bearing (top view). "
},
{
  "id": "disk_TT",
  "level": "2",
  ...
  "number": "9.7.5",
  "title": "",
  "body": "\nThe contact area in disc brakes is often approximated as a circular arc (inner radius   and outer radius  ) with a given contact angle ( )\n   \n             Dan Baker \n             \n           Contact area in disc brakes approximated as a circular arc. "
},
{
  "id": "exercises-8",
  "level": "1",
...
},
{
  "id": "p-2038",
  "level": "2",
  "url": "Chapter_10-integral-properties-of-shapes.html#p-2038",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-2053",
  "level": "2",
  "url": "Chapter_10-integral-properties-of-shapes.html#p-2053",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "area "
},
{
  "id": "p-2055",
  "level": "2",
  "url": "Chapter_10-integral-properties-of-shapes.html#p-2055",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-2058",
  "level": "2",
  "url": "Chapter_10-integral-properties-of-shapes.html#p-2058",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "area moment of inertia "
},
{
  "id": "p-2059",
  "level": "2",
  "url": "Chapter_10-integral-properties-of-shapes.html#p-2059",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "question-11",
  "level": "2",
  "url": "Chapter_10-integral-properties-of-shapes.html#question-11",
  "type": "Question",
  "number": "10.1.2",
  "title": "",
...
},
{
  "id": "p-2066",
  "level": "2",
  "url": "Chapter_10-integral-properties-of-shapes.html#p-2066",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "10.1.3",
  "title": "Beam bending.",
  "body": "Beam bending To get a feel for how moment of inertia affects engineering design, find a ruler, a yardstick, or something similar: long with a rectangular cross section.  Try to bend the ruler both when it’s flat and also when it’s turned on edge. You will find that bending the ruler around the   axis while it’s flat is easy compared to bending it the other way, around the   axis . Why is it easier to bend the ruler one way than the other? It’s the same object, made of the same material either way.  The answer has to due with the moment of inertia, and how it relates to the bending axis.  \n           \n         \nBending a ruler. \n \n               Dan Baker \n               CC-BY-SA \n             As engineers we are not satisfied with merely knowing that it’s harder to bend a ruler one way than the other, we’d like to know  how much harder ? For a    thick ruler that is   tall, the bending resistance about the   axis is over 20 times more than the bending resistance the other way, about the   axis.  To further see how the moment of inertia comes into play, consider the curvature caused by applying opposing moments to the ends of a beam such as your ruler. You will cause it to bend into an arc of a circle of some radius.  A curious engineer would like to know how the curvature of the beam is related to the applied moment, the geometry, and the physical properties of the beam. \nBeam of length   which is being bent by opposing couple-moments to an arc with angle  .\n \n               Dan Baker \n               CC-BY-SA \n             You will learn in Mechanics of Materials that the relationship is: \n  where:   is a material property called Young’s Modulus or the modulus of elasticity which characterizes the stiffness of a material.  is the length of the beam, and  is the moment of inertia of the cross-section of the beam about the bending axis.  is the moment applied to the ends of the beam, and  is the curvature of the beam.  Since   and   are in the numerator and   is in the denominator, a longer beam is more flexible and larger values of   or   make the beam stiffer.  With those properties fixed, angle   is directly proportional to the moment  . deflection "
},
{
  "id": "p-2083",
  "level": "2",
  "url": "Chapter_10-integral-properties-of-shapes.html#p-2083",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": "Why don't we call the polar moment of inertia  ? The squared distance in the polar moment of inertia formula is the distance from the   axis, so it would seem reasonable to name the polar moment   to be consistent with   and   which use distances from the   and   axes. Instead engineers use the letter   to represent this quantity.  Why? Interactive Diagram \n\tClick on the labeled rectangle to change the view to show the appropriate differential element to calculate each moment of inertia. Rotate element   through space.\n  In-plane and out-of-plane rotation of element   about the  ,   and   axes. If areas only existed in the  -  plane, this would be fine, but the real world is three-dimensional, so   must be reserved to use with areas in the  -  or  -  plane. As shown in the interactive, the rectangular moment of inertia   involves rotating element   about out-of-plane around an in-plain axis, and the polar moment   involves rotating the element in-plane around a perpendicular axis. The two quantities represent fundamentally different things.  "
},
{
  "id": "p-2091",
  "level": "2",
  "url": "Chapter_10-integral-properties-of-shapes.html#p-2091",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": " of a Rectangle Find the moment of inertia of the rectangle about the   axis using square differential elements  . A differential element with width dx and height dy at position (x,y) within a rectangle with one point at the origin and another at (b,h). \n               \n             Following the same procedure as before, we divide the rectangle into square differential elements   and evaluate the double integral for   from   first by integrating over  , and then over  .\n \n                   The formula for   is the same as the formula as we found previously for   except that the base and height terms have reversed roles.  Here, the horizontal dimension is cubed and the vertical dimension is the linear term.  In all moment of inertia formulas, the dimension perpendicular to the axis is cubed. This solution demonstrates that the result is the same when the order of integration is reversed. This time we evaluate   by dividing the rectangle into square differential elements   so the inside integral is now with respect to   and the outside integral is with respect to  . \n \n                   "
},
{
  ...
  "number": "10.2.3",
  "title": "Rectangle.",
  "body": "Rectangle A b x h rectangle with centroid at (b\/2, h\/2). \n                 Use integration to find the moment of inertia of a   rectangle about the    and   axes passing through its centroid. \n                 Indicate that the result is a  centroidal  moment of inertia by putting a bar over the symbol  . \n               . We can use the same approach with  , but now the limits of integration over   are now from    to  . \n \n                   Notice that the centroidal moment of inertia of the rectangle is smaller than the corresponding  moment of inertia about the baseline. The solution for   is similar. "
},
{
  "id": "insight-17",
  "level": "2",
  ...
  "body": "Stresses in a Rectangular Beam To provide some context for area moments of inertia, let’s examine the internal forces in a elastic beam. Assume that some external load is causing an external bending moment which is opposed by the internal forces exposed at a cut. neutral axis The change in length of the fibers are caused by internal compression and tension forces which increase linearly with distance from the neutral axis. The internal forces sum to zero in the horizontal direction, but they produce a net couple-moment which resists the external bending moment. \nInternal forces in a beam caused by an external load.\n \n                 Dan Baker \n                 CC-BY-SA \n               Think about summing the internal moments about the neutral axis on the beam cut face.  This moment at a point on the face increases with with the square of the distance   of the point from the neutral axis because both the internal force and the moment arm are proportional to this distance.  The appearance of   in this relationship is what connects a bending beam to the area moment of inertia.  The shape of the beam’s cross-section determines how easily the beam bends. A beam with more material farther from the neutral axis will have a larger moment of inertia and be stiffer. Of course, the material of which the beam is made is also a factor, but it is independent of this geometrical factor. "
},
{
...
},
{
  ...
  "body": "Moment of Inertia for Area Between Two Curves Graph with area shaded between two functions y1=x^2\/4 and y2 = x\/4. Use vertical strips to find both   and   for the area bounded by the functions \n . Units are cm. \n             \n           \n             \n                 Set up the integral \n                 The area is bounded by the functions\n \n                         \n                 By equating the two functions, we learn that they intersect at   and  , so the limits on   are   and  .  \n                 The differential area   for vertical strip is  . \n               \n                 Find  \n                         \n                 For vertical strips, which are parallel to the   axis we can use the definition of the Moment of Inertia.\n \n                         \n               \n                 Find  \n                         \n                 For vertical strips, which are perpendicular to the   axis, we will take subtract the moment of inertia of the area below   from the moment of inertia of the area below  .\n \n                         \n               \n           "
},
{
  "id": "table-6",
  "level": "2",
  ...
  "body": "Moment of Inertia Integration Strategies Element \n               \n             \n               \n             \n               \n                 Differential element dx-dy at (x, y). \n               \n             \n               \n                 \n               \n                or  \n               \n                 \n               \n             \n               \n                 \n               \n               \n                 \n               \n             \n               \n                 Differential element (a-x)*dy with left end of element at (x, y). \n               \n             \n               \n             \n               \n                 \n               \n               \n                 \n               \n             \n               \n                 Differential element y*dx with top end of element at (x, y). \n               \n             \n               \n             \n               \n                 \n               \n               \n                 \n               \n             "
},
{
  ...
  "body": "Parallel Axis Theorem The parallel axis theorem relates the moment of inertia of a shape about an arbitrary axis to its moment of inertia about a parallel centroidal axis. This theorem is particularly useful because if we know the centroidal moment of inertia of a shape, we can calculate its moment of inertia about any parallel axis by adding an appropriate correction factor.  Alternately, if we know the moment of inertia about an axis, we can find the associated centroidal moment of inertia by subtracting the same factor. The centroidal moment of inertia of common shapes are well known, and readily available in tables of properties of shapes such as  . Derivation \n           We will use the defining equation for the moment of inertia   to derive the parallel axis theorem. \n           The diagram shows an arbitrary shape, and two parallel axes: the   axis, drawn in red, passes through the centroid of the shape at  , and the    axis, which is parallel and separated by a distance,  .  The shape has area  , which is divided into square differential elements  .  The distance from the   axis to the element   is  , and the distance from the   axis is  . \n           By  , the moment of inertia of the shape about the   and   axes are  \n                \n         \nDefinitions for the parallel axis theorem.\n    \n               Dan Baker \n               CC-BY-SA \n             Image illustrating parallel-axis-theorem. The first is the value we are looking for, and the second is the centroidal moment of inertia of the shape. These two are related through the distance  , because  . Substituting that relation into the first equation and expanding the binomial gives\n . You should recognize these three integrals.  The first is the centroidal moment of inertia of the shape  , and the third is the total area of the shape,  .  The middle integral is  , the   first moment of area  with respect to the centroidal axis  . So we have,  . Furthermore,   is exactly zero because the   axis passes through the centroid, meaning that elements of area above and below the centroidal axis exactly balance and cancel each other out.  After dropping the middle term we get the version of the parallel axis theorem which you should remember,   . The subscripts designating the   and   axes have been dropped because this equation is applicable to any direction of parallel axes, not specifically horizontal axes. This equation says that you find the moment of inertia of a shape about  any  axis by adding   to the  parallel  centroidal moment of inertia. You can consider the   term as  correction factor  to account for the distance of the axis from the centroid.  This term is always positive, so the centroidal moment of inertia is always the minimum moment of inertia for a particular axis direction. The next example show how the parallel axis theorem is typically used to find the moment of inertia of a shape about an axis, by using then centroidal moment of inertia formulas found in  . Circular Ring \n               Use the parallel axis theorem to find the moment of inertia of the circular ring about the   axis. \n               The dimensions of the ring are  ,  , and  \n                      \n             Circular ring with inner radius ri and outer radius ro. The left edge is a distance of a mm from the y-axis. The y' axis intersects the centroid. \n             \n           To apply the parallel axis theorem, we need three pieces of information  The centroidal moment of inertia of the ring,   , the area of the ring,  , the distance between the parallel axes,  . \n                The area of the ring is found by subtracting the area of the inner circle from the area of the outer circle. The centroidal moment of inertia is calculated similarly using  .  The distance between the   and   axis is available from the diagram.  Inserting these values into the parallel axis theorem gives, \n \n                It is interesting that the  correction factor  is more than 20 times greater than the centroidal moment of inertia of the ring.  This indicates the importance of the distance squared term on the moment of inertia of a shape. You may feel like the answer to this problem is  too big .  Large answers are normal in problems like this because the moment of inertia involves raising lengths the fourth power.  If it really bothers you, you can convert the results from   to  , but then the number will probably feel  too small  to you.  It's best not to worry about it.  The parallel axis theorem can also be used to find a centroidal moment of inertia when you already know the moment of inertia of a shape about another axis, by using the theorem   backwards ,  \n . Centroidal Moment of Inertia of a Triangle Rignt triangle with vertices at (0,0), (b,0), and (0,h). Axes x' and y' intersect the centroid. Find the centroidal moment of inertia of a triangle knowing that the moment of inertia about its base is . \n             \n           \n             \n           For the triangle the moment of we have the following information:  ,  , and  . Looking for  :\n \n                The procedure for   is similar, or you can simply reverse the roles of   and  . Centroidal Moment of inertia of a Semi-Circle Half circle with base on x-axis and centered on y-axis. The x' axis intersects the centroid. Find the centroidal moment of inertia of a semi-circle knowing that the moment of inertia about its base is . \n             \n           The area of a semicircle is   and the distance between the parallel axes is  , so\n \n                Interactive: Rectangle This interactive allows you to change the location and size of the grey rectangle. Try to compute both the centroidal area moment of inertia   and   and the area moment of inertia about the system axes   and  \n             Interactive Diagram The inteactive calculates the moment of inertia using the parallel axis theorem  .  Note that a centroidal moment of inertia is smaller than the moment of inertia about any corresponding parallel axis.  Move the red dots to change the size and location of the rectangle. Moment of Inertia of a Rectangle Interactive: Semi-Circle Use this interactive to practice computing the area moments of inertia of the semi-circle about the centroidal   axis, the bottom edge  , and the system   axis.  You can change the location and size of the semicircle by moving the red points..  Interactive Diagram The inteactive calculates the moment of inertia of a semi-circle about three different axes using the parallel axis theorem  .  The distance term   represents the distance between the axis of interest and a parallel axis passing through the centroid of the shape.  Move the red dots to change the size and location of the semi-circle. Moment of Inertia of a Semi-Circle Moments of Inertia Table This table summarizes the properties of the common shapes discussed previously. Moments of Inertia of Common Shapes Shape Centroid Centroidal MOI \n               \n             \n               \n                 Rectangle with base b and height h \n               \n             \n               \n             \n               \n                 \n               \n               \n                 \n               \n             \n               \n                 \n                 \n               \n             \n               \n                 Right triangle with vertices (0,0), (0, h), and (b, 0) \n               \n             \n               \n             \n               \n                 \n                 \n               \n             \n               \n                 \n                 \n               \n             \n               \n                 Circle with centered at *x-bar, y-bar). The x' and y' axes intersect the centroid. \n               \n             \n               \n             \n               \n                 \n               \n             \n               \n                 \n               \n             \n               \n                 Half circle with base on x-axis and centered on y-axis. The x' axis intersects the centroid. \n               \n             \n               \n             \n               \n                 \n                 \n                   \n                 \n               \n               \n                 \n               \n             \n               \n                 \n               \n             \n               \n                 Quarter circle with base on x-axis and side on y-axis. The x' axis intersects the centroid. \n               \n             \n               \n             \n               \n                 \n                 \n                   \n                 \n               \n               \n                 \n               \n             \n               \n                 \n               \n             "
},
{
  ...
  "number": "10.3.1",
  "title": "",
  "body": "\nDefinitions for the parallel axis theorem.\n    \n               Dan Baker \n               CC-BY-SA \n             Image illustrating parallel-axis-theorem. "
},
{
...
},
{
  ...
  "body": "Centroidal Moment of Inertia of a Triangle Rignt triangle with vertices at (0,0), (b,0), and (0,h). Axes x' and y' intersect the centroid. Find the centroidal moment of inertia of a triangle knowing that the moment of inertia about its base is . \n             \n           \n             \n           For the triangle the moment of we have the following information:  ,  , and  . Looking for  :\n \n                The procedure for   is similar, or you can simply reverse the roles of   and  . "
},
{
  ...
  "body": "Centroidal Moment of inertia of a Semi-Circle Half circle with base on x-axis and centered on y-axis. The x' axis intersects the centroid. Find the centroidal moment of inertia of a semi-circle knowing that the moment of inertia about its base is . \n             \n           The area of a semicircle is   and the distance between the parallel axes is  , so\n \n                "
},
{
  ...
  "body": "Interactive: Rectangle This interactive allows you to change the location and size of the grey rectangle. Try to compute both the centroidal area moment of inertia   and   and the area moment of inertia about the system axes   and  \n             Interactive Diagram The inteactive calculates the moment of inertia using the parallel axis theorem  .  Note that a centroidal moment of inertia is smaller than the moment of inertia about any corresponding parallel axis.  Move the red dots to change the size and location of the rectangle. Moment of Inertia of a Rectangle "
},
{
...
},
{
  ...
  "number": "10.3.9",
  "title": "Moments of Inertia of Common Shapes",
  "body": "Moments of Inertia of Common Shapes Shape Centroid Centroidal MOI \n               \n             \n               \n                 Rectangle with base b and height h \n               \n             \n               \n             \n               \n                 \n               \n               \n                 \n               \n             \n               \n                 \n                 \n               \n             \n               \n                 Right triangle with vertices (0,0), (0, h), and (b, 0) \n               \n             \n               \n             \n               \n                 \n                 \n               \n             \n               \n                 \n                 \n               \n             \n               \n                 Circle with centered at *x-bar, y-bar). The x' and y' axes intersect the centroid. \n               \n             \n               \n             \n               \n                 \n               \n             \n               \n                 \n               \n             \n               \n                 Half circle with base on x-axis and centered on y-axis. The x' axis intersects the centroid. \n               \n             \n               \n             \n               \n                 \n                 \n                   \n                 \n               \n               \n                 \n               \n             \n               \n                 \n               \n             \n               \n                 Quarter circle with base on x-axis and side on y-axis. The x' axis intersects the centroid. \n               \n             \n               \n             \n               \n                 \n                 \n                   \n                 \n               \n               \n                 \n               \n             \n               \n                 \n               \n             "
},
{
...
},
{
  ...
  "number": "10.4.2",
  "title": "T Shape.",
  "body": "T Shape T-shape. Horizontal segment is 90 mm wide by 20 mm tall. Below that, the vertical segment is 30 mm wide by 60 mm tall. Find the moment of inertia of the T shape about the   and   axes. \n             \n           \n             \n                 Strategy \n                 Divide the T shape into a    vertical rectangle (1), and a   horizontal rectangle (2) then add the moments of inertia of the two parts. \n \n                         \n               \n                 MOI about the   Axis \n                 The bottom edge of rectangle 1 is on the   axis.  Using the formula from   gives . \n                 The centroid of rectangle 2 is located   above the   axis so we must use the parallel axis theorem  , so  \n . \n                 The moment of inertia of the entire T shape about the   axis is the sum of these two values, . \n               \n                 MOI about the   Axis \n                 We can use the same procedure to find the moment of inertia about the   axis, however it is usually more convenient to organize all the necessary information in a table rather than writing the equations explicitly.   \n                 We will use the parallel axis theorem for both rectangles with   representing the distance between the   axis and the centroid of the part.  In this example   is the same for both parts, but that will not always be true.   \n                 Part Dimensions \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     Units \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     1 \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     2 \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     Total \n                       \n                     \n                 \n                   \n                 \n               \n           "
},
{
  ...
  "number": "10.4.3",
  "title": "Fillet.",
  "body": "Fillet L-shaped segment 10 in high by 9 in at the base, thickness is 3\". The fillet at the interior of the L-shape has a radius of 3\". Find the moment inertia of the area about the   axis. \n             \n           \n             \n                 Strategy \n                 First, divide the area into four parts: \n a   rectangle a   rectangle a   rectangle, and  a removed quarter-circle with a   radius. \n                            \n                 Then set up a table and apply the parallel axis theorem   as in the previous example.  Since the quarter-circle is removed, subtract its moment of inertia from total of the other shapes. \n               \n                 MOI about the   Axis \n                 The centroidal moment of inertia of a quarter-circle, from   is\n \n                         \n                 The distance from the top edge of the quarter-circle down to its centroid is  , so the distance from the   axis to its centroid is  . \n                 Fill out the table of information. \n                 Part Dimensions \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     Units \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     1 \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     2 \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     3 \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     4 \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                       \n                     \n                 Take care to subtract the moment of inertia of the removed quarter-circle from the total.  . \n               \n           "
},
{
...
},
{
  ...
  "body": "Interactive: Composite Rectangles This interactive shows a composite shape shape consisting of a large rectangle with a smaller rectangle subtracted. You can change the location and size of the rectangles by moving the red and blue points. Use the interactive to see how changes to the rectangles affects the moments of inertia of this shape about the system   axis.  Notice that for two-part shapes like this, the centroid of the composite shape is on the line connecting the centroids of the two parts. For calculations, it is convenient to collect all the needed information in a table as is done here. Interactive Diagram Demonstrates calculation of the moment of inertia of a composite shape about the   axis using the parallel axis theorem  . Note that when using the parallel axis theorem, area is always positive, and the  MOI  of the hole   is subtracted from   to get the  MOI  of the combined shape. Moment of Inertia of a Rectangle "
},
{
  "id": "AISC-samples",
  "level": "2",
  ...
  "number": "10.4.7",
  "title": "",
  "body": "\nAISC Standard Sections: Left to right -- Wide-Flange (W), American Standard (S) , Channel (C),  Equal Angle (L), Unequal Angle (L), Structural Tee (T), Rectangle (HSS), Square (HSS), Round (HSS).\n    \n             Dan Baker \n             CC-BY-SA \n            Left to right Wide-Flange-wide I-shape, American Standard thin I-shape, Channel-thin square C-shape, Equal Angle wide L-shape, Unequal Angle- L-shape, Structural Tee T-shape, Rectangle shape, Square, Round. "
},
{
  ...
  "number": "10.4.8",
  "title": "",
  "body": "\nBeam Nomenclature\n \n               Dan Baker \n               CC-BY-SA \n             Top and bottom of beam are flanges. Vertical center column is the web. Depth is top to bottom measurement. Neutral axis and neutral plane intersect the centroid. "
},
{
  ...
  "number": "10.4.9",
  "title": "Built-up beam.",
  "body": "Built-up beam A built-up beam consists of two L8 4 1\/2 angles attached to a 8 1 plate as shown.  Determine  the distance from the   axis to the neutral axis, which passes through the centroid of the combined shape, and  the moment of inertia of the combined shape about the neutral axis. \n                   A built-up beam of L8 x 4 x 1\/2 angles attached to a 8 x 1 plate. \n             \n           \n             \n                 Strategy \n                 Determine the properties of the sub shapes with respect to the   axis, and then use them to find the neutral axis.   \n                 Use the parallel axis theorem to find the moment of inertia of the parts with respect to the neutral axis.   \n                 Take advantage of the fact that the two angles are identical and positioned similarly.  \n               \n                 Find the neutral axis \n                 For one L  angle, from  \n                            . \n                 For the  \n                             rectangle\n . \n                 Find the distance to the neutral axis\n . \n               \n                 Find the Moment of Inertia  \n                 The distance between  the neutral axis is and the centroids of the subparts are \n . \n                 The moment of inertia of the rectangle about the   axis\n . \n                 The moment of inertia of one angle about the   axis\n . \n                 The moment of inertia of the built up beam about the neutral axis\n . \n               \n           "
},
{
  "id": "polar-moment",
  "level": "1",
  ...
  "body": "Polar Moment of Inertia How are polar moments of inertia similar and different to area moments of inertia about either a horizontal or vertical axis? The polar moment of inertia is defined by the integral quantity  , where   is the distance from the reference point to a differential element of area  . Differential element dx by dy at radius r from origin which is at (x,y). The polar moment of inertia describes the distribution of the area of a body with respect to a point in the plane of the body.  Alternately, the point can be considered to be where a perpendicular axis crosses the plane of the body.  The subscript on the symbol   indicates the point or axis. There is a particularly simple relationship between the polar moment of inertia and the rectangular moments of inertia. Referring to the figure, apply the Pythagorean theorem   to the definition of polar moment of inertia to get\n . Torsional Stress The polar moment of inertia is an important factor in the design of drive shafts.  When a shaft is subjected to torsion, it experiences internal distributed shearing forces throughout its cross-section which counteract the external torsional load.   shear stress \nSection-cut view of a shaft, showing shearing forces developed to withstand external torsion  . \n \n             Dan Baker \n             CC-BY-SA \n           The force at any point is  , and the moment   exerted at any point is   times the moment arm, which is  .  The total moment is the integral of this quantity over the area of the cross section, and is proportional to the polar moment of inertia.\n \n          This is the relationship between the maximum stress in a circular shaft and the applied torque    and  the geometric properties of the shaft,   and  . "
},
{
  "id": "objectives-41",
  "level": "2",
...
},
{
  ...
  "body": "Torsional Stress The polar moment of inertia is an important factor in the design of drive shafts.  When a shaft is subjected to torsion, it experiences internal distributed shearing forces throughout its cross-section which counteract the external torsional load.   shear stress \nSection-cut view of a shaft, showing shearing forces developed to withstand external torsion  . \n \n             Dan Baker \n             CC-BY-SA \n           The force at any point is  , and the moment   exerted at any point is   times the moment arm, which is  .  The total moment is the integral of this quantity over the area of the cross section, and is proportional to the polar moment of inertia.\n \n          This is the relationship between the maximum stress in a circular shaft and the applied torque    and  the geometric properties of the shaft,   and  . "
},
{
...
},
{
  "id": "p-2338",
  "level": "2",
  "url": "products-of-inertia.html#p-2338",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "product of inertia "
},
{
  "id": "p-2340",
  "level": "2",
  "url": "products-of-inertia.html#p-2340",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "principle axes "
...
},
{
  ...
  "number": "A",
  "title": "Notation",
  "body": "Notation Notation refers to the symbols we use to represent physical quantities and variables in mathematical expressions. Notation is a tool for communication and the symbols themselves carry meaning. You will find it easier to understand the contents of engineering textbooks if you are familiar with the notation used, and can pronounce the symbols to yourself when studying the equations. tile of figure? Notation used in this book \n         \n             \n           \n             \n           \n         \n             \n           Vectors are written in a bold serif font. For handwritten\n            vectors, a superimposed arrow is used. \n         \n             \n            Magnitudes and other scalar values are rendered in an regular\n            italic serif font.   is the magnitude of\n             . \n         \n             \n            Vertical bars indicate  absolute value . The absolute\n            value of a vector is its magnitude. \n         \n             \n           Vector component of   in the   and\n                 directions. Subscripts are used to distinguish\n            different related values.  \n         \n             \n           Scalar components of vector   in the   and\n                 directions. These are signed numbers, not vectors.\n            Together, the sign and subscript define a vector\n            component. \n         \n             \n           An ordered pair of scalar components enclosed in angle\n            brackets defines a vector. \n         \n             \n           An ordered pair of magnitude and direction separated with a\n            semicolon defines a vector. \n         \n             \n           Unit vectors in the  ,  , and  \n            directions. Pronounced  i hat ,  j hat ,\n             \n                \n         \n             \n            A hat indicates a unit vector in the vector’s direction. \n         \n             \n           Scalar components multiplied by unit vectors are vector\n            components.  \n         \n             \n            A vector is the sum of its vector components.  \n         \n             \n           These are all equivalent representation of vector\n                . \n       "
},
{
  "id": "notations",
  "level": "2",
  ...
  "body": "tile of figure? Notation used in this book \n         \n             \n           \n             \n           \n         \n             \n           Vectors are written in a bold serif font. For handwritten\n            vectors, a superimposed arrow is used. \n         \n             \n            Magnitudes and other scalar values are rendered in an regular\n            italic serif font.   is the magnitude of\n             . \n         \n             \n            Vertical bars indicate  absolute value . The absolute\n            value of a vector is its magnitude. \n         \n             \n           Vector component of   in the   and\n                 directions. Subscripts are used to distinguish\n            different related values.  \n         \n             \n           Scalar components of vector   in the   and\n                 directions. These are signed numbers, not vectors.\n            Together, the sign and subscript define a vector\n            component. \n         \n             \n           An ordered pair of scalar components enclosed in angle\n            brackets defines a vector. \n         \n             \n           An ordered pair of magnitude and direction separated with a\n            semicolon defines a vector. \n         \n             \n           Unit vectors in the  ,  , and  \n            directions. Pronounced  i hat ,  j hat ,\n             \n                \n         \n             \n            A hat indicates a unit vector in the vector’s direction. \n         \n             \n           Scalar components multiplied by unit vectors are vector\n            components.  \n         \n             \n            A vector is the sum of its vector components.  \n         \n             \n           These are all equivalent representation of vector\n                . \n       "
},
{
  "id": "distance-formula",
  "level": "1",
...
},
{
  ...
  "body": "Oblique Triangle Trigonometry An oblique triangle is any triangle which does not contain a right angle.  As such, the rules of   do not apply! Law of Sines Law of Cosines Law of Sines \n           \n         The law of Sines is used when you know the length of one side, the angle opposite it, and one additional angle (SAA) or side (SSA).  If this is not the case use the Law of Cosines.  ambiguous case supplement If one of the angles is 90°, then the Law of Sines simplifies to the definitions of sine and cosine since the  . Law of Cosines \n           \n         The Law of Cosines is used when you know two sides and the included angle (SAS), or when you know all three sides but no angles (SSS).  In any other situation, use the Law of Sines. If one of the angles is   the Law of Cosines simplifies to the Pythagorean Theorem since  . "
},
{
  "id": "p-2386",
  "level": "2",
  "url": "los-loc.html#p-2386",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
