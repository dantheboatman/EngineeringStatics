...
},
{
  ...
  "number": "1.1.2",
  "title": "",
  "body": " In deep space, where friction and gravitational forces are negligible, an object moves with constant velocity; near a celestial body gravitational attraction continuously changes its velocity.    CC-0  NASA   An artist rendering of a spacecraft near the lunar surface. In the absence of forces in space, this space capsule will maintain its current velocity.   "
},
{
  "id": "p-31",
  "level": "2",
...
},
{
  "id": "p-108",
  "level": "2",
  "url": "Chapter_02-vectors.html#p-108",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-113",
  "level": "2",
  "url": "Chapter_02-one-dimensional-vectors.html#p-113",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "resultant "
...
},
{
  "id": "p-129",
  "level": "2",
  "url": "cartesian-coords-2d.html#p-129",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Cartesian "
...
},
{
  ...
  "body": " Rectangular to Polar Representation    Express point in polar coordinates.    William Haynes  CC-BY-SA   A graph that shows the point P = (-8.66, 5) on an x-y plane.           Given: ,      You must be careful here and use some common sense. The angle your calculator gives you in this problem is incorrect because point is in the second quadrant, but your calculator doesn't know this. It can't tell whether the argument of is negative because the was negative or because the was negative, so it must make an assumption and in this case it is wrong.  The arctan function on calculators will always return values in the first and fourth quadrant. If, by inspection of the and the coordinates, you see that the point is in the second or third quadrant, you must add or subtract to the calculator’s answer.  So in this problem, is really . After making this adjustment, the location of in polar coordinates is:       Most scientific calculators include handy polar-to-rectangular and rectangular-to-polar functions which can save you time and help you avoid errors. Perhaps you should google your calculator model to find out if yours does and learn how to use it?   "
},
{
...
},
{
  "id": "p-258",
  "level": "2",
  "url": "vector_algebra_2D.html#p-258",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-260",
  "level": "2",
  "url": "vector_algebra_2D.html#p-260",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-268",
  "level": "2",
  "url": "vector_algebra_2D.html#p-268",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-306",
  "level": "2",
  "url": "dot_products_2D.html#p-306",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-311",
  "level": "2",
  "url": "dot_products_2D.html#p-311",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-327",
  "level": "2",
  "url": "dot_products_2D.html#p-327",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "projection "
...
},
{
  ...
  "number": "3.5.4",
  "title": "Skycam.",
  "body": " Skycam   The skycam at Stanford University Stadium has a mass of and is supported by three cables as shown. Assuming that it is currently in equilibrium, find the tension in each of the three supporting cables.      Jrienstra   CC-BY-SA   Skycam has mass of 20 kg and is in equilibrium. Cable A is in the x-y plane, acting 35 degrees from positive x-axis. Cable B acts -30 degrees from the negative x-axis in the x-z plane, and 15 degrees above the x-z plane. Cable C acts 20 degrees in the y-z plane, -20 degrees from the positive z-axis.            In this situation, the directions of all four forces are specified by the angles in the free-body diagram, and the magnitude of the weight is known. The three unknowns are the magnitudes of forces , , and .   We will first find unit vectors in the directions of the four forces by inspection of the free-body diagram. This step requires visualizing the components unit vectors, and determining the angles each makes with the coordinate axis.   Particle equilibrium requires that , so, . This is a 3 3 system of three simultaneous equation, one for each coordinate direction, which needs to be solved for , , and .   These can be solved by any method you choose. Here we will use Sage. Evaluating the coefficients and expressing the equations in matrix form gives .  This is an equation in the form . Entering the coefficient matrices into Sage.   After evaluating, we learn that .   "
},
{
  "id": "exercises-2",
  "level": "1",
...
},
{
  ...
  "number": "4.1.2",
  "title": "",
  "body": " Point-and-curl right-hand rule technique for moments.       Image of a right hand held out flat, where is in the direction of the fingers held out flat. If the fingers were curled in, and the thumb pointed up, then the curled fingers are in the direction of and the thumb in the direction of .   "
},
{
  "id": "rhr5",
  "level": "2",
...
},
{
  ...
  "number": "4.4.3",
  "title": "Varignon’s theorem.",
  "body": " Varignon's theorem    A force is applied to the frame as shown. Determine the moment this force makes about point .           Force acts from the vertical with a magnitude, so its horizontal and vertical components are   For component , the perpendicular distance from point is so the moment of this component is .  For component , the perpendicular distance from point is so the moment of this component is .  Assigning a negative sign to and a positive sign to to account for their directions and summing, gives the moment of about .   The negative sign indicates that the resultant moment is clockwise, with a magnitude of .      "
},
{
  "id": "ggb_cgjzpe7k",
  "level": "2",
...
},
{
  ...
  "number": "4.8.2",
  "title": "",
  "body": " Moving a force is not an equivalent transformation     Force at end of beam.    William Haynes  CC-BY-SA   Rigid beam fixed at O point B at length l and point A at length 2l. Force P acts downward at point A.     Force moved to center of beam.    William Haynes  CC-BY-SA   Rigid beam fixed at O point B at length l and point A at length 2l. Force P acts downward at point B.       FBD and reactions for (a).    William Haynes  CC-BY-SA   FBD of rigid beam which was fixed at O point with B at length l and point A at length 2l. Force P acts downward at point A. At O, a force P acts upward. A Moment of M = 2P*l is developed in the counter-clockwise direction.     FBD and reactions for (b).    William Haynes  CC-BY-SA   FBD of rigid beam which was fixed at O point with B at length l and point A at length 2l. Force P acts downward at point B. At O, a force P acts upward. A Moment of M = P*l is developed in the counter-clockwise direction.      "
},
{
  "id": "figure-65",
  "level": "2",
...
},
{
  ...
  "number": "5.1.2",
  "title": "",
  "body": " Three-dimensional rigid body have six degrees of freedom - three translations and three rotations.    Dan Baker  CC-BY-SA   A 3-D box shown on a three dimensional coordinate system can translate in the x-, y-, and z-directions, and can rotate to any angle thetaX around the x axis, thetaY around the y axis, and thetaZ around the z axis.   "
},
{
...
},
{
  ...
  "body": " Mud on Concrete Wall     Find the depth of mud for which the tall concrete retaining wall will be on the verge of tipping over.  Assume the density of mud is and the density of concrete is .    Retaining wall is 3 m high and 0.8 m wide. The mud is shown to the right of the wall at height of h.               "
},
{
...
},
{
  ...
  "number": "9.3.2",
  "title": "",
  "body": "   Find the minimum force P required to start raising the block. Assume that the wedge is massless.    Dan Baker    Schematic of a force being applied to an angled wedge to lift a larger block against a frictionless roller.           This figure demonstrates the free-body diagrams to find the minimum to raise the block. We would assume that all the friction forces are pushed to impending motion, thus you can use to relate the friction and normal forces at all contact surfaces. A detail of and has also been provided so that you can see how the angle is incorporated into the and components.   "
},
{
  "id": "example-69",
  "level": "2",
